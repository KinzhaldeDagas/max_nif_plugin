...
public:
    ...
    TSTR SubAnimName(int i, bool localized) override { return i ? _T("") : (localized ? GetString(IDS_LUMINATION_PARAMS) : _T("Luminance PB")); }
...
public:    
    ...
    TSTR GetName(bool localized) const override { return localized ? GetString(IDS_QUANTITY_LUMINANCE) : _T("Luminance"); }
    ...
    void SetElementName( const TCHAR* newName); 
...
public:
    ...
    int NumSubs() { return 1; }
    Animatable* SubAnim(int i){ return i? NULL : pParamBlk; }
    TSTR SubAnimName(int i, bool localized) override { return i ? _T("") : (localized ? GetString(IDS_ILLUMINATION_PARAMS) : _T("Illuminance PB")); }
    
    int NumRefs() { return 1;};
    RefTargetHandle GetReference(int i){ return i? NULL : pParamBlk; }

	// The default implementation now returns FALSE, so Scanline Render Elements
	// should override the method to be visible to Scanline
...
public:    
    ...
    TSTR GetName(bool localized) const override { return localized ? GetString(IDS_QUANTITY_ILLUMINANCE) : _T("Illuminance"); }
    void GetClassName(MSTR& s, bool localized) const override { s = GetName(localized); }
