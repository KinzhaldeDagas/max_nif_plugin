...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_BEAUTY_RENDER_ELEMENT) : _T("Beauty"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Beauty"); }
...
void BeautyRenderElement::SetElementName( const TCHAR* pStr ) 
{
