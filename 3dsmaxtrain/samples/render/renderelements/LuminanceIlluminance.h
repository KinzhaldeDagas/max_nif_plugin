...
public:
    ...
    TSTR GetName(bool localized) const override { return localized ? GetString(IDS_LUMINANCE_CLASSNAME) : _T("Luminance HDR Data"); }
...
public:
    ...
    TSTR GetName(bool localized) const override { return localized ? GetString(IDS_ILLUMINANCE_CLASSNAME) : _T("Illuminance HDR Data"); }
    void GetClassName(MSTR& s, bool localized) const override { s = GetName(localized); }
