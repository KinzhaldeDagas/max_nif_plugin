...
#define MOTION_RENDER_ELEMENT_CLASS_ID          0x00000013
#define LUMINANCE_RENDER_ELEMENT_CLASS_ID		0x00000016
...
extern ClassDesc* GetMotionElementDesc();
extern ClassDesc* GetMaterialIDElementDesc();
extern ClassDesc* GetObjectIDElementDesc();
...
//		Bitmap*		mpBitmap;
	...
	public:
		...
		BaseRenderElement() : mpParamBlk(NULL) {}
