...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_DIFFUSE_RENDER_ELEMENT) : _T("Diffuse"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Diffuse"); }
...
static ParamBlockDesc2 diffuseParamBlk(PBLOCK_NUMBER, _T("Diffuse render element parameters"), 0, &diffuseCD, P_AUTO_CONSTRUCT + P_AUTO_UI, PBLOCK_REF,
	...
	DiffuseRenderElement::lightingOn, _T("lightingOn"), TYPE_BOOL, 0, IDS_LIGHTING_ON,
		p_default, FALSE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_LIGHTING,
		p_end,
	p_end
	);
...
void DiffuseRenderElement::PostIllum(ShadeContext& sc, IllumParams& ip)
{
	if( ip.pMtl == NULL ){ // bgnd
		...
		else
		{
			...
			sc.out.elementVals[ mShadeOutputIndex ] = ip.stdIDToChannel ? AColor(ip.channels[ ip.stdIDToChannel[ ID_DI ]]) : AColor(0,0,0);
			float a = 1.0f - Intens( sc.out.t );
			if( a < 0.0f ) a = 0.0f;
			sc.out.elementVals[ mShadeOutputIndex ].a = a;
		}
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_MATTE_RENDER_ELEMENT) : _T("Matte"); }
		SFXParamDlg *CreateParamDialog(IRendParams *ip);
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Matte"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return matteRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
static ParamBlockDesc2 matteParamBlk(PBLOCK_NUMBER, _T("Matte render element parameters"), 0, &matteCD, P_AUTO_CONSTRUCT + P_AUTO_UI, PBLOCK_REF,
	...
	MatteRenderElement::mtlIDOn, _T("mtlIDOn"), TYPE_BOOL, 0, IDS_MTLID_ON,
		p_default, FALSE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_MTL_ID,
		p_end,
	MatteRenderElement::gbufIDOn, _T("gbufIDOn"), TYPE_BOOL, 0, IDS_GBUFID_ON,
		p_default, FALSE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_GBUF_ID,
		p_end,
	...
	MatteRenderElement::IncludeOn, _T("includeOn"), TYPE_BOOL, 0, IDS_INCLUDE_ON,
		p_default, FALSE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_INCLUDE_CHECK,
		p_end,
	p_end
);
//--- Matte Render Element ------------------------------------------------
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_LIGHTING_RENDER_ELEMENT) : _T("Lighting"); }
		SFXParamDlg *CreateParamDialog(IRendParams *ip);
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Lighting"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return lightingRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_SPECULAR_RENDER_ELEMENT) : _T("Specular"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Specular"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return specularRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_SPECULAR_COMP_RENDER_ELEMENT) : _T("Composited Specular"); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_EMISSION_RENDER_ELEMENT) : _T("Self-Illumination"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Self-Illumination"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return emissionRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_BGND_RENDER_ELEMENT) : _T("Background"); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_REFLECTION_RENDER_ELEMENT) : _T("Reflection"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Reflection"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return reflectionRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_REFRACTION_RENDER_ELEMENT) : _T("Refraction"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Refraction"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return refractionRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_SHADOW_RENDER_ELEMENT) : _T("Shadow"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Shadow"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return shadowRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_ATMOS_RENDER_ELEMENT) : _T("Atmosphere"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Atmosphere"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return atmosphereRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_ALPHA_RENDER_ELEMENT) : _T("Alpha"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Alpha"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return alphaRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
//			diffuseOn = BaseRenderElement::pathName+1, 
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_BLEND_RENDER_ELEMENT) : _T("Blend"); }
...
static ParamBlockDesc2 BlendParamBlk(PBLOCK_NUMBER, _T("Blend render element parameters"), 0, &BlendCD, P_AUTO_CONSTRUCT + P_AUTO_UI, PBLOCK_REF,
	...
	BlendRenderElement::atmosphereOn, _T("atmosphereOn"), TYPE_BOOL, 0, IDS_ATMOSPHERE_ON,
		p_default, TRUE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_ATMOS_ON,
		p_end,
	BlendRenderElement::shadowOn, _T("shadowOn"), TYPE_BOOL, 0, IDS_SHADOW_ON,
		p_default, TRUE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_SHADOW_ON,
		p_end,
	...
	BlendRenderElement::inkOn, _T("inkOn"), TYPE_BOOL, 0, IDS_INK_ON,
		p_default, TRUE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_INK_ON,
		p_end,
	BlendRenderElement::paintOn, _T("paintOn"), TYPE_BOOL, 0, IDS_PAINT_ON,
		p_default, TRUE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_PAINT_ON,
		p_end,
...
void BlendRenderElement::PostIllum(ShadeContext& sc, IllumParams& ip)
{
	...
	if( ip.pMtl == NULL ){ // bgnd
		...
		n = ip.FindUserIllumName(_T("Paint"));
		if(IsPaintOn() && n>=0 )
			c += ip.finalAttenuation * (ip.GetUserIllumOutput(n));
		
		n = ip.FindUserIllumName(_T("Ink"));
		if( IsInkOn() && n>=0 )
			c += ip.finalAttenuation * (ip.GetUserIllumOutput(n));
...
public:
	...
	TSTR GetName(bool localized) const override { return localized ? GetString(IDS_MOTION_RENDER_ELEMENT) : _T("Velocity"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Velocity"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID		ClassID() { return motionRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
static ParamBlockDesc2 MotionRenderElementParamBlk(PBLOCK_NUMBER, _T("Motion render element parameters"), 0, &motionRenderElementCD, P_AUTO_CONSTRUCT + P_AUTO_UI, PBLOCK_REF,
		...
		p_default, FALSE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_VELOCITY_UPDATE,
		p_end,
		p_end
		);
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_Z_RENDER_ELEMENT) : _T("Z Depth"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Z Depth"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return ZRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
//		p_accessor,		&extendedPBAccessor,
	...
	ZRenderElement::ZUpdate, _T("zUpdate"), TYPE_BOOL, 0, IDS_ZDEPTH_UPDATE,
		p_default, FALSE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_ZDEPTH_UPDATE,
		p_end,
	p_end
	);
...
public:
	...
	TSTR GetName(bool localized) const override { return localized ? GetString(IDS_MATERIALID_RENDER_ELEMENT) : _T("Material ID"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Material ID"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return MaterialIDRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
...
public:
	...
	TSTR GetName(bool localized) const override { return localized ? GetString(IDS_OBJECTID_RENDER_ELEMENT) : _T("Object ID"); }
	SFXParamDlg *CreateParamDialog(IRendParams *ip);
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Object ID"); }
	SClass_ID		SuperClassID() { return RENDER_ELEMENT_CLASS_ID; }
	Class_ID 		ClassID() { return ObjectIDRenderElementClassID; }
	const TCHAR* 	Category() { return _T(""); }
