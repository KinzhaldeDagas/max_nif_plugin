    ...
    m_monitored_camera_node(nullptr)
{
    ...
    {
        m_notification_client->MonitorActiveShadeView(*this, nullptr);
    }
...
void CameraContainer_Interactive::InteractiveRenderingCallback_NotifyEvent(const IViewEvent& view_event, void* /*userData*/)
{
    ...
    {
    case EventType_View_Type:
        // We get this notification whenever the active viewport type changed - say we are going from persp view to top view or from a camera view to a persp view. 
        //So we need to fetch the entire view parameters again.
        // Fall into...
    ...
    case EventType_View_Deleted:
        ...
        break;
    case EventType_View_NodesFiltered:
    {
        //TODO: Enable this when PerViewFilter affect rendering
        //Some nodes were filtered in/out from the ActiveShade viewport
        //Invalidate();//Should trigger a rebuild of the scene (taking into account filtered in/out nodes)
    }
    break;
    default:
