...
public:
		...
		void			GetClassName(MSTR& s, bool localized) const { s = localized ? GetString(IDS_FILM_GRAIN_EFFECT) : _T("Film Grain"); }
		...
		TSTR			GetName(bool localized) const override { return localized ? GetString(IDS_FILM_GRAIN_EFFECT) : _T("Film Grain"); }
