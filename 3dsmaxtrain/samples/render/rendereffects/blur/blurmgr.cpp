...
// paramMap pointers
// -----------------
IParamMap2 *BlurMgr::pmMain     = NULL;
...
// dialog procs
// ------------
MainDlgProc	BlurMgr::mainDlgProc;
BlurDataDlgProc	BlurMgr::blurDataDlgProc(&mainDlgProc);
SelDataDlgProc	BlurMgr::selDataDlgProc(&mainDlgProc);

// ----------------------
// paramblock descriptors
// ----------------------
ParamBlockDesc2 BlurMgr::pbdMain(idMain, _T("blur effect parameters"), 0, &blurMgrCD, P_AUTO_CONSTRUCT + P_AUTO_UI, idMain,
	//rollout
	IDD_MAIN, IDS_PARAMS, 0, 0, &mainDlgProc,
...
ParamBlockDesc2 BlurMgr::pbdBlurData(idBlurData, _T("blurData"), 0, &blurMgrCD, P_AUTO_CONSTRUCT, idBlurData,
	...
	prmBlurType, _T("blur_type"), TYPE_RADIOBTN_INDEX, P_ANIMATABLE, IDS_BLUR_TYPE,
		...
		p_nonLocalizedName, _T("Blur Type"),
		p_end,
	// BlurUniform
	prmUnifPixRad, _T("bUnifPixRad"), TYPE_FLOAT, P_ANIMATABLE, IDS_BUNIF_PIXEL_RAD,
		...
		p_nonLocalizedName, _T("Blur Uniform Pixel Radius"),
		p_end,
	prmUnifAlpha, _T("bUnifAlpha"), TYPE_BOOL, P_ANIMATABLE, IDS_BUNIF_ALPHA,
		p_default, TRUE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_BUNIF_ALPHA,
		p_nonLocalizedName, _T("Blur Uniform Affect Alpha"),
		p_end,
	// BlurDirectional
	prmDirUPixRad, _T("bDirUPixRad"), TYPE_FLOAT, P_ANIMATABLE, IDS_BDIR_UPIX_RAD,
		...
		p_nonLocalizedName, _T("Blur Directional U Pixel Radius"),
		p_end,
	prmDirVPixRad, _T("bDirVPixRad"), TYPE_FLOAT, P_ANIMATABLE, IDS_BDIR_VPIX_RAD,
		...
		p_nonLocalizedName, _T("Blur Directional V Pixel Radius"),
		p_end,
	prmDirUTrail, _T("bDirUTrail"), TYPE_FLOAT, P_ANIMATABLE, IDS_BDIR_UTRAIL,
		...
		p_nonLocalizedName, _T("Blur Directional U Trail"),
		p_end,
	prmDirVTrail, _T("bDirVTrail"), TYPE_FLOAT, P_ANIMATABLE, IDS_BDIR_VTRAIL,
		...
		p_nonLocalizedName, _T("Blur Directional V Trail"),
		p_end,
	prmDirRot, _T("bDirRotation"), TYPE_INT, P_ANIMATABLE, IDS_BDIR_ROTATION,
		...
		p_nonLocalizedName, _T("Blur Directional Rotation"),
		p_end,
	prmDirAlpha, _T("bDirAlpha"), TYPE_BOOL, P_ANIMATABLE, IDS_BDIR_ALPHA,
		p_default, TRUE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_BDIR_ALPHA,
		p_nonLocalizedName, _T("Blur Directional Affect Alpha"),
		p_end,
	// BlurRadial
	prmRadialPixRad, _T("bRadialPixRad"), TYPE_FLOAT, P_ANIMATABLE, IDS_BRADIAL_PIXEL_RAD,
		...
		p_nonLocalizedName, _T("Blur Radial Pixel Radius"),
		p_end,
	prmRadialTrail, _T("bRadialTrail"), TYPE_FLOAT, P_ANIMATABLE, IDS_BRADIAL_TRAIL,
		...
		p_nonLocalizedName, _T("Blur Radial Trail"),
		p_end,
	prmRadialAlpha, _T("bRadialAlpha"), TYPE_BOOL, P_ANIMATABLE, IDS_BRADIAL_ALPHA,
		p_default, TRUE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_BRADIAL_ALPHA,
		p_nonLocalizedName, _T("Blur Radial Affect Alpha"),
		p_end,
	prmRadialXOrig, _T("bRadialXOrig"), TYPE_INT, P_ANIMATABLE, IDS_BRADIAL_XORIGIN,
		...
		p_nonLocalizedName, _T("Blur Radial X Origin"),
		p_end,
	prmRadialYOrig, _T("bRadialYOrig"), TYPE_INT, P_ANIMATABLE, IDS_BRADIAL_YORIGIN,
		...
		p_nonLocalizedName, _T("Blur Radial Y Origin"),
		p_end,
	prmRadialUseNode, _T("bRadialUseNode"), TYPE_BOOL, P_ANIMATABLE, IDS_BRADIAL_USE_NODE,
		p_default, FALSE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_BRADIAL_USE_NODE,
		p_nonLocalizedName, _T("Blur Radial Use Object"),
		p_end,
	prmRadialNode, _T("bRadialNode"), TYPE_INODE, 0, IDS_BRADIAL_NODE,	// not animatable
		...
		p_nonLocalizedName, _T("Blur Radial Object"),
		p_end,
	p_end
	);
...
ParamBlockDesc2 BlurMgr::pbdSelData(idSelData, _T("selectionData"), 0, &blurMgrCD, P_AUTO_CONSTRUCT, idSelData,
	...
	prmImageActive, _T("selImageActive"), TYPE_BOOL, P_ANIMATABLE, IDS_SIMAGE_ACTIVE,
		p_default, TRUE,
		p_ui, TYPE_SINGLECHECKBOX, IDC_SIMAGE_ACTIVE,
		p_enable_ctrls, 2, prmImageBrighten, prmImageBlend,
		p_nonLocalizedName, _T("Select Image Active"),
		p_end,
	prmImageBrighten, _T("selImageBrighten"), TYPE_FLOAT, P_ANIMATABLE, IDS_SIMAGE_BRIGHTEN,
		...
		p_nonLocalizedName, _T("Select Image Brighten"),
		p_end,
	...
	prmIBackBrighten, _T("selIBackBrighten"), TYPE_FLOAT, P_ANIMATABLE, IDS_SIBACK_BRIGHTEN,
		...
		p_nonLocalizedName, _T("Select Non-Bkgrnd Brighten"),
		p_end,
	prmIBackBlend, _T("selIBackBlend"), TYPE_FLOAT, P_ANIMATABLE, IDS_SIBACK_BLEND,
		...
		p_nonLocalizedName, _T("Select Non-Bkgrnd Blend"),
		p_end,
	...
	prmLumBrighten, _T("selLumBrighten"), TYPE_FLOAT, P_ANIMATABLE, IDS_SLUM_BRIGHTEN,
		...
		p_nonLocalizedName, _T("Select Luminance Brighten"),
		p_end,
	prmLumBlend, _T("selLumBlend"), TYPE_FLOAT, P_ANIMATABLE, IDS_SLUM_BLEND,
		...
		p_nonLocalizedName, _T("Select Luminance Blend"),
		p_end,
	prmLumMin, _T("selLumMin"), TYPE_FLOAT, P_ANIMATABLE, IDS_SLUM_MIN,
		...
		p_nonLocalizedName, _T("Select Luminance Min"),
		p_end,
	prmLumMax, _T("selLumMax"), TYPE_FLOAT, P_ANIMATABLE, IDS_SLUM_MAX,
		...
		p_nonLocalizedName, _T("Select Luminance Max"),
		p_end,
	...
	prmMaskBrighten, _T("selMaskBrighten"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMASK_BRIGHTEN,
		...
		p_nonLocalizedName, _T("Select Mask Brighten"),
		p_end,
	prmMaskBlend, _T("selMaskBlend"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMASK_BLEND,
		...
		p_nonLocalizedName, _T("Select Mask Blend"),
		p_end,
	prmMaskMin, _T("selMaskMin"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMASK_MIN,
		...
		p_nonLocalizedName, _T("Select Mask Min"),
		p_end,
	prmMaskMax, _T("selMaskMax"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMASK_MAX,
		...
		p_nonLocalizedName, _T("Select Mask Max"),
		p_end,
	...
	prmObjIdsIds, _T("selObjIdsIds"), TYPE_INT_TAB, 0, P_ANIMATABLE | P_VARIABLE_SIZE, IDS_SOBJIDS_IDS,
		...
		p_nonLocalizedName, _T("Select ObjIds Ids"),
		p_end,
	prmObjIdsBrighten, _T("selObjIdsBrighten"), TYPE_FLOAT, P_ANIMATABLE, IDS_SOBJIDS_BRIGHTEN,
		...
		p_nonLocalizedName, _T("Select ObjIds Brighten"),
		p_end,
	prmObjIdsBlend, _T("selObjIdsBlend"), TYPE_FLOAT, P_ANIMATABLE, IDS_SOBJIDS_BLEND,
		...
		p_nonLocalizedName, _T("Select ObjIds Blend"),
		p_end,
	prmObjIdsFeathRad, _T("selObjIdsFRadius"), TYPE_FLOAT, P_ANIMATABLE, IDS_SOBJIDS_FEATHER_RAD,
		...
		p_nonLocalizedName, _T("Select ObjIds Feather Radius"),
		p_end,
	prmObjIdsLumMin, _T("selObjIdsLumMin"), TYPE_FLOAT, P_ANIMATABLE, IDS_SOBJIDS_LUM_MIN,
		...
		p_nonLocalizedName, _T("Select ObjIds Min Luminance"),
		p_end,
	...
	prmMatIdsIds, _T("selMatIdsIds"), TYPE_INT_TAB, 0, P_ANIMATABLE | P_VARIABLE_SIZE, IDS_SMATIDS_IDS,
		...
		p_nonLocalizedName, _T("Select MatIds Ids"),
		p_end,
	prmMatIdsBrighten, _T("selMatIdsBrighten"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMATIDS_BRIGHTEN,
		...
		p_nonLocalizedName, _T("Select MatIds Brighten"),
		p_end,
	prmMatIdsBlend, _T("selMatIdsBlend"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMATIDS_BLEND,
		...
		p_nonLocalizedName, _T("Select MatIds Blend"),
		p_end,
	prmMatIdsFeathRad, _T("selMatIdsFRadius"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMATIDS_FEATHER_RAD,
		...
		p_nonLocalizedName, _T("Select MatIds Feather Radius"),
		p_end,
	prmMatIdsLumMin, _T("selMatIdsLumMin"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMATIDS_LUM_MIN,
		...
		p_nonLocalizedName, _T("Select MatIds Min Luminance"),
		p_end,
	prmMatIdsLumMax, _T("selMatIdsLumMax"), TYPE_FLOAT, P_ANIMATABLE, IDS_SMATIDS_LUM_MAX,
		...
		p_nonLocalizedName, _T("Select MatIds Max Luminance"),
		p_end,
	prmGenBrightType, _T("selGenBrightType"), TYPE_RADIOBTN_INDEX, P_ANIMATABLE, IDS_SEL_BRIGHT_TYPE,
		...
		p_nonLocalizedName, _T("Select Brighten Type"),
		p_end,
	p_end
	);
...
BlurMgr::BlurMgr() :
	pbMain(NULL), pbBlurData(NULL), pbSelData(NULL), mp_CCtl(NULL),
...
// ----------------------------------------------------------------------------
{
	...
	assert(	pbMain && pbBlurData && pbSelData);
...
{	
    // create the main rollout dialog
    IAutoEParamDlg* dlg = blurMgrCD.CreateParamDialog(pbMain->ID(), ip, this);
	pmMain = dlg->GetMap();

	// create the blur types child dialogs
	pmBlurData = CreateChildRParamMap2(pbBlurData, ip, hInstance,
									   pmMain, MAKEINTRESOURCE(IDD_BLUR_TYPES),
	...
	pmSelData = CreateChildRParamMap2(pbSelData, ip, hInstance,
									  pmMain, MAKEINTRESOURCE(IDD_SEL_TYPES),
									  GetString(IDS_SEL_TYPES), &selDataDlgProc);

	// tell the main dialog we're done adding children
	mainDlgProc.notifyChildrenCreated(this);
...
TSTR BlurMgr::SubAnimName(int i, bool localized)
{
	switch (i)
	{
	case idMain:       return localized ? GetString(IDS_BLUR_PARAMS)       : _T("Blur Parameters");
	case idBlurData:     return localized ? GetString(IDS_BLUR_TYPE)         : _T("Blur Type");
	case idSelData:      return localized ? GetString(IDS_SEL_TYPES)         : _T("Pixel Selections");
	case idSelCurveCtrl: return localized ? GetString(IDS_SEL_FALLOFF_CURVE) : _T("Select Falloff Curve");
	default:             return _T("");
	}
}
...
RefResult BlurMgr::NotifyRefChanged(const Interval& changeInt, RefTargetHandle hTarget, PartID& partID, RefMessage message, BOOL propagate)
{
	ParamID prmID = -1;
	...
	switch (message) {
		case REFMSG_CHANGE:
			if (hTarget == pbMain)
			{
				pbdMain.InvalidateUI(pbMain->LastNotifyParamID());
				return REF_SUCCEED;
			}
