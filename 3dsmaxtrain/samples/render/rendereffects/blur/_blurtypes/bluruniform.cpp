...
void BlurUniform::notifyPrmChanged(ParamID prmID)
{
	switch (prmID)
	{
		case prmUnifPixRad:
...
bool BlurUniform::doBlur(CompMap *pCompMap, BitmapAccessor &bmFrom, BitmapAccessor &bmTo )
{
	...
	return BlurDirectional::doBlur(pCompMap, bmFrom, bmTo);
}
