...
class GenericKernel: public FilterKernel {
	public:
		...
		// From Animatable
		void*GetInterface(ULONG id) {  return FilterKernel::GetInterface(id); }
		void DeleteThis() { delete this; }
		int NumSubs() {return 0;}
		Animatable* SubAnim(int i){ return NULL; }
		TSTR SubAnimName(int i, bool localized) override { return _T(""); }
		virtual const TCHAR *GetObjectName(bool localized) const { return NULL; } // dummy, overridden by subclass
		void GetClassName(MSTR& s, bool localized) const override { s = GetObjectName(localized); };
		TSTR GetName(bool localized) const override { TSTR s = GetObjectName(localized); return s; };
...
//		}
		...
		virtual const TCHAR * GetFilterParamName( long nParam ) { return GetString( IDS_KE_BLANK ); }
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_AREA_KERNEL) : _T("Area"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_AREA_COMMENT); }
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_PIXELSIZE_KERNEL) : _T("Plate Match/MAX R2"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_PIXELSIZE_COMMENT); }
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_CONE_KERNEL) : _T("Cone"); }
//		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_CONE_COMMENT); }
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_QUADRATIC_KERNEL) : _T("Quadratic"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_QUAD_COMMENT); }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_CUBIC_KERNEL) : _T("Cubic"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_CUBIC_COMMENT); }
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_CATROM_KERNEL) : _T("Catmull-Rom"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_CATROM_COMMENT); }
		long GetKernelSupport() { return 2; };
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_GAUSS_NARROW_KERNEL) : _T("Narrow Gauss"); }
		long GetKernelSupport() { return 1; };
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_GAUSS_MEDIUM_KERNEL) : _T("Medium Gauss"); }
		long GetKernelSupport() { return 1; };
		void GetKernelSz( double& x, double& y ){ x = 1.5; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_GAUSS_WIDE_KERNEL) : _T("Wide Gauss"); }
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_PAVIC_UNITVOL_KERNEL) : _T("Pavic Unit Vol"); }
		long GetKernelSupport() { return 1; };
		void GetKernelSz( double& x, double& y ){ x = 1.0; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_PAVIC_OP_KERNEL) : _T("Pavic Op"); }
		long GetKernelSupport() { return 1; };
		void GetKernelSz( double& x, double& y ){ x = 1.0; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_HANNING_KERNEL) : _T("Hanning"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_HANNING_COMMENT); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_HAMMING_KERNEL) : _T("Hamming"); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_BLACKMAN_KERNEL) : _T("Exact Blackman"); }
		bool HasNegativeLobes(){ return TRUE; };
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_BLACKMAN361_KERNEL) : _T("Blackman 3-61"); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_BLACKMAN367_KERNEL) : _T("Blackman 3-67"); }
		bool HasNegativeLobes(){ return TRUE; };
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_BLACKMAN474_KERNEL) : _T("Blackman"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_BLACKMAN_COMMENT); }
		bool HasNegativeLobes(){ return TRUE; };
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_BLACKMAN492_KERNEL) : _T("Blackman 4-92"); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_MAX1_KERNEL) : _T("Sharp Quadratic"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_MAX_COMMENT); }
		long GetKernelSupport() { return 1; };
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_MAX2_KERNEL) : _T("Max 2"); }
		long GetKernelSupport() { return 1; };
		void GetKernelSz( double& x, double& y ){ x = 1.4; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_MAX3_KERNEL) : _T("Max 3"); }
		long GetKernelSupport() { return 1; };
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_MITNET_OP_KERNEL) : _T("Mitchell-Netravali"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_MITNET_COMMENT); }
		bool HasNegativeLobes(){ return TRUE; };
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_NTSC_KERNEL) : _T("Video"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_NTSC_COMMENT); }
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_MITNET_NOTCH_KERNEL) : _T("MitNet Notch"); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_COOK_OP_KERNEL) : _T("Cook Op"); }
		long GetKernelSupport() { return 2; }
		void GetKernelSz( double& x, double& y ){ x = 1.5; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
class CylinderVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_CYLINDER_VAR_KERNEL) : _T("Coarse Soften"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_CYLVAR_COMMENT); }
		long GetKernelSupport() { return long( w + 0.5 ); }
		bool IsVariableSz(){ return TRUE; };
...
class ConeVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_CONE_VAR_KERNEL) : _T("Cone Soften"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_CONEVAR_COMMENT); }
		long GetKernelSupport() { return long( w + 0.5 ); }
		bool IsVariableSz(){ return TRUE; };
		// 1-D filters ignore the y parameter
...
class QuadraticVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_QUADRATIC_VAR_KERNEL) : _T("Quadratic Soften"); }
		long GetKernelSupport() { return long( w + 0.5 ); }
		bool IsVariableSz(){ return TRUE; };
		// 1-D filters ignore the y parameter
...
class CubicVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_CUBIC_VAR_KERNEL) : _T("Cubic Soften"); }
		long GetKernelSupport() { return long( w + 0.5 ); }
		bool IsVariableSz(){ return TRUE; };
		// 1-D filters ignore the y parameter
...
class CookVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_COOK_VAR_KERNEL) : _T("Cook Variable"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_COOK_COMMENT); }
		long GetKernelSupport() { return long( w + 0.5 ); }
		bool IsVariableSz(){ return TRUE; };
		// 1-D filters ignore the y parameter
//		void SetKernelSz( double x, double y = 0.0 ) { w = (x == 0.0)? 1.5 : x; };
...
class GaussVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_GAUSS_VAR_KERNEL) : _T("Soften"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_GAUSSVAR_COMMENT); }
		long GetKernelSupport() { return long( w + 0.5 ); }
		bool IsVariableSz(){ return TRUE; };
		// 1-D filters ignore the y parameter
//		void SetKernelSz( double x, double y = 0.0 ) { w = (x == 0.0)? 1.5 : x; };
...
class GenericKernelClassDesc2:public ClassDesc2 {
	public:
	int 			IsPublic() { return 1; }
	SClass_ID		SuperClassID() { return FILTER_KERNEL_CLASS_ID; }
...
class AreaKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new AreaFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_AREA_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Area"); }
	Class_ID		ClassID() { return AreaKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Area" ); }
};
...
//	 PixelsSize filter, for 2.5 compatibility & camera mapping
#ifdef INCLUDE_PIXELSIZE 
class PixelSizeKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new PixelSizeKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_PIXELSIZE_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Plate Match/MAX R2"); }
	Class_ID		ClassID() { return PixelSizeKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Plate_Match_MAX_R2" ); }
};
static PixelSizeKernelClassDesc pixelSizeCD;
ClassDesc* GetPixelSizeKernelDesc() {return &pixelSizeCD;}
#endif ////////////////////////////////////////////////////////////////////////

class ConeKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new ConeFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_CONE_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Cone"); }
	Class_ID		ClassID() { return ConeKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Cone" ); }
};
static ConeKernelClassDesc coneCD;
ClassDesc* GetConeKernelDesc() {return &coneCD;}

class QuadraticKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new QuadraticFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_QUADRATIC_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Quadratic"); }
	Class_ID		ClassID() { return QuadraticKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Quadratic" ); }
};
static QuadraticKernelClassDesc quadCD;
ClassDesc* GetQuadraticKernelDesc() {return &quadCD;}

class CubicKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new CubicFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_CUBIC_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Cubic"); }
	Class_ID		ClassID() { return CubicKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Cubic" ); }
};
static CubicKernelClassDesc cubicCD;
ClassDesc* GetCubicKernelDesc() {return &cubicCD;}

class CatRomKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new CatRomFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_CATROM_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Catmull-Rom"); }
	Class_ID		ClassID() { return CatRomKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Catmull_Rom" ); }
};
static CatRomKernelClassDesc CatRomCD;
ClassDesc* GetCatRomKernelDesc() {return &CatRomCD;}

class GaussNarrowKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new GaussNarrowFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_GAUSS_NARROW_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Narrow Gauss"); }
	Class_ID		ClassID() { return GaussNarrowKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Narrow_Gauss" ); }
};
static GaussNarrowKernelClassDesc GaussNarrowCD;
ClassDesc* GetGaussNarrowKernelDesc() {return &GaussNarrowCD;}

class GaussMediumKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new GaussMediumFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_GAUSS_MEDIUM_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Medium Gauss"); }
	Class_ID		ClassID() { return GaussMediumKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Medium_Gauss" ); }
};
static GaussMediumKernelClassDesc GaussMediumCD;
ClassDesc* GetGaussMediumKernelDesc() {return &GaussMediumCD;}

class GaussWideKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new GaussWideFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_GAUSS_WIDE_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Wide Gauss"); }
	Class_ID		ClassID() { return GaussWideKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Wide_Gauss" ); }
};
static GaussWideKernelClassDesc GaussWideCD;
ClassDesc* GetGaussWideKernelDesc() {return &GaussWideCD;}

class PavicUnitVolKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new PavicUnitVolFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_PAVIC_UNITVOL_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Pavic Unit Vol"); }
	Class_ID		ClassID() { return PavicUnitVolKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Pavic_Unit_Vol" ); }
};
static PavicUnitVolKernelClassDesc PavicUnitVolCD;
ClassDesc* GetPavicUnitVolKernelDesc() {return &PavicUnitVolCD;}

class PavicOpKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new PavicOpFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_PAVIC_OP_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Pavic Op"); }
	Class_ID		ClassID() { return PavicOpKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Pavic_Op" ); }
};
static PavicOpKernelClassDesc PavicOpCD;
ClassDesc* GetPavicOpKernelDesc() {return &PavicOpCD;}

class HanningKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new HanningFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_HANNING_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Hanning"); }
	Class_ID		ClassID() { return HanningKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Hanning" ); }
};
static HanningKernelClassDesc HanningCD;
ClassDesc* GetHanningKernelDesc() {return &HanningCD;}

class HammingKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new HammingFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_HAMMING_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Hamming"); }
	Class_ID		ClassID() { return HammingKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Hamming" ); }
};
static HammingKernelClassDesc HammingCD;
ClassDesc* GetHammingKernelDesc() {return &HammingCD;}

class BlackmanKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new BlackmanFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_BLACKMAN_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Exact Blackman"); }
	Class_ID		ClassID() { return BlackmanKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Exact_Blackman" ); }
};
static BlackmanKernelClassDesc BlackmanCD;
ClassDesc* GetBlackmanKernelDesc() {return &BlackmanCD;}

class Blackman367KernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new Blackman367FilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_BLACKMAN367_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Blackman 3-67"); }
	Class_ID		ClassID() { return Blackman367KernelClassID; }
	const MCHAR*	InternalName() { return _M( "Blackman_3_67" ); }
};
static Blackman367KernelClassDesc Blackman367CD;
ClassDesc* GetBlackman367KernelDesc() {return &Blackman367CD;}

class Blackman361KernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new Blackman361FilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_BLACKMAN361_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Blackman 3-61"); }
	Class_ID		ClassID() { return Blackman361KernelClassID; }
	const MCHAR*	InternalName() { return _M( "Blackman_3_61" ); }
};
static Blackman361KernelClassDesc Blackman361CD;
ClassDesc* GetBlackman361KernelDesc() {return &Blackman361CD;}

class Blackman474KernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new Blackman474FilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_BLACKMAN474_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Blackman"); }
	Class_ID		ClassID() { return Blackman474KernelClassID; }
	const MCHAR*	InternalName() { return _M( "Blackman" ); }
};
static Blackman474KernelClassDesc Blackman474CD;
ClassDesc* GetBlackman474KernelDesc() {return &Blackman474CD;}

class Blackman492KernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new Blackman492FilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_BLACKMAN492_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Blackman 4-92"); }
	Class_ID		ClassID() { return Blackman492KernelClassID; }
	const MCHAR*	InternalName() { return _M( "Blackman_4_92" ); }
};
static Blackman492KernelClassDesc Blackman492CD;
ClassDesc* GetBlackman492KernelDesc() {return &Blackman492CD;}

class	Max1KernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new Max1FilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_MAX1_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Sharp Quadratic"); }
	Class_ID		ClassID() { return Max1KernelClassID; }
	const MCHAR*	InternalName() { return _M( "Sharp_Quadratic" ); }
};
static Max1KernelClassDesc Max1CD;
ClassDesc* GetMax1KernelDesc() {return &Max1CD;}

class	Max2KernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new Max2FilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_MAX2_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Max 2"); }
	Class_ID		ClassID() { return Max2KernelClassID; }
	const MCHAR*	InternalName() { return _M( "Max_2" ); }
};
static Max2KernelClassDesc Max2CD;
ClassDesc* GetMax2KernelDesc() {return &Max2CD;}

class	Max3KernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new Max3FilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_MAX3_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Max 3"); }
	Class_ID		ClassID() { return Max3KernelClassID; }
	const MCHAR*	InternalName() { return _M( "Max_3" ); }
};
static Max3KernelClassDesc Max3CD;
ClassDesc* GetMax3KernelDesc() {return &Max3CD;}

class	MitNetOpKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new MitNetOpFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_MITNET_OP_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Mitchell-Netravali"); }
	Class_ID		ClassID() { return MitNetOpKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Mitchell_Netravali" ); }
};
static MitNetOpKernelClassDesc MitNetOpCD;
ClassDesc* GetMitNetOpKernelDesc() {return &MitNetOpCD;}

class	MitNetNotchKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new MitNetNotchFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_MITNET_NOTCH_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("MitNet Notch"); }
	Class_ID		ClassID() { return MitNetNotchKernelClassID; }
	const MCHAR*	InternalName() { return _M( "MitNet_Notch" ); }
};
static MitNetNotchKernelClassDesc MitNetNotchCD;
ClassDesc* GetMitNetNotchKernelDesc() {return &MitNetNotchCD;}

class	NTSCKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new NTSCFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_NTSC_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Video"); }
	Class_ID		ClassID() { return NTSCKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Video" ); }
};
static NTSCKernelClassDesc NtscCD;
ClassDesc* GetNTSCKernelDesc() {return &NtscCD;}

class	CookOpKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new CookOpFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_COOK_OP_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Cook Op"); }
	Class_ID		ClassID() { return CookOpKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Cook_Op" ); }
};
static CookOpKernelClassDesc CookOpCD;
ClassDesc* GetCookOpKernelDesc() {return &CookOpCD;}

// ----------------- soften filters -----------------------------
class	GaussVarKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new GaussVarFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_GAUSS_VAR_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Soften"); }
	Class_ID		ClassID() { return GaussVarKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Soften" ); }
};
static GaussVarKernelClassDesc GaussVarCD;
ClassDesc* GetGaussVarKernelDesc() {return &GaussVarCD;}

class	CookVarKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new CookVarFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_COOK_VAR_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Cook Variable"); }
	Class_ID		ClassID() { return CookVarKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Cook_Variable" ); }
	bool IsVariableSz(){ return TRUE; };
};
...
class	CylinderVarKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new CylinderVarFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_CYLINDER_VAR_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Coarse Soften"); }
	Class_ID		ClassID() { return CylinderVarKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Coarse_Soften" ); }
	bool IsVariableSz(){ return TRUE; };
};
...
class	ConeVarKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new ConeVarFilterKernel; }
	const TCHAR*	ClassName() { return GetString(IDS_KE_CONE_VAR_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Cone Soften"); }
	Class_ID		ClassID() { return ConeVarKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Cone_Soften" ); }
	bool IsVariableSz(){ return TRUE; };
};
static ConeVarKernelClassDesc ConeVarCD;
ClassDesc* GetConeVarKernelDesc() {return &ConeVarCD;}

class	QuadraticVarKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new QuadraticVarFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_QUADRATIC_VAR_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Quadratic Soften"); }
	Class_ID		ClassID() { return QuadraticVarKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Quadratic_Soften" ); }
	bool IsVariableSz(){ return TRUE; };
};
static QuadraticVarKernelClassDesc QuadraticVarCD;
ClassDesc* GetQuadraticVarKernelDesc() {return &QuadraticVarCD;}

class	CubicVarKernelClassDesc : public GenericKernelClassDesc2 {
public:
	void*			Create(BOOL loading) { return new CubicVarFilterKernel; }
	const MCHAR*	ClassName() { return GetString(IDS_KE_CUBIC_VAR_KERNEL); }
	const MCHAR*	NonLocalizedClassName() { return _M("Cubic Soften"); }
	Class_ID		ClassID() { return CubicVarKernelClassID; }
	const MCHAR*	InternalName() { return _M( "Cubic_Soften" ); }
	bool IsVariableSz(){ return TRUE; };
};
...
private:
		virtual void SetReference(int i, RefTargetHandle rTarget);
public:
...
//		FilterKernelParamDlg * CreateParamDialog(IRendParams *ip);
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_MITNET_VAR_KERNEL) : _T("Mitchell-Netravali"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_MITNET_COMMENT); }
		
		// support both the optional parameters
		long GetNFilterParams() { return 2; }
		const TCHAR * GetFilterParamName( long nParam ) { 
...
{
	pParamBlock = NULL;
	ReplaceReference(0, CreateParameterBlock(MitNetDescV0, MNPBLOCK_LENGTH, MNCURRENT_VERSION));
	assert(pParamBlock);
	b = c = 0.33333f;
...
TSTR MitNetVarFilterKernel::SubAnimName(int i, bool localized)
{
	switch (i)
	{
	case 0: return localized ? GetString(IDS_KE_MITNET_PARAMS) : _T("Mitchell / Netravali Kernel Parameters");
	default: return _T("");
	}
}
		...
		PartID& partID, RefMessage message, BOOL propagate) 
{
	switch (message) {
		...
		case REFMSG_GET_PARAM_NAME_NONLOCALIZED: {
			GetParamName *gpn = (GetParamName*)partID;
			switch (gpn->index) {
				case PB_B: gpn->name = _T("Blur:");    break;
				case PB_C: gpn->name = _T("Ringing:"); break;
				default:   gpn->name = _T("");         break;
			}
			return REF_HALT;
		}
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Mitchell-Netravali"); }
	Class_ID		ClassID() { return MitNetVarKernelClassID; }
};
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_STOCKING_KERNEL) : _T("Fine Blend"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_STOCKING_COMMENT); }
		
		// support both the optional parameters
		long GetNFilterParams() { return N_STOCKING_FILTER_PARAMS; }
		const TCHAR * GetFilterParamName( long nParam ) { return  GetString( nParam==0 ? IDS_KE_STOCKING_BLEND: IDS_KE_STOCKING_SHARPNESS ); }
...
{
	pParamBlock = NULL;
	ReplaceReference(0, CreateParameterBlock(StockingDescV0, STPBLOCK_LENGTH, STCURRENT_VERSION));
	assert(pParamBlock);
	blend = 0.3f;
	w = 4.0;
...
TSTR StockingFilterKernel::SubAnimName(int i, bool localized)
{
	switch (i)
	{
	case 0: return localized ? GetString(IDS_KE_STOCKING_PARAMS) : _T("Parameters");
	default: return _T("");
	}
}
		...
		PartID& partID, RefMessage message, BOOL propagate) 
{
	switch (message) {
		...
		case REFMSG_GET_PARAM_NAME_NONLOCALIZED: {
			GetParamName *gpn = (GetParamName*)partID;
			switch (gpn->index) {
				case PB_BLEND:     gpn->name = _T("Blend:");     break;
				case PB_SHARPNESS: gpn->name = _T("Sharpness:"); break;
				default:           gpn->name = _T("");           break;
			}
			return REF_HALT;
		}
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Fine Blend"); }
	Class_ID		ClassID() { return StockingKernelClassID; }
};
...
public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_KE_BLEND_KERNEL) : _T("Blend"); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_BLEND_COMMENT); }
		
		// support both the optional parameters
		long GetNFilterParams() { return 1; }
		const TCHAR * GetFilterParamName( long nParam ) { return  nParam==0 ? GetString(IDS_KE_STOCKING_BLEND) : NULL; }
...
{
	pParamBlock = NULL;
	ReplaceReference(0, CreateParameterBlock(BlendDescV0, BLPBLOCK_LENGTH, BLCURRENT_VERSION));
	assert(pParamBlock);
	blend = 0.3f;
	w = 4.0;
	pParamBlock->SetValue( PB_BLEND, 0, blend );
...
TSTR BlendFilterKernel::SubAnimName(int i, bool localized)
{
	switch (i)
	{
	case 0: return localized ? GetString(IDS_KE_STOCKING_PARAMS) : _T("Parameters");
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Blend"); }
	Class_ID		ClassID() { return BlendKernelClassID; }
};
