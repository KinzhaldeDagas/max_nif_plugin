...
#define MAXVER_INTERNALNAME "NotificationSystem\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "NotificationSystem.dll\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "3ds Max NotificationSystem (plugin)\0"//should  be overidden on a per-dll level
