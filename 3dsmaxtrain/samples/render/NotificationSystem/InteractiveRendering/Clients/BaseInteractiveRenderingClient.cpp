    ...
    )
{
    ...
    if (Max::InteractiveRendering::Utils::IsActiveShadeViewLocked() ){
...
void BaseInteractiveRenderingClient::ActiveCameraWasDeleted(const INodeEvent& node_event)
{
    ...
    const bool UseOldviewID = Max::InteractiveRendering::Utils::IsActiveShadeViewLocked(); //Takes care of active shade locked
