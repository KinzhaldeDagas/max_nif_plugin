...
using namespace MaxSDK::NotificationAPI;
    ...
    //The manager
    class NotificationManager : public INotificationManager2
	{
    private:
	...
	public:
        ...
        // -- inherited from INotificationManager2
        virtual void NotifyViewEvent(const ViewEventType eventType, const int viewID) const override;
