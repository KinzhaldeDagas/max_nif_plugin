...
//	ShadeContext* pSC;
	...
	public:
		...
		TSTR SubAnimName(int i, bool localized) override { return i ? _T("") : (localized ? GetString(IDS_KE_PARAMETERS) : _T("Parameters")); }
...
private:
		...
		{
			if ( i == 0 ) 
				pParamBlk = (IParamBlock*)rtarg;
		}
public:
		Class_ID ClassID() {return R25SamplerClassID;};
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_R25_SAMPLER) : _T("Max 2.5 Star"); }
...
//								ShadeContext* sc, MASK pMask );
		...
		const TCHAR* GetDefaultComment(){	return GetString(IDS_KE_R25_COMMENT); }
...
class R25SamplerClassDesc : public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Max 2.5 Star"); }
...
R25Sampler::R25Sampler()
{
	...
	ReplaceReference(0, CreateParameterBlock(pbDesc, PBLOCK_LENGTH, PB_CURRENT_VERSION));
	DbgAssert(pParamBlk);
...
RefResult R25Sampler::NotifyRefChanged(
		...
		PartID& partID, RefMessage message, BOOL propagate) 
{
	return intNotifyRefChanged( changeInt, hTarget, partID,  message, propagate);
}
		...
		PartID& partID, RefMessage message, BOOL propagate)
{
	...
	switch (message) {
		...
		case REFMSG_GET_PARAM_NAME_NONLOCALIZED: {
			gpn = (GetParamName*)partID;
			switch (gpn->index) {
				case PB_ENABLE:      gpn->name = _T("Quality");             break;
				case PB_QUALITY:     gpn->name = _T("Quality");             break;
				case PB_SUBSAMP_TEX: gpn->name = _T("Sub-sample Textures"); break;
				default:             gpn->name = _T("");                    break;
			}
			return REF_STOP;
		}
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_UNIFORM_SAMPLER) : _T("Uniform"); }
		void GetClassName(MSTR& s, bool localized) const override { s = GetName(localized); }
		RefResult NotifyRefChanged(const Interval& changeInt, RefTargetHandle hTarget, 
							         PartID& partID, RefMessage message, BOOL propagate);
...
//								ShadeContext* sc, MASK pMask );
		...
		const TCHAR* GetDefaultComment(){	return GetString(IDS_KE_UNIFORM_COMMENT); }
		ULONG SupportsStdParams(){ return SUPER_SAMPLE_TEX_CHECK_BOX; }
...
class UniformSamplerClassDesc : public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Uniform"); }
	SClass_ID		SuperClassID() { return SAMPLER_CLASS_ID; }
	Class_ID 		ClassID() { return UniformSamplerClassID; }
	const TCHAR* 	Category() { return _T("");  }
};
...
public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_CMJ_SAMPLER) : _T("Skew Uniform"); }
		void GetClassName(MSTR& s, bool localized) const override { s = GetName(localized); }
		RefResult NotifyRefChanged(const Interval& changeInt, RefTargetHandle hTarget, 
							         PartID& partID, RefMessage message, BOOL propagate);
...
//								ShadeContext* sc, MASK pMask );
		...
		const TCHAR* GetDefaultComment(){	return GetString(IDS_KE_CMJ_COMMENT); }
		ULONG SupportsStdParams(){ return SUPER_SAMPLE_TEX_CHECK_BOX; }
...
class CMJSamplerClassDesc : public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Skew Uniform"); }
	SClass_ID		SuperClassID() { return SAMPLER_CLASS_ID; }
	Class_ID 		ClassID() { return CMJSamplerClassID; }
	const TCHAR* 	Category() { return _T("");  }
};
...
class HammersleySampler: public Sampler {
	...
	public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_HAMM_SAMPLER) : _T("Hammersley"); }
...
//								ShadeContext* sc, MASK pMask );
		...
		const TCHAR* GetDefaultComment(){	return GetString(IDS_KE_HAMM_COMMENT); }
		ULONG SupportsStdParams(){ return SUPER_SAMPLE_TEX_CHECK_BOX; }
...
class HammersleySamplerClassDesc : public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Hammersley"); }
	SClass_ID		SuperClassID() { return SAMPLER_CLASS_ID; }
	Class_ID 		ClassID() { return HammersleySamplerClassID; }
	const TCHAR* 	Category() { return _T("");  }
};
...
class HaltonSampler: public Sampler {
	...
	public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_HALTON_SAMPLER) : _T("Halton"); }
...
//						ShadeContext* sc, MASK pMask );
		...
		const TCHAR* GetDefaultComment(){	return GetString(IDS_KE_HALTON_COMMENT); }
		ULONG SupportsStdParams(){ return SUPER_SAMPLE_TEX_CHECK_BOX; }
...
class HaltonSamplerClassDesc : public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Halton"); }
	SClass_ID		SuperClassID() { return SAMPLER_CLASS_ID; }
	Class_ID 		ClassID() { return HaltonSamplerClassID; }
	const TCHAR* 	Category() { return _T("");  }
};
...
class AdaptiveHaltonSampler: public Sampler {
	...
	public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_AHALTON_SAMPLER) : _T("Adaptive Halton"); }
...
//						ShadeContext* sc, MASK pMask );
		...
		int SupportsQualityLevels() { return N_HALTON_MAX_SAMPLES; }
		const TCHAR* GetDefaultComment(){	return GetString(IDS_KE_AHALTON_COMMENT); }
...
class AdaptiveHaltonSamplerClassDesc : public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Adaptive Halton"); }
	SClass_ID		SuperClassID() { return SAMPLER_CLASS_ID; }
	Class_ID 		ClassID() { return AHaltonSamplerClassID; }
	const TCHAR* 	Category() { return _T("");  }
};
...
AdaptiveHaltonSampler::AdaptiveHaltonSampler()
{
	...
	texSuperSampleOn = TRUE; 
	SuspendAll suspendAll (TRUE, TRUE, TRUE);
	ReplaceReference(0, CreateParameterBlock(apbDesc, APBLOCK_LENGTH, APB_CURRENT_VERSION));
	DbgAssert(pParamBlk);
...
RefResult AdaptiveHaltonSampler::NotifyRefChanged(
		...
		PartID& partID, RefMessage message, BOOL propagate) 
{
	return adaptNotifyRefChanged( changeInt, hTarget, partID,  message, propagate);
}
...
class ACMJSampler: public Sampler {
	...
	public:
		...
		TSTR GetName(bool localized) const override { return localized ? GetString(IDS_KE_ACMJ_SAMPLER) : _T("Adaptive Uniform"); }
...
//						ShadeContext* sc, MASK pMask );
		...
		int SupportsQualityLevels() { return N_UNIFORM_MAX_SAMPLES; }
		const TCHAR* GetDefaultComment(){	return GetString(IDS_KE_ACMJ_COMMENT); }
...
class ACMJSamplerClassDesc : public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Adaptive Uniform"); }
	SClass_ID		SuperClassID() { return SAMPLER_CLASS_ID; }
	Class_ID 		ClassID() { return ACMJSamplerClassID; }
	const TCHAR* 	Category() { return _T("");  }
};
