...
class ProjectionHolderUVW : public Modifier {
	public:
		...
		void		GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_PROJECTIONHOLDERUVW_CLASS_NAME) : _T("Project Mapping Holder");}
...
public:
		...
		const TCHAR*		GetObjectName(bool localized) const override { return localized ? GetString(IDS_PROJECTIONHOLDERUVW_CLASS_NAME) : _T("Project Mapping Holder"); }
