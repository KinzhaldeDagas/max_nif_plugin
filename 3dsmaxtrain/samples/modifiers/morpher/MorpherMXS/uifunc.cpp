...
is_morpher_cf(Value** arg_list, int count)
{
	...
	type_check(arg_list[0], MAXModifier, _T("IsValidMorpherMod [Morpher Modifier]"));
...
wm3_refeshchannelUI_cf(Value** arg_list, int count)
{
	...
	type_check(arg_list[0], MAXModifier, _T("WM3_RefreshChannelListUI [Morpher Modifier]"));
...
wm3_refeshmcpUI_cf(Value** arg_list, int count)
{
	...
	type_check(arg_list[0], MAXModifier, _T("WM3_RefreshChannelParamsUI [Morpher Modifier]"));
...
wm3_setscrollpos_cf(Value** arg_list, int count)
{
	...
	type_check(arg_list[0], MAXModifier, _T("WM3_SetChannelPos [Morpher Modifier] [NewPos]"));
	integer_type_check(arg_list[1], _T("WM3_SetChannelPos [Morpher Modifier] [NewPos]"));
...
wm3_setscrollsel_cf(Value** arg_list, int count)
{
	...
	type_check(arg_list[0], MAXModifier, _T("WM3_SetChannelSel [Morpher Modifier] [NewSel]"));
	integer_type_check(arg_list[1], _T("WM3_SetChannelSel [Morpher Modifier] [NewSel]"));
