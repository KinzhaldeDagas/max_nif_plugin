...
#include "..\..\morpher\include\MorpherClassID.h"
...
def_visible_primitive(wm3_NumberOfChannels, "WM3_NumberOfChannels");
...
def_visible_primitive_debug_ok(wm3_mc_settarget, "WM3_MC_SetTarget");
...
def_visible_primitive(wm3_IsProgressive, "WM3_IsProgressive");
def_visible_primitive(wm3_GetBaseDeltas, "WM3_GetBaseDeltas");
def_visible_primitive(wm3_GetProgressiveTargetDeltas, "WM3_GetProgressiveTargetDeltas");
