...
class MappingMod : public Modifier {
	public:
		...
		MappingMod() : mLocalSetValue(false), flags(0), aspect(1), tmControl(NULL),mOldFudgeFactor(false) { } // mjm - 6.7.99
		void* GetInterface(ULONG id);
		BaseInterface* GetInterface(Interface_ID id);
		void InitControl(ModContext &mc,Object *obj,int type,TimeValue t, ObjectState* os);
...
#define CONTROL_RESET_TILING (1<<7)  // used when switching real-world scale mode
#define CONTROL_SET_RWS_ON   (1<<8)
#define CONTROL_SET_RWS_OFF  (1<<9)
