...
morphbybone_param_blk ( morphbybone_params, _T("params"),  0, &MorphByBoneDesc, 
					   ...
					   p_nonLocalizedName, _T("Bone Nodes"),
					   p_end,
					   ...
					   p_default, 		FALSE, 
					   p_ui,  morphbybone_mapparamscopy, TYPE_SINGLECHECKBOX, 	IDC_SHOWMIRRORPLANE_CHECK, 
					   p_end, 
					   ...
					   p_default, 		FALSE, 
					   p_ui,  morphbybone_mapparamscopy,TYPE_SINGLECHECKBOX, 	IDC_MIRRORTM_CHECK, 
					   p_end, 
					   ...
					   p_default, 		FALSE, 
					   p_ui,  morphbybone_mapparamscopy,TYPE_SINGLECHECKBOX, 	IDC_PREVIEWVERTICES_CHECK, 
					   p_end, 

					   pb_mirrorpreviewbone, 	_T("previewBone"),		TYPE_BOOL, 		P_RESET_DEFAULT,IDS_PREVIEWBONE,
					   p_default, 		FALSE, 
					   p_ui,  morphbybone_mapparamscopy,TYPE_SINGLECHECKBOX, 	IDC_PREVIEWBONE_CHECK, 
					   p_end, 
					   ...
					   */
					   ...
					   p_nonLocalizedName, _T("Node List"),
					   p_end,

					   pb_falloffgraphlist,    _T("falloffGraphs"),  TYPE_REFTARG_TAB,		0,	P_VARIABLE_SIZE,	IDS_FALLOFFGRAPHS,
					   p_nonLocalizedName, _T("Falloff Graphs"),
					   p_end,

					   pb_reloadselected, 	_T("reloadSelected"),		TYPE_BOOL, 		P_RESET_DEFAULT,IDS_RELOADSELECTED,
					   p_default, 		FALSE, 
					   p_ui,  morphbybone_mapparamsprop,TYPE_SINGLECHECKBOX, 	IDC_RELOADSELECTED_CHECK, 
					   p_end, 

					   pb_safemode, 	_T("safemode"),		TYPE_BOOL, 		0,IDS_SAFEMODE,
					   p_default, 		TRUE, 
					   p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_SAFEMODE_CHECK, 
					   p_end, 

					   pb_showdriverbone, 	_T("showDriverBone"),		TYPE_BOOL, 		0,IDS_SHOWDRIVERBONE,
					   p_default, 		TRUE, 
					   p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_SHOWDRIVERBONE_CHECK, 
					   p_end, 

					   pb_showmorphbone, 	_T("showMorphBone"),		TYPE_BOOL, 		0,IDS_SHOWMORPHBONE,
					   p_default, 		TRUE, 
					   p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_SHOWMORPHBONE_CHECK, 
					   p_end, 

					   pb_showcurrentangle, 	_T("showCurrentAngle"),		TYPE_BOOL, 		0,IDS_SHOWCURRENTANGLE,
					   p_default, 		TRUE, 
					   p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_SHOWCURRENTANGLE_CHECK, 
					   p_end, 
					   pb_showanglelimit, 	_T("showLimitAngle"),		TYPE_BOOL, 		0,IDS_SHOWLIMITANGLE,
					   p_default, 		FALSE, 
					   //		p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_SHOWLIMITANGLE_CHECK, 
					   p_end, 
					   ...
					   p_default, 		TRUE, 
					   p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_SHOWDELTAS_CHECK, 
					   p_end, 

					   pb_drawx, 	_T("showX"),		TYPE_BOOL, 		0,	IDS_SHOWX,
					   p_default, 		TRUE, 
					   //		p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_X_CHECK, 
					   p_end, 

					   pb_drawy, 	_T("showY"),		TYPE_BOOL, 		0,	IDS_SHOWY,
					   p_default, 		TRUE, 
					   //		p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_Y_CHECK, 
					   p_end, 

					   pb_drawz, 	_T("showZ"),		TYPE_BOOL, 		0,	IDS_SHOWZ,
					   p_default, 		TRUE, 
					   //		p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_Z_CHECK, 
					   p_end, 
					   ...
					   p_nonLocalizedName, _T("Soft Selection Graph"),
					   p_end, 

					   pb_usesoftselection, 	_T("useSoftSelection"),		TYPE_BOOL, 		0,IDS_USESOFTSELECTION,
					   p_default, 		FALSE, 
					   p_ui,  morphbybone_mapparamsselection,TYPE_SINGLECHECKBOX, 	IDC_USESOFTSELECTIONCHECK, 
					   p_end, 
					   ...
					   p_ui,  morphbybone_mapparamsselection,TYPE_SINGLECHECKBOX, 	IDC_USEEDGELIMITCHECK, 
					   p_end, 

					   pb_lenabled, 	_T("enabled"),		TYPE_BOOL, 		0,IDS_ENABLED,
					   p_default, 		TRUE, 
					   p_ui,  morphbybone_mapparamsprop,TYPE_SINGLECHECKBOX, 	IDC_ENABLED_CHECK, 
					   p_accessor,		&morphbybone_accessor,
					   p_end, 
					   ...
					   p_default, 		TRUE, 
					   p_ui,  morphbybone_mapparamsoptions,TYPE_SINGLECHECKBOX, 	IDC_SHOWEDGES_CHECK, 
					   p_end, 
...
static FPInterfaceDesc morphbybone_interface(
    MORPHBYBONE_INTERFACE, _T("skinMorphOps"), 0, &MorphByBoneDesc, FP_MIXIN,
		...
		morphbybone_bonesetmorphvertid, _T("boneSetMorphVertID"), 0, TYPE_VOID, 0, 4,
			_T("node"), 0, TYPE_INODE,
			_T("morphIndex"), 0, TYPE_INT,
			_T("ithVertIndex"), 0, TYPE_INT,
			_T("index"), 0, TYPE_INT,
...
void MorphByBone::EndEditParams( IObjParam *ip, ULONG flags,Animatable *next)
{
	...
	if(!TestAFlag(A_MOD_DISABLED))
	{
		...
		{
			//prevents a double delete since the local data can get deleted before the UI goes away 
			//especially when using Maxscript
			if (GetNodeFromLocalData(localDataList[i])) 
			{
				if (localDataList[i])
...
void	MorphByBone::fnRemoveMorph(INode *node, const TCHAR *name)
{
...
void	MorphByBone::fnResetOrientation(INode *node, const TCHAR *name)
{
	int whichBone = this->GetBoneIndex(node); 
	int whichMorph = this->GetMorphIndex(node,name);
...
void	MorphByBone::fnReloadTarget(INode *node, const TCHAR *name)
{
	int whichBone = this->GetBoneIndex(node); 
	int whichMorph = this->GetMorphIndex(node,name);
...
void	MorphByBone::fnEditFalloffGraph(INode *node, const TCHAR *name)
{
...
const TCHAR*	MorphByBone::fnBoneGetMorphName(INode *node, int morphIndex)
{
	morphIndex--;
	int whichBone = this->GetBoneIndex(node);
...
void	MorphByBone::fnBoneSetMorphName(INode *node, int morphIndex,const TCHAR* name)
{
	morphIndex--;
	int whichBone = this->GetBoneIndex(node);
...
float	MorphByBone::fnGetWeight(INode *node, const TCHAR*name)
{
	int whichBone = this->GetBoneIndex(node); 
	int whichMorph = this->GetMorphIndex(node,name);
