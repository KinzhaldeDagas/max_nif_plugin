...
class PasteSkinWeightsClassDesc :public ClassDesc2 {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Paste Skin Weights"); }
...
void PasteSkinWeights::NotifyInputChanged(const Interval& changeInt, PartID partID, RefMessage message, ModContext *mc)
{
