...
void RegisterTranslations()
{
	MaxSDK::TranslationSupport::RegisterTranslation(MaxSDK::TranslationSupport::kTrackViewNodes, GetString(IDS_RB_CLUSTNODEMOD), _T("ClustNodeMod"));
	MaxSDK::TranslationSupport::RegisterTranslation(MaxSDK::TranslationSupport::kTrackViewNodes, GetString(IDS_PW_VOLDATA), _T("Vol. Select Data"));
}
