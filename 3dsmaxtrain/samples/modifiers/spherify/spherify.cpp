...
class SpherifyMod : public Modifier {
  public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s= localized ? CLASSNAME : _T("Spherify Modifier"); }  
	...
	TSTR SubAnimName(int i, bool localized) override { return localized ? PARAMETERS_NAME : _T("Parameters");}
...
public:
	...
	const TCHAR *GetObjectName(bool localized) const override { return localized ? INIT_MOD_NAME : _T("Spherify"); }
...
RefResult SpherifyMod::NotifyRefChanged(const Interval& changeInt,
...
Point3 SpherifyDeformer::Map(int i, Point3 p) const
{
	float x, y, z;
...
bool SpherifyDeformer::IsThreadSafe() const
{
	return true;
}
...
class SpherifyClassDesc : public ClassDesc {
  public:
	...
	const TCHAR*     NonLocalizedClassName() { return _T("Spherify"); }
	SClass_ID		SuperClassID() { return OSM_CLASS_ID; }
