...
class BitmapIO_IFL : public BitmapIO {
     ...
     private:
		...
		TSTR m_iflName;
        // This is the timestamp of the IFL file that was parsed to create m_fileList.
		FILETIME m_iflName_timestamp;
		...
		void			WriteCfg			( );
		TSTR			GetCfgFilename		( );
		static FILETIME GetFileLastWriteTime(const TSTR& fname);
        bool            IFLFileTimeStampChanged() const;
