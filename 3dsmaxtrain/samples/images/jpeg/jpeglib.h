...
/* Common fields between JPEG compression and decompression main structs. */
...
struct jpeg_common_struct {
  jpeg_common_fields;		/* Fields common to both main struct types */
...
/* Main record for a compression instance */
...
struct jpeg_compress_struct {
   ...
   */
  struct jpeg_comp_main* comp_main;
...
/* Main record for a decompression instance */
...
struct jpeg_decompress_struct {
   ...
   */
  struct jpeg_decomp_main * decomp_main;
...
#define JPOOL_PERMANENT	0	/* lasts until main record is destroyed */
...
struct jpeg_comp_main { long dummy; };
...
struct jpeg_decomp_main { long dummy; };
