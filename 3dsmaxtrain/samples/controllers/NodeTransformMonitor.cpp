	...
	RefTargMonitorRefMaker* caller)
{
	...
	if (propagate && !suspendTMMessagePassing && fromNode && message == REFMSG_CHANGE && partID==PART_TM && forwardPartTM)
	{
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("NodeTransformMonitor"); }
