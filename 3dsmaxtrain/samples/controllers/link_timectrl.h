...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override {s = _T("LinkTimeControl");}
...
public:
	...
	const TCHAR*	ClassName() {return _T("LinkTimeControl");}
	const TCHAR*	NonLocalizedClassName() { return _T("LinkTimeControl"); }
	SClass_ID		SuperClassID() {return CTRL_FLOAT_CLASS_ID; }
	Class_ID		ClassID() {return LINK_TIME_CONTROL_CLASS_ID;}
