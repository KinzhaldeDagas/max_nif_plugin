...
public:
	...
	virtual void GetClassName(MSTR& s, bool localized) const override { s = _M("FloatLimitControlDlg"); } // from Animatable
...
private:
	...
	LimitControlDlgManager& operator=(const LimitControlDlgManager& in_mgr);
