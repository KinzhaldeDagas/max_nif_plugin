...
#include "iparamm2.h"
#include "Simpobj.h"
//#define DRIVERBLOCK_SUPER_CLASS_ID	0x64c95999
...
#define DRIVEN_CONTROL_CNAME	GetString(IDS_PW_DRIVEN_CLASSNAME)
#define DRIVEN_CONTROL_CLASS_ID	Class_ID(0x64c959cf, 0x47df4590)

#define DRIVENFLOAT_CONTROL_CNAME	GetString(IDS_PW_DRIVENFLOAT_CLASSNAME)
#define DRIVENFLOAT_CONTROL_CLASS_ID	Class_ID(0x64c959cf, 0x47df4501)

#define DRIVENPOS_CONTROL_CNAME	GetString(IDS_PW_DRIVENPOS_CLASSNAME)
#define DRIVENPOS_CONTROL_CLASS_ID	Class_ID(0x64c959cf, 0x47df4512)

#define DRIVENROTATION_CONTROL_CNAME	GetString(IDS_PW_DRIVENROTATION_CLASSNAME)
#define DRIVENROTATION_CONTROL_CLASS_ID	Class_ID(0x64c959cf, 0x47df4523)

#define DRIVENSCALE_CONTROL_CNAME	GetString(IDS_PW_DRIVENSCALE_CLASSNAME)
#define DRIVENSCALE_CONTROL_CLASS_ID	Class_ID(0x64c959cf, 0x47df4534)


#define DRIVENPOINT3_CONTROL_CNAME	GetString(IDS_PW_DRIVENPOINT3_CLASSNAME)
#define DRIVENPOINT3_CONTROL_CLASS_ID	Class_ID(0x64c959cf, 0x47df4535)



#define DRIVERBLOCK_CONTROL_CNAME	GetString(IDS_PW_DRIVERBLOCK_CLASSNAME)
#define DRIVERBLOCK_CONTROL_CLASS_ID	Class_ID(0x64c959cf, 0x47df4578)
#define DRIVERBLOCKDLG_CLASS_ID	0xaab659c4
#define DRIVENDLG_CLASS_ID	0xaab659c5
...
public:
	...
	Tab<DrivenControl*> backPointers;

	Tab<DrivenControl*> externalBackPointers;

	void NotifyAllDriven();
	...
	void GetClassName(MSTR& s, bool localized) const override {s = localized ? BLOCK_CONTROL_CNAME : _T("Block");}
	...
	Control* BuildDriven(TrackViewPick res,Control* list, BOOL createdList);
...
class BlockControlClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Block"); }
	SClass_ID		SuperClassID() { return CTRL_FLOAT_CLASS_ID; }
	Class_ID		ClassID() { return BLOCK_CONTROL_CLASS_ID; }
...
static_assert(sizeof(BlockKeysClass) == 5 * sizeof(int) + 3 * sizeof(BOOL) + sizeof(float), "");

class DriverBlockControl : public Control
{
public:
	DriverBlockControl();
	~DriverBlockControl();
	...
	int AppendBlockNoDriven(BlockControl *b,int i, TSTR *name, Control *bdata);
...
public:
	...
	Class_ID ClassID() { return DRIVERBLOCK_CONTROL_CLASS_ID; }  
	SClass_ID SuperClassID() { return DRIVERBLOCK_SUPER_CLASS_ID; } 
	void GetClassName(MSTR& s, bool localized) const override {s = localized ? DRIVERBLOCK_CONTROL_CNAME : _T("DriverBlock");}
...
class DriverBlockClassDesc:public ClassDesc2 {
	public:
	int 			IsPublic() { return 1; }
	void*			Create(BOOL /*loading*/) { return new DriverBlockControl(); }
	const TCHAR*	ClassName() { return DRIVERBLOCK_CONTROL_CNAME; }
	const TCHAR*	NonLocalizedClassName() { return _T("DriverBlock"); }
	SClass_ID		SuperClassID() { return DRIVERBLOCK_SUPER_CLASS_ID; }
	Class_ID		ClassID() { return DRIVERBLOCK_CONTROL_CLASS_ID; }
	const TCHAR* 	Category() { return _T("");  }
	const TCHAR*	InternalName() { return _T("DriverBlock"); }  // returns fixed parsable name (scripter-visible name)
...
public:
	...
	Class_ID ClassID() { return DRIVEN_CONTROL_CLASS_ID; }  
	SClass_ID SuperClassID() { return CTRL_FLOAT_CLASS_ID; } 
	void GetClassName(MSTR& s, bool localized) const override {s = localized ? DRIVEN_CONTROL_CNAME : _T("Driven");}
	...
	virtual void UpdateDriven() {}
};


class DrivenFloatControl : public DrivenControl {
public:
	DrivenFloatControl();

	void GetValue(TimeValue t, void *val, Interval &valid, GetSetMethod method);
	Class_ID ClassID() { return DRIVENFLOAT_CONTROL_CLASS_ID; }  
	void GetClassName(MSTR& s, bool localized) const override {s = localized ? DRIVENFLOAT_CONTROL_CNAME : _T("DrivenFloat");}
	void UpdateDriven();
	// Control methods
	RefTargetHandle Clone(RemapDir& remap);
};

class DrivenFloatClassDesc:public ClassDesc2 {
public:
	int 			IsPublic() { return 1; }
	void*			Create(BOOL) { return new DrivenFloatControl(); }
	const TCHAR*	ClassName() { return DRIVENFLOAT_CONTROL_CNAME; }
	const TCHAR*	NonLocalizedClassName() { return _T("DrivenFloat"); }
	SClass_ID		SuperClassID() { return CTRL_FLOAT_CLASS_ID; }
	Class_ID		ClassID() { return DRIVENFLOAT_CONTROL_CLASS_ID; }
	const TCHAR* 	Category() { return _T("");  }
	// TODO Need to do research on usage of this function, e.g. MAXScript etc
	const TCHAR*	InternalName() { return _T("DrivenFloat"); }   // returns fixed parsable name (scripter-visible name)
	HINSTANCE		HInstance() { return hInstance; }				// returns owning module handle
};

class DrivenPosControl : public DrivenControl {
	public:		

		DrivenPosControl();
		void GetValue(TimeValue t, void *val, Interval &valid, GetSetMethod method);
		Class_ID ClassID() { return DRIVENPOS_CONTROL_CLASS_ID; }  
		SClass_ID SuperClassID() { return CTRL_POSITION_CLASS_ID; } 
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? DRIVENPOS_CONTROL_CNAME : _T("DrivenPos");}
		void UpdateDriven(); 
		// Control methods
		RefTargetHandle Clone(RemapDir& remap);
	};

class DrivenPosClassDesc:public ClassDesc2 {
	public:
	int 			IsPublic() { return 1; }
	void*			Create(BOOL) { return new DrivenPosControl(); }
	const TCHAR*	ClassName() { return DRIVENPOS_CONTROL_CNAME; }
	const TCHAR*	NonLocalizedClassName() { return _T("DrivenPos"); }
	SClass_ID		SuperClassID() { return CTRL_POSITION_CLASS_ID; }
	Class_ID		ClassID() { return DRIVENPOS_CONTROL_CLASS_ID; }
	const TCHAR* 	Category() { return _T("");  }
	const TCHAR*	InternalName() { return _T("DrivenPos"); }   // returns fixed parsable name (scripter-visible name)
	HINSTANCE		HInstance() { return hInstance; }				// returns owning module handle
	};


class DrivenPoint3Control : public DrivenControl {
	public:		

		DrivenPoint3Control();
		void GetValue(TimeValue t, void *val, Interval &valid, GetSetMethod method);
		Class_ID ClassID() { return DRIVENPOINT3_CONTROL_CLASS_ID; }  
		SClass_ID SuperClassID() { return CTRL_POINT3_CLASS_ID; } 
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? DRIVENPOINT3_CONTROL_CNAME : _T("Driven Point3");}
		void UpdateDriven();
		// Control methods
		RefTargetHandle Clone(RemapDir& remap);
	};
...
class DrivenPoint3ClassDesc:public ClassDesc2 {
	public:
	int 			IsPublic() { return 1; }
	void*			Create(BOOL) { return new DrivenPoint3Control(); }
	const TCHAR*	ClassName() { return DRIVENPOINT3_CONTROL_CNAME; }
	// TODO should we change it like others (no space) of change others with spaces?
	const TCHAR*	NonLocalizedClassName() { return _T("Driven Point3"); }
	SClass_ID		SuperClassID() { return CTRL_POINT3_CLASS_ID; }
	Class_ID		ClassID() { return DRIVENPOINT3_CONTROL_CLASS_ID; }
	const TCHAR* 	Category() { return _T("");  }
	const TCHAR*	InternalName() { return _T("DrivenPoint3"); }   // returns fixed parsable name (scripter-visible name)
	HINSTANCE		HInstance() { return hInstance; }				// returns owning module handle
	};


class DrivenRotationControl : public DrivenControl {
	public:		

		DrivenRotationControl();
		void GetValue(TimeValue t, void *val, Interval &valid, GetSetMethod method);

		Class_ID ClassID() { return DRIVENROTATION_CONTROL_CLASS_ID; }  
		SClass_ID SuperClassID() { return CTRL_ROTATION_CLASS_ID; } 
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? DRIVENROTATION_CONTROL_CNAME : _T("DrivenRotation");}
		void UpdateDriven();
...
class DrivenRotationClassDesc:public ClassDesc2 {
	public:
	int 			IsPublic() { return 1; }
	void*			Create(BOOL) { return new DrivenRotationControl(); }
	const TCHAR*	ClassName() { return DRIVENROTATION_CONTROL_CNAME; }
	const TCHAR*	NonLocalizedClassName() { return _T("DrivenRotation"); }
	SClass_ID		SuperClassID() { return CTRL_ROTATION_CLASS_ID; }
	Class_ID		ClassID() { return DRIVENROTATION_CONTROL_CLASS_ID; }
	const TCHAR* 	Category() { return _T("");  }
	const TCHAR*	InternalName() { return _T("DrivenRotation"); }  // returns fixed parsable name (scripter-visible name)
	HINSTANCE		HInstance() { return hInstance; }				// returns owning module handle
	};



class DrivenScaleControl : public DrivenControl {
	public:		

		DrivenScaleControl();
		void GetValue(TimeValue t, void *val, Interval &valid, GetSetMethod method);

		Class_ID ClassID() { return DRIVENSCALE_CONTROL_CLASS_ID; }  
		SClass_ID SuperClassID() { return CTRL_SCALE_CLASS_ID; } 
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? DRIVENSCALE_CONTROL_CNAME : _T("DrivenScale");}
		void UpdateDriven();
		// Control methods
		RefTargetHandle Clone(RemapDir& remap);
...
class DrivenScaleClassDesc:public ClassDesc2 {
	public:
	int 			IsPublic() { return 1; }
	void*			Create(BOOL) { return new DrivenScaleControl(); }
	const TCHAR*	ClassName() { return DRIVENSCALE_CONTROL_CNAME; }
	const TCHAR*	NonLocalizedClassName() { return _T("DrivenScale"); }
	SClass_ID		SuperClassID() { return CTRL_SCALE_CLASS_ID; }
	Class_ID		ClassID() { return DRIVENSCALE_CONTROL_CLASS_ID; }
	const TCHAR* 	Category() { return _T("");  }
	const TCHAR*	InternalName() { return _T("DrivenScale"); }   // returns fixed parsable name (scripter-visible name)
	HINSTANCE		HInstance() { return hInstance; }				// returns owning module handle
	};
...
class RangeRestore : public RestoreObj {
	public:
		...
		Interval ur, rr;
		RangeRestore(DriverBlockControl *c) 
			{
			cont = c;
			ur   = cont->range;
			}
		...
		TSTR Description() { return _T("Range"); }
	};


class DriverBlockRest : public RestoreObj {
	public:
		...
		DriverBlockRest(DriverBlockControl *c) { 
			cont = c;
			undo = c->BlockKeys;
			ur   = cont->range;
		...
		TSTR Description() { return _T("DriverBlock Restore"); }
	};


class DriverBlockAddKey : public RestoreObj {
	public:
		Tab<BlockKeysClass> undo, redo;
		DriverBlockControl *cont;
		Interval ur, rr;

		DriverBlockAddKey(DriverBlockControl *c) { 
			cont = c;
			undo = c->BlockKeys;
			ur = c->range;
			}
		...
		TSTR Description() { return _T("DriverBlock Add Key"); }
	};

class DriverBlockDeleteKey : public RestoreObj {
	public:
		Tab<BlockKeysClass> undo, redo;
		DriverBlockControl *cont;
		Interval ur, rr;

		DriverBlockDeleteKey(DriverBlockControl *c) { 
			cont = c;
			undo = c->BlockKeys;
			ur = c->range;
			}
		~DriverBlockDeleteKey() {}
		void Restore(int isUndo) {
			if (isUndo) {
				if (redo.Count()!=cont->BlockKeys.Count()) {
					redo = cont->BlockKeys;
		...
		TSTR Description() { return _T("DriverBlock Delete Key"); }
	};



class DriverBlockAdd : public RestoreObj {
	public:
		Tab<BlockControl*> undo, redo;
		DriverBlockControl *cont;

		DriverBlockAdd(DriverBlockControl *c) { 
			cont = c;
			undo = c->Blocks;
			}
		~DriverBlockAdd() {}
		...
		TSTR Description() { return _T("Add Block"); }
	};

#pragma endregion

class DriverBlockDlg 
{
public:
	DriverBlockControl *cont;
	ParamDimensionBase *dim;
...
class DrivenDlg : public ReferenceMaker{
	public:
		DrivenControl* cont;
		ParamDimensionBase *dim;
		IObjParam *ip;
		...
		Class_ID ClassID() {return Class_ID(DRIVERBLOCKDLG_CLASS_ID,0);}
		SClass_ID SuperClassID() {return REF_MAKER_CLASS_ID;}
		virtual void GetClassName(MSTR& s, bool localized) const override { s = _M("DrivenDlg"); }
...
private:
		virtual void SetReference(int , RefTargetHandle rtarg) {cont=(DrivenControl*)rtarg;}
	};




class DriverBlockTrackViewFilter :public TrackViewFilter
{
	BOOL proc(Animatable *anim, Animatable *client,int subNum);
};

class DriverBlockTrackViewFilterAdd :public TrackViewFilter
{
	BOOL proc(Animatable *anim, Animatable *client,int subNum);
};

class DriverTrackViewFilter :public TrackViewFilter
{
	BOOL proc(Animatable *anim, Animatable *client,int subNum);
};

class DriverMatchNodeViewFilter :public TrackViewFilter
{
	BOOL proc(Animatable *anim, Animatable *client,int subNum);
};
...
{
	friend class DriverBlockControl;
public:
	static IObjParam *ip;
	...
	RefTargetHandle Clone(RemapDir& remap);
	const TCHAR *GetObjectName(bool localized) const override { return localized ? CONTROLCONTAINER_CNAME : _T("ControlContainer"); }
	BOOL HasUVW();
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("ControlContainer"); }
