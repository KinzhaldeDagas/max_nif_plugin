...
void initClassDescArray(void)
{
   if( !classDescCount )
   {
      classDescArray[classDescCount++] = GetDriverBlockDesc();
      classDescArray[classDescCount++] = GetBlockControlDesc();
      classDescArray[classDescCount++] = GetDrivenFloatDesc();
      classDescArray[classDescCount++] = GetDrivenPosDesc();
      classDescArray[classDescCount++] = GetControlContainerDesc();
      classDescArray[classDescCount++] = GetDrivenRotationDesc();
      classDescArray[classDescCount++] = GetDrivenScaleDesc();
      classDescArray[classDescCount++] = GetDrivenPoint3Desc();
   }
}
