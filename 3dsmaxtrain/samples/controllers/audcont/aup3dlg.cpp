...
{
   int mmerr;
   AudioP3Control* af = DLGetWindowLongPtr<AudioP3Control *>(hWnd,DWLP_USER);
...
RefResult AudioP3Dlg::NotifyRefChanged(const Interval& changeInt, 
...
static INT_PTR CALLBACK AudioP3DlgProc(HWND hWnd, UINT msg, WPARAM wParam,
   LPARAM lParam)
{
   AudioP3Dlg *dlg = DLGetWindowLongPtr<AudioP3Dlg*>(hWnd);
