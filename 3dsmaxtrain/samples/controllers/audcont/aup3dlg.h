...
class AudioP3Dlg : public ReferenceMaker {
	public:
		...
		virtual void GetClassName(MSTR& s, bool localized) const override { s = _M("AudioP3Dlg"); }

		RefResult NotifyRefChanged(const Interval& changeInt, RefTargetHandle hTarget, PartID& partID, RefMessage message, BOOL propagate);
		int NumRefs() {return 1;}
		RefTargetHandle GetReference(int i) {return cont;}
private:
		virtual void SetReference(int i, RefTargetHandle rtarg) {cont=(AudioP3Control*)rtarg;}
public:
