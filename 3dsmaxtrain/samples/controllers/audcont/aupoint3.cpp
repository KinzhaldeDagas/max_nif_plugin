...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override {s = localized ? AUDIO_POINT3_CONTROL_CNAME : _T("AudioPoint3");}
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("AudioPoint3"); }
	SClass_ID		SuperClassID() { return CTRL_POINT3_CLASS_ID; }
	Class_ID		ClassID() { return Class_ID(AUDIO_POINT3_CONTROL_CLASS_ID1,AUDIO_POINT3_CONTROL_CLASS_ID2); }
...
void AudioPoint3Control::RefDeleted(RefMakerHandle rm)
{
	int c=0;
