...
(
	...
	// required param specs
		...
		// sub-material ID Offset
			kMaterialFrequency_mtlIDOffset, _T("SubMtl_ID_Offset"),
									TYPE_INT,
									P_RESET_DEFAULT,
									IDS_SUBMTLIDOFFSET,
			// optional tagged param specs
		...
		// materialFrequency ID #1 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #1 Frequency"),
			p_end,
		// materialFrequency ID #2 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #2 Frequency"),
			p_end,
		// materialFrequency ID #3 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #3 Frequency"),
			p_end,
		// materialFrequency ID #4 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #4 Frequency"),
			p_end,
		// materialFrequency ID #5 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #5 Frequency"),
			p_end,
		// materialFrequency ID #6 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #6 Frequency"),
			p_end,
		// materialFrequency ID #7 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #7 Frequency"),
			p_end,
		// materialFrequency ID #8 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #8 Frequency"),
			p_end,
		// materialFrequency ID #9 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #9 Frequency"),
			p_end,
		// materialFrequency ID #8 frequency
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID #10 Frequency"),
			p_end,
		// random seed
