...
#ifndef _PFTESTSPAWNONCOLLISION_H_
#define _PFTESTSPAWNONCOLLISION_H_
...
#include "slate/SlateModelWrapper.h"

namespace PFActions {

class PFTestSpawnOnCollision:	public HelperObject, 
								public IPFAction,
								public IPFTest,
								public IPViewItem,
								public IPFIntegrator,
								public HitByNameDlgCallback,
								public MaxSDK::ParticleFlow::SlateModelWrapper
{
public:
	// constructor/destructor
	PFTestSpawnOnCollision();
	~PFTestSpawnOnCollision();
...
public:
	...
	// needed by SlateModelWrapper
	virtual void NotifyTarget( int message, ReferenceMaker* hMaker ) { SlateModelWrapper::RefMakerNotifyTarget( message, hMaker ); }
	...
	const TCHAR *dialogTitle()	{ return GetString(IDS_SELECTDEFLECTORS); }
	const TCHAR *buttonText()		{ return GetString(IDS_SELECT); }
...
public:
		void RefreshUI(int updateID) const;
		void UpdatePViewUI(ParamID updateID) const;
		...
		bool updateObjectNames(ParamID pblockID);
...
#endif // _PFTESTSPAWNONCOLLISION_H_
