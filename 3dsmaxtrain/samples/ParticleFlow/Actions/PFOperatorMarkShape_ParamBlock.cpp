...
(
	...
	// required param specs
		...
		// deform mark shape to surface animation
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_VERTEXANIMATED,
			p_end,
		...
		// impact angle distortion
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_IMPACTDISTORTION,
			p_end,
		...
		// allow multiple elements for a particle
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_MULTISHAPE,
			p_end,
		...
		// constant update for box intersection cut-out
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_CONTUPDATE,
			p_end,
		// material
		...
		// generate mapping coordinates
			...
			// optional tagged param specs
					p_default,		TRUE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_GENERATEMAPPING,
			p_end,
		// random seed
...
INT_PTR PFOperatorMarkShapeDlgProc::DlgProc( TimeValue t, IParamMap2 *map, HWND hWnd, UINT msg,
