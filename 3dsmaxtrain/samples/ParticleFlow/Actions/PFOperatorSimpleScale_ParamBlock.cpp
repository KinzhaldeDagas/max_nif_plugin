	...
	// required param specs
		...
		// x scale factor
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("X Scale Factor"),
			p_end,
		// y scale factor
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Y Scale Factor"),
			p_end,
		// z scale factor
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Z Scale Factor"),
			p_end,
		// constrain scale factor
			...
			// optional tagged param specs
					p_default,		TRUE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_CONSTRAINSCALE,
			p_end,
		// x scale variation
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("X Scale Variation"),
			p_end,
		// y scale variation
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Y Scale Variation"),
			p_end,
		// z scale variation
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Z Scale Variation"),
			p_end,
		// constrain scale variation
			...
			// optional tagged param specs
					p_default,		TRUE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_CONSTRAINVARIATION,
			p_end,
		// bias
...
INT_PTR PFOperatorSimpleScaleDlgProc::DlgProc(TimeValue t, IParamMap2* map, HWND hWnd,
