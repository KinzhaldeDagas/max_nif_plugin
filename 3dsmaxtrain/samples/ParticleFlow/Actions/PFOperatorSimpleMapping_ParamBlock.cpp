	...
	// required param specs
		// U coord. mapping
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("U Map Coordinate"),
			p_end,
		// V coord. mapping
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("V Map Coordinate"),
			p_end,
		// W coord. mapping
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("W Map Coordinate"),
			p_end,
		// sync type
...
INT_PTR PFOperatorSimpleMappingDlgProc::DlgProc( TimeValue t, IParamMap2 *map, HWND hWnd, UINT msg,
