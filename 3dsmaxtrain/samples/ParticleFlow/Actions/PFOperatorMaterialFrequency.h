...
protected:
	...
	ParamID assignMtlParamID(void) const;
	ParamID mtlParamID(void) const;
	ParamID numSubMtlsParamID(void) const;
	ParamID randParamID(void) const;
	int mtlIDOffset(void) const;
