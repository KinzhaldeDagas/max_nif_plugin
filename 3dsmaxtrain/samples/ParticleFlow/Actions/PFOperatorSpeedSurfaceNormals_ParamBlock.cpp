...
(
	...
	// required param specs
		...
		// set speed value
			...
			// optional tagged param specs
					p_default,		TRUE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_USESPEEDVALUE,
			p_end,
		// speed value
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Speed Value"),
			p_end,
		// speed variation
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Speed Variation"),
			p_end,
		// surface objects
		...
		// use material multiplier/set
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_BYMATERIAL,
			p_end,
		// speedMaterial type
		...
		// unlimited range of speed control
			...
			// optional tagged param specs
					p_default,		TRUE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_UNLIMITEDRANGE,
			p_end,
		// range
...
INT_PTR PFOperatorSpeedSurfaceNormalsDlgProc::DlgProc(TimeValue t, IParamMap2* map, HWND hWnd,
