...
const TCHAR* PFOperatorSimpleShapeDesc::NonLocalizedClassName()
{
...
INT_PTR PFOperatorSimpleShapeDesc::Execute(int cmd, ULONG_PTR arg1, ULONG_PTR arg2, ULONG_PTR arg3)
{
	...
	HBITMAP* depotMask;
	bool* isPublic;
	static bool registrationVerified(false);
	static bool box1ModuleRegistered(false);
	switch( cmd )
	{
	...
	case kPF_PViewPublic:
		...
		{
			box1ModuleRegistered = GetPViewManager()->IsModuleRegistered(PFTOOLSBOX1_MODULE_CLASSID);
			registrationVerified = true;
		}
		*isPublic = !box1ModuleRegistered;
		break;
