	...
	// required param specs
		...
		// size value
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Size Value"),
			p_end,
		// size variation
		...
		// scale value
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Scale Value"),
			p_end,
		// size variation
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Scale Variation"),
			p_end,
		// sync type
...
//+>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>+
INT_PTR TestScaleDlgProc::DlgProc(TimeValue t, IParamMap2 *map, HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	IParamBlock2* pblock;
	switch (msg) 
	{
