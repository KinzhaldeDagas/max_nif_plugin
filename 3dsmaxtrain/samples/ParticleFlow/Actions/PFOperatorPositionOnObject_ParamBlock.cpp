	...
	// required param specs
		// locked on the emitter
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_LOCK,
			p_end,
		// inherit the emitter speed/movement
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_INHERIT,
			p_end,
...
//						p_accessor,	&lag_accessor,
		...
		// location type
			...
			// optional tagged param specs
					...
					p_ui,			TYPE_INTLISTBOX,	IDC_TYPE,	kPositionOnObject_locationType_num,
												IDS_LOCATIONTYPE_PIVOT,
												IDS_LOCATIONTYPE_VERTEXALL, IDS_LOCATIONTYPE_VERTEXRANDOM,
					...
					p_vals,			kPositionOnObject_locationType_pivot,
									kPositionOnObject_locationType_vertexAll,
		...
		// use surface offset
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_SURFACEOFFSET,
			p_end,
		// surface offset minumum
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Surface Offset Minimum"),
			p_end,
		// surface offset maximum
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Surface Offset Maximum"),
			p_end,
		// use non-uniform density
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_NONUNIFORM,
			p_end,
		// density type
		...
		// use sub-material for density
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_USESUBMAT,
			p_end,
		// Sub-Material ID
		...
		// apart placement
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX, IDC_APART,
			p_end,
		// apart distance
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Apart Distance"),
			p_end,
		// distinct points only
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX, IDC_DISTINCT,
			p_end,
		// total number of of distinct points
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Total Distinct Points"),
			p_end,
		// remove particles with invalid location
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX, IDC_DELETEPARTICLES,
			p_end,
		// random seed
...
INT_PTR PFOperatorPositionOnObjectDlgProc::DlgProc( TimeValue t, IParamMap2 *map, HWND hWnd, UINT msg,
...
void PFOperatorPositionOnObjectDlgProc::UpdateTypeDlg( HWND hWnd, IParamBlock2* pblock )
{
	...
	bool enableDensity = ((type != kPositionOnObject_locationType_pivot)
							&& (type != kPositionOnObject_locationType_vertexAll));
