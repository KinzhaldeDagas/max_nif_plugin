...
(
	...
	// required param specs
		...
		// locked on the emitter
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_RESTRICTTOAXIS,
			p_end,
		// Div. Axis X
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Divergence Axis X"),
			p_end,
		// Div. Axis Y
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Divergence Axis Y"),
			p_end,
		// Div. Axis Y
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Divergence Axis Z"),
			p_end,
		// seed
