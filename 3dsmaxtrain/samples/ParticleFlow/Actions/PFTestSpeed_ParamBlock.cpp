	...
	// required param specs
		...
		// unit value
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Unit Value"),
			p_end,
		// unit variation
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Unit Variation"),
			p_end,
		...
		// angle value
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Angle Value"),
			p_end,
		// angle variation
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Angle Variation"),
			p_end,
		// sync type
...
//+>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>+
INT_PTR TestSpeedDlgProc::DlgProc(TimeValue t, IParamMap2 *map, HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	IParamBlock2* pblock;
	switch (msg) 
	{
