...
(
	...
	// required param specs
		...
		// delete parent
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_DELETEPARENT,
			p_end,
		// index of the last particle
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Spawn Rate"),
			p_end,
		// step size
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Spawn Step Size"),
			p_end,
		// percentage of spawn-able particles
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Spawn Able"),
			p_end,
		// number of particles spawn
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Number of Offsprings"),
			p_end,
		// variation for number of particles spawn
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Variation"),
			p_end,
		// sync by
		...
		// restart particle age
			...
			// optional tagged param specs
					p_default,		TRUE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_RESTARTAGE,
			p_end,
		...
		// speed inherited
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Speed Inherited"),
			p_end,
		// variation for speed
...
//+>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>+
INT_PTR TestSpawnDlgProc::DlgProc(TimeValue t, IParamMap2 *map, HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg) 
	{
	case WM_INITDIALOG:
