	...
	// required param specs
		// accel limit value
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Accel Limit"),
			p_end,
		// influence
		...
		// use speed variation
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_SPEEDVARIATION,
			p_end,
		// speed minimum
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Speed Minimum (%)"),
			p_end,
		// speed maximum
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Speed Maximum (%)"),
			p_end,
		// use icon orientation
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_USEORIENT,
			p_end,
		// steer towards trajectory
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_STEER,
			p_end,
...
INT_PTR PFOperatorSpeedCopyDlgProc::DlgProc(TimeValue t, IParamMap2* map, HWND hWnd,
