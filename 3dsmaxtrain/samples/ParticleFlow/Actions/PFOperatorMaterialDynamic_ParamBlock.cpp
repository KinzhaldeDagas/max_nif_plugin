...
(
	...
	// required param specs
		...
		// sub-material ID Offset
			kMaterialDynamic_mtlIDOffset, _T("SubMtl_ID_Offset"),
									TYPE_INT,
									P_RESET_DEFAULT,
									IDS_SUBMTLIDOFFSET,
			// optional tagged param specs
		...
		// reset particle age
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_RESETAGE,
			p_end,
		// randomize particle age
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_RANDOMIZEAGE,
			p_end,
		// maximum age offset
		...
		// material ID
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Material ID"),
			p_end,
		...
		// number of sub-materialDynamics per frame
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Sub-Materials Rate"),
			p_end,
		// loop frames
