...
(
	...
	// required param specs
		...
		// use accel limit
			...
			// optional tagged param specs
					p_default,		TRUE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_USEACCELLIMIT,
			p_end,
		// accel limit value
		...
		// use speed limit
			...
			// optional tagged param specs
					p_default,		FALSE,
					p_ui,			TYPE_SINGLECHECKBOX,	IDC_USESPEEDLIMIT,
			p_end,
		// speed limit value
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Speed Limit"),
			p_end,
		...
		// core size
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Core Size"),
			p_end,
		// falloff size
			...
			// optional tagged param specs
					...
					p_nonLocalizedName, _T("Falloff Size"),
			p_end,
		// core scale
...
INT_PTR PFOperatorSpeedKeepApartDlgProc::DlgProc(TimeValue t, IParamMap2* map, HWND hWnd,
...
static bool selectionUpdateInProgress = false;
