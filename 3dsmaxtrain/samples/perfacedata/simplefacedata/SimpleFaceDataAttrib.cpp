...
//-----------------------------------------------------------------------------
const TCHAR* SimpleFaceDataAttrib::GetName(bool /*localized*/)
...
//-----------------------------------------------------------------------------
{
	...
	std::unique_ptr<ISimpleFPChannel> pContainer = WrapFaceChannel(_GetFaceChannel(), mChannelType);
...
//-----------------------------------------------------------------------------
{
	...
	std::unique_ptr<ISimpleFPChannel> pWrap = WrapFaceChannel(NULL, TYPE_UNSPECIFIED);
...
//-----------------------------------------------------------------------------
std::unique_ptr<ISimpleFPChannel> SimpleFaceDataAttrib::WrapFaceChannel(IFaceDataChannel* pChan, int type)
//-----------------------------------------------------------------------------
{
	switch (type)
	{
	case TYPE_BOOL:
		return std::unique_ptr<ISimpleFPChannel>(new SimpleFPChannel<TYPE_BOOL_TYPE>(pChan));
	break;
	case TYPE_INDEX:
	case TYPE_INT:
		return std::unique_ptr<ISimpleFPChannel>(new SimpleFPChannel<TYPE_INT_TYPE>(pChan));
	break;
	case TYPE_FLOAT:
		return std::unique_ptr<ISimpleFPChannel>(new SimpleFPChannel<TYPE_FLOAT_TYPE>(pChan));
	break;
	case TYPE_POINT2_BV:
		return std::unique_ptr<ISimpleFPChannel>(new PointerFPChannel<TYPE_POINT2_BV_TYPE>(pChan));
	break;
	case TYPE_POINT3_BV:
		return std::unique_ptr<ISimpleFPChannel>(new PointerFPChannel<TYPE_POINT3_BV_TYPE>(pChan));
	break;
	}
	return std::unique_ptr<ISimpleFPChannel>(new SimpleFPChannel<TYPE_INT_TYPE>(NULL));
}
...
// ****************************************************************************
//-----------------------------------------------------------------------------
const TCHAR* SimpleFaceDataAttrib::GetChannelName()
// exposed channel name property
//-----------------------------------------------------------------------------
{
	std::unique_ptr<ISimpleFPChannel> pChan = WrapFaceChannel(_GetFaceChannel(), mChannelType);
	if (pChan->GetChannel()) {
