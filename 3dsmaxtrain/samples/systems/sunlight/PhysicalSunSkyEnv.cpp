...
ParamBlockDesc2 PhysicalSunSkyEnv::m_pb_desc(
    ...
    kMainParamID_GlobalIntensity, _T("global_intensity"), TYPE_FLOAT, P_ANIMATABLE, IDS_PHYSSUNSKY_GLOBALINTENSITY,
        p_default, 1.0f,
        p_range, 0.0f, 1e6f,
        p_nonLocalizedName, _T("Global Intensity"),
        p_end,
    ...
    kMainParamID_HorizonBlur, _T("horizon_blur_deg"), TYPE_FLOAT, P_ANIMATABLE, IDS_PHYSSUNSKY_HORIZONBLUR,
        ...
        p_range, 0.0f, 45.0f,
        p_nonLocalizedName, _T("Horizon Blur Deg"),
        p_end,
    kMainParamID_GroundColor, _T("ground_color"), TYPE_FRGBA, P_ANIMATABLE, IDS_PHYSSUNSKY_GROUNDCOLOR,
        ...
        p_nonLocalizedName, _T("Ground Color"),
        p_end,
    ...
    kMainParamID_PerezDiffuseHorizontalIlluminance, _T("perez_diffuse_horizontal_illuminance"), TYPE_FLOAT, P_ANIMATABLE, IDS_PHYSSUNSKY_PEREZ_DIFFHORILL,
        ...
        p_range, 0.0f, 1e12f,
        p_accessor, &m_pb_accessor,
        p_nonLocalizedName, _T("Perez Diffuse Horizontal Illuminance"),
        p_end,
    kMainParamID_PerezDirectNormalIlluminance, _T("perez_direct_normal_illuminance"), TYPE_FLOAT, P_ANIMATABLE, IDS_PHYSSUNSKY_PEREZ_DIRNORILL,
        ...
        p_range, 0.0f, 1e12f,
        p_accessor, &m_pb_accessor,
        p_nonLocalizedName, _T("Perez Direct Normal Illuminance"),
        p_end,
    p_end
);
...
void PhysicalSunSkyEnv::GetClassName(MSTR& s, bool localized) const
{
...
TSTR PhysicalSunSkyEnv::SubAnimName(int i, bool localized)
{
	switch (i)
	{
	case 0: return localized ? MaxSDK::GetResourceStringAsMSTR(IDS_PARAMETERS) : MSTR(_T("Parameters"));
	default: DbgAssert(false); return TSTR();
	}
}
...
const TCHAR* PhysicalSunSkyEnv::ClassDescriptor::NonLocalizedClassName()
{
	return _T("Physical Sun & Sky Environment");
}
