...
class SunDriverCreateMode : public CommandMode, public MaxSDK::Util::Noncopyable
{
public:
	static SunDriverCreateMode* GetInstance();
	static void Destroy();
...
private:
	SunDriverCreateMode();
	virtual ~SunDriverCreateMode();
	
	// This instance of SunDriverCreationMangaer handles the user/mouse
	// interaction as the sun array is created.
	IObjCreate *ip;
	SunDriverCreationManager proc;

	static SunDriverCreateMode* sInstance;
};
