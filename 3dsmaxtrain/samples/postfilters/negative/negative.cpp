...
void RegisterTranslations()
{
	MaxSDK::TranslationSupport::RegisterTranslation(MaxSDK::TranslationSupport::kTrackViewNodes, GetString(IDS_BLEND), _T("Blend Value"));
}
...
class NEGClassDesc:public ClassDesc {
	  ...
	  public:
		 ...
		 const TCHAR*    NonLocalizedClassName()            { return _T("Negative"); }
...
INT_PTR ImageFilter_Negative::Control(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam) {
