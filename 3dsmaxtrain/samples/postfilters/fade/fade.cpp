...
class FADEClassDesc:public ClassDesc {
     ...
     public:
		...
		const TCHAR*    NonLocalizedClassName()            { return _T("Fade"); }
...
INT_PTR ImageFilter_Fade::Control(HWND hWnd,UINT message,WPARAM wParam,LPARAM lParam)	{
...
BOOL ImageFilter_Fade::LoadConfigure ( void *ptr, DWORD piDataSize ) {
