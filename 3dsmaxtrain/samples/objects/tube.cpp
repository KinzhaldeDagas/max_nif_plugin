...
class TubeObject : public SimpleObject2, public RealWorldMapSizeInterface {
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_RB_TUBE) : _T("Tube");}
...
class TubeClassDesc:public ClassDesc2 {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Tube"); }
...
static_assert(tube_params == TUBE_PARAMBLOCK_ID, "");
...
void TubeObject::BuildMesh(TimeValue t)
	...
	LimitValue( capsegs, MIN_SIDES, MAX_SIDES);
