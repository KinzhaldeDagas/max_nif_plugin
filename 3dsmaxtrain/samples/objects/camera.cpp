...
class SimpleCamClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Free"); }
...
SharedMeshPtr SimpleCamera::smpSharedMesh = nullptr;
...
{
public:
	CameraMeshItem(SharedMeshPtr pSharedMesh)
		: MeshEdgeRenderItem(pSharedMesh, true)
	{
   ...
   SimpleCamera *so = DLGetWindowLongPtr<SimpleCamera *>( hDlg);
	...
	switch ( message )
	{
		...
		case CC_SPINNER_BUTTONUP:
			...
			{
            ExecuteMAXScriptScript(_T(" InvalidateAllBackgrounds() "), MAXScript::ScriptSource::NonEmbedded, TRUE);
			}
...
void SimpleCamera::BuildMesh()	{
	...
	if (nullptr == smpSharedMesh){
		smpSharedMesh = new SharedMesh();
	}
	smpSharedMesh->GetMesh().setNumVerts(170+2);	//pw need to add 2 points to make the bounding box symmetrical
	smpSharedMesh->GetMesh().setNumFaces(284);


	smpSharedMesh->GetMesh().setVert(0, Point3(3.051641,3.476140,19.865290));
	smpSharedMesh->GetMesh().setVert(1, Point3(3.051641,7.351941,19.865288));
	smpSharedMesh->GetMesh().setVert(2, Point3(3.051641,10.708482,17.927383));
	smpSharedMesh->GetMesh().setVert(3, Point3(3.051642,12.646385,14.570845));
	smpSharedMesh->GetMesh().setVert(4, Point3(3.051642,12.646385,10.695045));
	smpSharedMesh->GetMesh().setVert(5, Point3(3.051642,10.718940,7.343246));
	smpSharedMesh->GetMesh().setVert(6, Point3(3.051642,7.362399,5.405346));
	smpSharedMesh->GetMesh().setVert(7, Point3(3.051642,3.476141,5.400602));
	smpSharedMesh->GetMesh().setVert(8, Point3(3.051642,0.119599,7.338503));
	smpSharedMesh->GetMesh().setVert(9, Point3(3.051641,-1.818303,10.695044));
	smpSharedMesh->GetMesh().setVert(10, Point3(3.051641,-1.818301,14.570848));
	smpSharedMesh->GetMesh().setVert(11, Point3(3.051641,0.119600,17.927389));
	smpSharedMesh->GetMesh().setVert(12, Point3(-2.927488,3.476141,19.865290));
	smpSharedMesh->GetMesh().setVert(13, Point3(-2.927488,7.351941,19.865288));
	smpSharedMesh->GetMesh().setVert(14, Point3(-2.927488,10.708485,17.927383));
	smpSharedMesh->GetMesh().setVert(15, Point3(-2.927488,12.646383,14.570839));
	smpSharedMesh->GetMesh().setVert(16, Point3(-2.927486,12.646383,10.695044));
	smpSharedMesh->GetMesh().setVert(17, Point3(-2.927485,10.718940,7.343246));
	smpSharedMesh->GetMesh().setVert(18, Point3(-2.927486,7.362398,5.405346));
	smpSharedMesh->GetMesh().setVert(19, Point3(-2.927488,3.476141,5.400604));
	smpSharedMesh->GetMesh().setVert(20, Point3(-2.927486,0.119599,7.338502));
	smpSharedMesh->GetMesh().setVert(21, Point3(-2.927488,-1.818302,10.695044));
	smpSharedMesh->GetMesh().setVert(22, Point3(-2.927488,-1.818301,14.570842));
	smpSharedMesh->GetMesh().setVert(23, Point3(-2.927488,0.119600,17.927389));
	smpSharedMesh->GetMesh().setVert(24, Point3(3.051642,14.605198,7.347991));
	smpSharedMesh->GetMesh().setVert(25, Point3(3.051642,17.961739,5.410092));
	smpSharedMesh->GetMesh().setVert(26, Point3(3.051642,19.899639,2.053550));
	smpSharedMesh->GetMesh().setVert(27, Point3(3.051643,19.899641,-1.822252));
	smpSharedMesh->GetMesh().setVert(28, Point3(3.051643,17.961742,-5.178796));
	smpSharedMesh->GetMesh().setVert(29, Point3(3.051643,14.605200,-7.116695));
	smpSharedMesh->GetMesh().setVert(30, Point3(3.051644,10.729396,-7.116697));
	smpSharedMesh->GetMesh().setVert(31, Point3(3.051644,7.372853,-5.178795));
	smpSharedMesh->GetMesh().setVert(32, Point3(3.051642,5.434954,-1.822254));
	smpSharedMesh->GetMesh().setVert(33, Point3(3.051642,5.434955,2.053549));
	smpSharedMesh->GetMesh().setVert(34, Point3(-2.927486,14.605195,7.347991));
	smpSharedMesh->GetMesh().setVert(35, Point3(-2.927485,17.961739,5.410092));
	smpSharedMesh->GetMesh().setVert(36, Point3(-2.927485,19.899643,2.053545));
	smpSharedMesh->GetMesh().setVert(37, Point3(-2.927485,19.899641,-1.822254));
	smpSharedMesh->GetMesh().setVert(38, Point3(-2.927485,17.961742,-5.178796));
	smpSharedMesh->GetMesh().setVert(39, Point3(-2.927485,14.605194,-7.116697));
	smpSharedMesh->GetMesh().setVert(40, Point3(-2.927485,10.729397,-7.116697));
	smpSharedMesh->GetMesh().setVert(41, Point3(-2.927485,7.372854,-5.178796));
	smpSharedMesh->GetMesh().setVert(42, Point3(-2.927485,5.434955,-1.822254));
	smpSharedMesh->GetMesh().setVert(43, Point3(-2.927485,5.434955,2.053546));
	smpSharedMesh->GetMesh().setVert(44, Point3(-4.024377,-5.645106,-6.857333));
	smpSharedMesh->GetMesh().setVert(45, Point3(-4.024381,-5.645108,5.771017));
	smpSharedMesh->GetMesh().setVert(46, Point3(4.298551,-5.645106,-6.857333));
	smpSharedMesh->GetMesh().setVert(47, Point3(4.298550,-5.645107,5.771020));
	smpSharedMesh->GetMesh().setVert(48, Point3(-4.024377,5.452132,-5.590975));
	smpSharedMesh->GetMesh().setVert(49, Point3(4.298551,5.452132,-5.590975));
	smpSharedMesh->GetMesh().setVert(50, Point3(-4.024381,-2.215711,8.686206));
	smpSharedMesh->GetMesh().setVert(51, Point3(4.298549,-2.215710,8.686206));
	smpSharedMesh->GetMesh().setVert(52, Point3(4.298550,5.452131,4.260479));
	smpSharedMesh->GetMesh().setVert(53, Point3(-4.024381,5.452131,4.260478));
	smpSharedMesh->GetMesh().setVert(54, Point3(4.298552,-2.673011,-9.176138));
	smpSharedMesh->GetMesh().setVert(55, Point3(-4.024377,-2.673013,-9.176139));
	smpSharedMesh->GetMesh().setVert(56, Point3(-4.024377,2.446853,-9.185402));
	smpSharedMesh->GetMesh().setVert(57, Point3(4.298551,2.446853,-9.185402));
	smpSharedMesh->GetMesh().setVert(58, Point3(-3.974360,3.286706,-5.111160));
	smpSharedMesh->GetMesh().setVert(59, Point3(-3.974360,3.778829,-5.883637));
	smpSharedMesh->GetMesh().setVert(60, Point3(-3.974360,3.580588,-6.777846));
	smpSharedMesh->GetMesh().setVert(61, Point3(-3.974360,2.808110,-7.269970));
	smpSharedMesh->GetMesh().setVert(62, Point3(-3.974360,1.913902,-7.071730));
	smpSharedMesh->GetMesh().setVert(63, Point3(-3.974360,1.421778,-6.299250));
	smpSharedMesh->GetMesh().setVert(64, Point3(-3.974360,1.620020,-5.405043));
	smpSharedMesh->GetMesh().setVert(65, Point3(-3.974360,2.392498,-4.912918));
	smpSharedMesh->GetMesh().setVert(66, Point3(-4.842994,3.493080,-4.816429));
	smpSharedMesh->GetMesh().setVert(67, Point3(-5.090842,4.044086,-5.504812));
	smpSharedMesh->GetMesh().setVert(68, Point3(-5.689195,3.988004,-6.195997));
	smpSharedMesh->GetMesh().setVert(69, Point3(-6.287547,3.357684,-6.485096));
	smpSharedMesh->GetMesh().setVert(70, Point3(-6.535392,2.522360,-6.202761));
	smpSharedMesh->GetMesh().setVert(71, Point3(-6.287547,1.971353,-5.514376));
	smpSharedMesh->GetMesh().setVert(72, Point3(-5.689195,2.027436,-4.823191));
	smpSharedMesh->GetMesh().setVert(73, Point3(-5.090842,2.657756,-4.534092));
	smpSharedMesh->GetMesh().setVert(74, Point3(-5.202796,3.991309,-4.104883));
	smpSharedMesh->GetMesh().setVert(75, Point3(-5.553304,4.684474,-4.590243));
	smpSharedMesh->GetMesh().setVert(76, Point3(-6.399501,4.971593,-4.791286));
	smpSharedMesh->GetMesh().setVert(77, Point3(-7.245704,4.684475,-4.590243));
	smpSharedMesh->GetMesh().setVert(78, Point3(-7.596208,3.991309,-4.104883));
	smpSharedMesh->GetMesh().setVert(79, Point3(-7.245700,3.298144,-3.619523));
	smpSharedMesh->GetMesh().setVert(80, Point3(-6.399501,3.011024,-3.418482));
	smpSharedMesh->GetMesh().setVert(81, Point3(-5.553304,3.298143,-3.619523));
	smpSharedMesh->GetMesh().setVert(82, Point3(-4.700181,4.326933,-3.625562));
	smpSharedMesh->GetMesh().setVert(83, Point3(-5.197900,5.311228,-4.314773));
	smpSharedMesh->GetMesh().setVert(84, Point3(-6.399501,5.718936,-4.600252));
	smpSharedMesh->GetMesh().setVert(85, Point3(-7.601106,5.311228,-4.314773));
	smpSharedMesh->GetMesh().setVert(86, Point3(-8.098825,4.326933,-3.625562));
	smpSharedMesh->GetMesh().setVert(87, Point3(-7.601106,3.342639,-2.936350));
	smpSharedMesh->GetMesh().setVert(88, Point3(-6.399501,2.934930,-2.650871));
	smpSharedMesh->GetMesh().setVert(89, Point3(-5.197900,3.342638,-2.936352));
	smpSharedMesh->GetMesh().setVert(90, Point3(-2.228243,-0.091865,-9.172746));
	smpSharedMesh->GetMesh().setVert(91, Point3(-2.073412,0.786230,-9.172744));
	smpSharedMesh->GetMesh().setVert(92, Point3(-1.627592,1.558412,-9.172746));
	smpSharedMesh->GetMesh().setVert(93, Point3(-0.944555,2.131548,-9.172746));
	smpSharedMesh->GetMesh().setVert(94, Point3(-0.106688,2.436507,-9.172744));
	smpSharedMesh->GetMesh().setVert(95, Point3(0.784952,2.436507,-9.172744));
	smpSharedMesh->GetMesh().setVert(96, Point3(1.622821,2.131547,-9.172746));
	smpSharedMesh->GetMesh().setVert(97, Point3(2.305858,1.558413,-9.172746));
	smpSharedMesh->GetMesh().setVert(98, Point3(2.751678,0.786228,-9.172744));
	smpSharedMesh->GetMesh().setVert(99, Point3(2.906510,-0.091866,-9.172746));
	smpSharedMesh->GetMesh().setVert(100, Point3(2.751678,-0.969961,-9.172746));
	smpSharedMesh->GetMesh().setVert(101, Point3(2.305857,-1.742143,-9.172744));
	smpSharedMesh->GetMesh().setVert(102, Point3(1.622820,-2.315279,-9.172744));
	smpSharedMesh->GetMesh().setVert(103, Point3(0.784952,-2.620237,-9.172746));
	smpSharedMesh->GetMesh().setVert(104, Point3(-0.106688,-2.620237,-9.172746));
	smpSharedMesh->GetMesh().setVert(105, Point3(-0.944556,-2.315279,-9.172746));
	smpSharedMesh->GetMesh().setVert(106, Point3(-1.627593,-1.742142,-9.172744));
	smpSharedMesh->GetMesh().setVert(107, Point3(-2.073413,-0.969958,-9.172747));
	smpSharedMesh->GetMesh().setVert(108, Point3(-2.228243,-0.091864,-14.836016));
	smpSharedMesh->GetMesh().setVert(109, Point3(-2.073412,0.786230,-14.836016));
	smpSharedMesh->GetMesh().setVert(110, Point3(-1.627591,1.558412,-14.836016));
	smpSharedMesh->GetMesh().setVert(111, Point3(-0.944554,2.131549,-14.836016));
	smpSharedMesh->GetMesh().setVert(112, Point3(-0.106687,2.436507,-14.836020));
	smpSharedMesh->GetMesh().setVert(113, Point3(0.784954,2.436507,-14.836020));
	smpSharedMesh->GetMesh().setVert(114, Point3(1.622822,2.131548,-14.836020));
	smpSharedMesh->GetMesh().setVert(115, Point3(2.305858,1.558412,-14.836016));
	smpSharedMesh->GetMesh().setVert(116, Point3(2.751678,0.786230,-14.836020));
	smpSharedMesh->GetMesh().setVert(117, Point3(2.906510,-0.091865,-14.836020));
	smpSharedMesh->GetMesh().setVert(118, Point3(2.751679,-0.969959,-14.836016));
	smpSharedMesh->GetMesh().setVert(119, Point3(2.305858,-1.742141,-14.836016));
	smpSharedMesh->GetMesh().setVert(120, Point3(1.622821,-2.315277,-14.836016));
	smpSharedMesh->GetMesh().setVert(121, Point3(0.784952,-2.620236,-14.836016));
	smpSharedMesh->GetMesh().setVert(122, Point3(-0.106688,-2.620236,-14.836016));
	smpSharedMesh->GetMesh().setVert(123, Point3(-0.944555,-2.315276,-14.836016));
	smpSharedMesh->GetMesh().setVert(124, Point3(-1.627592,-1.742141,-14.836016));
	smpSharedMesh->GetMesh().setVert(125, Point3(-2.073412,-0.969958,-14.836016));
	smpSharedMesh->GetMesh().setVert(126, Point3(-2.774064,-0.091865,-16.139450));
	smpSharedMesh->GetMesh().setVert(127, Point3(-2.586314,0.972911,-16.139450));
	smpSharedMesh->GetMesh().setVert(128, Point3(-2.045713,1.909259,-16.139450));
	smpSharedMesh->GetMesh().setVert(129, Point3(-1.217464,2.604243,-16.139450));
	smpSharedMesh->GetMesh().setVert(130, Point3(-0.201468,2.974035,-16.139450));
	smpSharedMesh->GetMesh().setVert(131, Point3(0.879735,2.974035,-16.139450));
	smpSharedMesh->GetMesh().setVert(132, Point3(1.895732,2.604242,-16.139450));
	smpSharedMesh->GetMesh().setVert(133, Point3(2.723981,1.909260,-16.139450));
	smpSharedMesh->GetMesh().setVert(134, Point3(3.264582,0.972910,-16.139450));
	smpSharedMesh->GetMesh().setVert(135, Point3(3.452331,-0.091865,-16.139450));
	smpSharedMesh->GetMesh().setVert(136, Point3(3.264582,-1.156641,-16.139450));
	smpSharedMesh->GetMesh().setVert(137, Point3(2.723980,-2.092987,-16.139450));
	smpSharedMesh->GetMesh().setVert(138, Point3(1.895732,-2.787971,-16.139450));
	smpSharedMesh->GetMesh().setVert(139, Point3(0.879734,-3.157765,-16.139450));
	smpSharedMesh->GetMesh().setVert(140, Point3(-0.201468,-3.157763,-16.139450));
	smpSharedMesh->GetMesh().setVert(141, Point3(-1.217465,-2.787971,-16.139450));
	smpSharedMesh->GetMesh().setVert(142, Point3(-2.045714,-2.092988,-16.139450));
	smpSharedMesh->GetMesh().setVert(143, Point3(-2.586316,-1.156639,-16.139450));
	smpSharedMesh->GetMesh().setVert(144, Point3(-2.774064,-0.091864,-19.194777));
	smpSharedMesh->GetMesh().setVert(145, Point3(-2.586314,0.972911,-19.194771));
	smpSharedMesh->GetMesh().setVert(146, Point3(-2.045713,1.909259,-19.194773));
	smpSharedMesh->GetMesh().setVert(147, Point3(-1.217464,2.604243,-19.194773));
	smpSharedMesh->GetMesh().setVert(148, Point3(-0.201467,2.974036,-19.194771));
	smpSharedMesh->GetMesh().setVert(149, Point3(0.879735,2.974034,-19.194771));
	smpSharedMesh->GetMesh().setVert(150, Point3(1.895733,2.604243,-19.194773));
	smpSharedMesh->GetMesh().setVert(151, Point3(2.723981,1.909260,-19.194773));
	smpSharedMesh->GetMesh().setVert(152, Point3(3.264582,0.972910,-19.194771));
	smpSharedMesh->GetMesh().setVert(153, Point3(3.452332,-0.091865,-19.194773));
	smpSharedMesh->GetMesh().setVert(154, Point3(3.264582,-1.156642,-19.194771));
	smpSharedMesh->GetMesh().setVert(155, Point3(2.723981,-2.092989,-19.194773));
	smpSharedMesh->GetMesh().setVert(156, Point3(1.895732,-2.787971,-19.194773));
	smpSharedMesh->GetMesh().setVert(157, Point3(0.879734,-3.157765,-19.194771));
	smpSharedMesh->GetMesh().setVert(158, Point3(-0.201468,-3.157763,-19.194771));
	smpSharedMesh->GetMesh().setVert(159, Point3(-1.217464,-2.787970,-19.194777));
	smpSharedMesh->GetMesh().setVert(160, Point3(-2.045714,-2.092988,-19.194777));
	smpSharedMesh->GetMesh().setVert(161, Point3(-2.586316,-1.156640,-19.194773));
	smpSharedMesh->GetMesh().setVert(162, Point3(5.033586,-3.077510,-19.223640));
	smpSharedMesh->GetMesh().setVert(163, Point3(-4.204867,-3.077511,-19.223642));
	smpSharedMesh->GetMesh().setVert(164, Point3(5.033587,3.017310,-19.223642));
	smpSharedMesh->GetMesh().setVert(165, Point3(-4.204867,3.017310,-19.223642));
	smpSharedMesh->GetMesh().setVert(166, Point3(8.950690,-5.661717,-23.902903));
	smpSharedMesh->GetMesh().setVert(167, Point3(-8.121970,-5.661717,-23.902897));
	smpSharedMesh->GetMesh().setVert(168, Point3(8.950689,5.601515,-23.902897));
	smpSharedMesh->GetMesh().setVert(169, Point3(-8.121970,5.601515,-23.902897));
...
//pw need to ceate 2 points to make the bounding box symmetrical
	...
	for (int i =0; i < 170; i++)
		{
		bbox += smpSharedMesh->GetMesh().getVert(i);
		}
	...
	smpSharedMesh->GetMesh().setVert(170, maxVec);
	smpSharedMesh->GetMesh().setVert(171, minVec);

	Face f;

	f.v[0] = 10;  f.v[1] = 9;  f.v[2] = 8;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[0] = f;
	f.v[0] = 8;  f.v[1] = 7;  f.v[2] = 6;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[1] = f;
	f.v[0] = 6;  f.v[1] = 5;  f.v[2] = 4;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[2] = f;
	f.v[0] = 8;  f.v[1] = 6;  f.v[2] = 4;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[3] = f;
	f.v[0] = 4;  f.v[1] = 3;  f.v[2] = 2;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[4] = f;
	f.v[0] = 2;  f.v[1] = 1;  f.v[2] = 0;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[5] = f;
	f.v[0] = 4;  f.v[1] = 2;  f.v[2] = 0;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[6] = f;
	f.v[0] = 8;  f.v[1] = 4;  f.v[2] = 0;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[7] = f;
	f.v[0] = 10;  f.v[1] = 8;  f.v[2] = 0;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[8] = f;
	f.v[0] = 11;  f.v[1] = 10;  f.v[2] = 0;  	f.smGroup = 1;  f.flags = 65541; smpSharedMesh->GetMesh().faces[9] = f;
	f.v[0] = 0;  f.v[1] = 1;  f.v[2] = 13;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[10] = f;
	f.v[0] = 13;  f.v[1] = 12;  f.v[2] = 0;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[11] = f;
	f.v[0] = 1;  f.v[1] = 2;  f.v[2] = 14;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[12] = f;
	f.v[0] = 14;  f.v[1] = 13;  f.v[2] = 1;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[13] = f;
	f.v[0] = 2;  f.v[1] = 3;  f.v[2] = 15;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[14] = f;
	f.v[0] = 15;  f.v[1] = 14;  f.v[2] = 2;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[15] = f;
	f.v[0] = 3;  f.v[1] = 4;  f.v[2] = 16;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[16] = f;
	f.v[0] = 16;  f.v[1] = 15;  f.v[2] = 3;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[17] = f;
	f.v[0] = 4;  f.v[1] = 5;  f.v[2] = 17;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[18] = f;
	f.v[0] = 17;  f.v[1] = 16;  f.v[2] = 4;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[19] = f;
	f.v[0] = 6;  f.v[1] = 7;  f.v[2] = 19;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[20] = f;
	f.v[0] = 19;  f.v[1] = 18;  f.v[2] = 6;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[21] = f;
	f.v[0] = 8;  f.v[1] = 9;  f.v[2] = 21;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[22] = f;
	f.v[0] = 21;  f.v[1] = 20;  f.v[2] = 8;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[23] = f;
	f.v[0] = 10;  f.v[1] = 11;  f.v[2] = 23;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[24] = f;
	f.v[0] = 23;  f.v[1] = 22;  f.v[2] = 10;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[25] = f;
	f.v[0] = 11;  f.v[1] = 0;  f.v[2] = 12;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[26] = f;
	f.v[0] = 12;  f.v[1] = 23;  f.v[2] = 11;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[27] = f;
	f.v[0] = 12;  f.v[1] = 13;  f.v[2] = 14;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[28] = f;
	f.v[0] = 14;  f.v[1] = 15;  f.v[2] = 16;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[29] = f;
	f.v[0] = 16;  f.v[1] = 17;  f.v[2] = 18;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[30] = f;
	f.v[0] = 14;  f.v[1] = 16;  f.v[2] = 18;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[31] = f;
	f.v[0] = 18;  f.v[1] = 19;  f.v[2] = 20;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[32] = f;
	f.v[0] = 20;  f.v[1] = 21;  f.v[2] = 22;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[33] = f;
	f.v[0] = 18;  f.v[1] = 20;  f.v[2] = 22;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[34] = f;
	f.v[0] = 14;  f.v[1] = 18;  f.v[2] = 22;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[35] = f;
	f.v[0] = 12;  f.v[1] = 14;  f.v[2] = 22;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[36] = f;
	f.v[0] = 23;  f.v[1] = 12;  f.v[2] = 22;  	f.smGroup = 1;  f.flags = 5; smpSharedMesh->GetMesh().faces[37] = f;
	f.v[0] = 33;  f.v[1] = 32;  f.v[2] = 31;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[38] = f;
	f.v[0] = 31;  f.v[1] = 30;  f.v[2] = 29;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[39] = f;
	f.v[0] = 29;  f.v[1] = 28;  f.v[2] = 27;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[40] = f;
	f.v[0] = 31;  f.v[1] = 29;  f.v[2] = 27;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[41] = f;
	f.v[0] = 27;  f.v[1] = 26;  f.v[2] = 25;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[42] = f;
	f.v[0] = 25;  f.v[1] = 24;  f.v[2] = 5;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[43] = f;
	f.v[0] = 27;  f.v[1] = 25;  f.v[2] = 5;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[44] = f;
	f.v[0] = 31;  f.v[1] = 27;  f.v[2] = 5;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[45] = f;
	f.v[0] = 33;  f.v[1] = 31;  f.v[2] = 5;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[46] = f;
	f.v[0] = 6;  f.v[1] = 33;  f.v[2] = 5;  	f.smGroup = 1;  f.flags = 65541; smpSharedMesh->GetMesh().faces[47] = f;
	f.v[0] = 5;  f.v[1] = 24;  f.v[2] = 34;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[48] = f;
	f.v[0] = 34;  f.v[1] = 17;  f.v[2] = 5;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[49] = f;
	f.v[0] = 24;  f.v[1] = 25;  f.v[2] = 35;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[50] = f;
	f.v[0] = 35;  f.v[1] = 34;  f.v[2] = 24;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[51] = f;
	f.v[0] = 25;  f.v[1] = 26;  f.v[2] = 36;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[52] = f;
	f.v[0] = 36;  f.v[1] = 35;  f.v[2] = 25;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[53] = f;
	f.v[0] = 26;  f.v[1] = 27;  f.v[2] = 37;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[54] = f;
	f.v[0] = 37;  f.v[1] = 36;  f.v[2] = 26;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[55] = f;
	f.v[0] = 27;  f.v[1] = 28;  f.v[2] = 38;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[56] = f;
	f.v[0] = 38;  f.v[1] = 37;  f.v[2] = 27;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[57] = f;
	f.v[0] = 28;  f.v[1] = 29;  f.v[2] = 39;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[58] = f;
	f.v[0] = 39;  f.v[1] = 38;  f.v[2] = 28;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[59] = f;
	f.v[0] = 29;  f.v[1] = 30;  f.v[2] = 40;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[60] = f;
	f.v[0] = 40;  f.v[1] = 39;  f.v[2] = 29;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[61] = f;
	f.v[0] = 30;  f.v[1] = 31;  f.v[2] = 41;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[62] = f;
	f.v[0] = 41;  f.v[1] = 40;  f.v[2] = 30;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[63] = f;
	f.v[0] = 31;  f.v[1] = 32;  f.v[2] = 42;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[64] = f;
	f.v[0] = 42;  f.v[1] = 41;  f.v[2] = 31;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[65] = f;
	f.v[0] = 33;  f.v[1] = 6;  f.v[2] = 18;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[66] = f;
	f.v[0] = 18;  f.v[1] = 43;  f.v[2] = 33;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[67] = f;
	f.v[0] = 17;  f.v[1] = 34;  f.v[2] = 35;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[68] = f;
	f.v[0] = 35;  f.v[1] = 36;  f.v[2] = 37;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[69] = f;
	f.v[0] = 37;  f.v[1] = 38;  f.v[2] = 39;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[70] = f;
	f.v[0] = 35;  f.v[1] = 37;  f.v[2] = 39;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[71] = f;
	f.v[0] = 39;  f.v[1] = 40;  f.v[2] = 41;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[72] = f;
	f.v[0] = 41;  f.v[1] = 42;  f.v[2] = 43;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[73] = f;
	f.v[0] = 39;  f.v[1] = 41;  f.v[2] = 43;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[74] = f;
	f.v[0] = 35;  f.v[1] = 39;  f.v[2] = 43;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[75] = f;
	f.v[0] = 17;  f.v[1] = 35;  f.v[2] = 43;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[76] = f;
	f.v[0] = 18;  f.v[1] = 17;  f.v[2] = 43;  	f.smGroup = 1;  f.flags = 5; smpSharedMesh->GetMesh().faces[77] = f;
	f.v[0] = 47;  f.v[1] = 45;  f.v[2] = 44;  	f.smGroup = 4;  f.flags = 65539; smpSharedMesh->GetMesh().faces[78] = f;
	f.v[0] = 44;  f.v[1] = 46;  f.v[2] = 47;  	f.smGroup = 4;  f.flags = 65539; smpSharedMesh->GetMesh().faces[79] = f;
	f.v[0] = 52;  f.v[1] = 53;  f.v[2] = 50;  	f.smGroup = 16;  f.flags = 196611; smpSharedMesh->GetMesh().faces[80] = f;
	f.v[0] = 50;  f.v[1] = 51;  f.v[2] = 52;  	f.smGroup = 16;  f.flags = 196611; smpSharedMesh->GetMesh().faces[81] = f;
	f.v[0] = 56;  f.v[1] = 57;  f.v[2] = 54;  	f.smGroup = 64;  f.flags = 131075; smpSharedMesh->GetMesh().faces[82] = f;
	f.v[0] = 54;  f.v[1] = 55;  f.v[2] = 56;  	f.smGroup = 64;  f.flags = 131075; smpSharedMesh->GetMesh().faces[83] = f;
	f.v[0] = 51;  f.v[1] = 50;  f.v[2] = 45;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[84] = f;
	f.v[0] = 45;  f.v[1] = 47;  f.v[2] = 51;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[85] = f;
	f.v[0] = 55;  f.v[1] = 54;  f.v[2] = 46;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[86] = f;
	f.v[0] = 46;  f.v[1] = 44;  f.v[2] = 55;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[87] = f;
	f.v[0] = 57;  f.v[1] = 56;  f.v[2] = 48;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[88] = f;
	f.v[0] = 48;  f.v[1] = 49;  f.v[2] = 57;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[89] = f;
	f.v[0] = 52;  f.v[1] = 49;  f.v[2] = 48;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[90] = f;
	f.v[0] = 48;  f.v[1] = 53;  f.v[2] = 52;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[91] = f;
	f.v[0] = 56;  f.v[1] = 55;  f.v[2] = 44;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[92] = f;
	f.v[0] = 56;  f.v[1] = 44;  f.v[2] = 45;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[93] = f;
	f.v[0] = 56;  f.v[1] = 45;  f.v[2] = 50;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[94] = f;
	f.v[0] = 56;  f.v[1] = 50;  f.v[2] = 53;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[95] = f;
	f.v[0] = 48;  f.v[1] = 56;  f.v[2] = 53;  	f.smGroup = 0;  f.flags = 5; smpSharedMesh->GetMesh().faces[96] = f;
	f.v[0] = 51;  f.v[1] = 47;  f.v[2] = 46;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[97] = f;
	f.v[0] = 51;  f.v[1] = 46;  f.v[2] = 54;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[98] = f;
	f.v[0] = 51;  f.v[1] = 54;  f.v[2] = 57;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[99] = f;
	f.v[0] = 51;  f.v[1] = 57;  f.v[2] = 49;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[100] = f;
	f.v[0] = 52;  f.v[1] = 51;  f.v[2] = 49;  	f.smGroup = 0;  f.flags = 5; smpSharedMesh->GetMesh().faces[101] = f;
	f.v[0] = 22;  f.v[1] = 21;  f.v[2] = 9;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[102] = f;
	f.v[0] = 9;  f.v[1] = 10;  f.v[2] = 22;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[103] = f;
	f.v[0] = 60;  f.v[1] = 59;  f.v[2] = 58;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[104] = f;
	f.v[0] = 58;  f.v[1] = 65;  f.v[2] = 64;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[105] = f;
	f.v[0] = 64;  f.v[1] = 63;  f.v[2] = 62;  	f.smGroup = 1;  f.flags = 65539; smpSharedMesh->GetMesh().faces[106] = f;
	f.v[0] = 58;  f.v[1] = 64;  f.v[2] = 62;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[107] = f;
	f.v[0] = 60;  f.v[1] = 58;  f.v[2] = 62;  	f.smGroup = 1;  f.flags = 65536; smpSharedMesh->GetMesh().faces[108] = f;
	f.v[0] = 60;  f.v[1] = 62;  f.v[2] = 61;  	f.smGroup = 1;  f.flags = 65542; smpSharedMesh->GetMesh().faces[109] = f;
	f.v[0] = 59;  f.v[1] = 60;  f.v[2] = 68;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[110] = f;
	f.v[0] = 59;  f.v[1] = 68;  f.v[2] = 67;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[111] = f;
	f.v[0] = 67;  f.v[1] = 66;  f.v[2] = 58;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[112] = f;
	f.v[0] = 59;  f.v[1] = 67;  f.v[2] = 58;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[113] = f;
	f.v[0] = 61;  f.v[1] = 62;  f.v[2] = 70;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[114] = f;
	f.v[0] = 61;  f.v[1] = 70;  f.v[2] = 69;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[115] = f;
	f.v[0] = 69;  f.v[1] = 68;  f.v[2] = 60;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[116] = f;
	f.v[0] = 61;  f.v[1] = 69;  f.v[2] = 60;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[117] = f;
	f.v[0] = 63;  f.v[1] = 64;  f.v[2] = 72;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[118] = f;
	f.v[0] = 63;  f.v[1] = 72;  f.v[2] = 71;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[119] = f;
	f.v[0] = 71;  f.v[1] = 70;  f.v[2] = 62;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[120] = f;
	f.v[0] = 63;  f.v[1] = 71;  f.v[2] = 62;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[121] = f;
	f.v[0] = 65;  f.v[1] = 58;  f.v[2] = 66;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[122] = f;
	f.v[0] = 65;  f.v[1] = 66;  f.v[2] = 73;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[123] = f;
	f.v[0] = 73;  f.v[1] = 72;  f.v[2] = 64;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[124] = f;
	f.v[0] = 65;  f.v[1] = 73;  f.v[2] = 64;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[125] = f;
	f.v[0] = 67;  f.v[1] = 68;  f.v[2] = 76;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[126] = f;
	f.v[0] = 67;  f.v[1] = 76;  f.v[2] = 75;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[127] = f;
	f.v[0] = 75;  f.v[1] = 74;  f.v[2] = 66;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[128] = f;
	f.v[0] = 67;  f.v[1] = 75;  f.v[2] = 66;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[129] = f;
	f.v[0] = 69;  f.v[1] = 70;  f.v[2] = 78;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[130] = f;
	f.v[0] = 69;  f.v[1] = 78;  f.v[2] = 77;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[131] = f;
	f.v[0] = 77;  f.v[1] = 76;  f.v[2] = 68;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[132] = f;
	f.v[0] = 69;  f.v[1] = 77;  f.v[2] = 68;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[133] = f;
	f.v[0] = 71;  f.v[1] = 72;  f.v[2] = 80;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[134] = f;
	f.v[0] = 71;  f.v[1] = 80;  f.v[2] = 79;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[135] = f;
	f.v[0] = 79;  f.v[1] = 78;  f.v[2] = 70;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[136] = f;
	f.v[0] = 71;  f.v[1] = 79;  f.v[2] = 70;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[137] = f;
	f.v[0] = 73;  f.v[1] = 66;  f.v[2] = 74;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[138] = f;
	f.v[0] = 73;  f.v[1] = 74;  f.v[2] = 81;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[139] = f;
	f.v[0] = 81;  f.v[1] = 80;  f.v[2] = 72;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[140] = f;
	f.v[0] = 73;  f.v[1] = 81;  f.v[2] = 72;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[141] = f;
	f.v[0] = 86;  f.v[1] = 87;  f.v[2] = 88;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[142] = f;
	f.v[0] = 88;  f.v[1] = 89;  f.v[2] = 82;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[143] = f;
	f.v[0] = 82;  f.v[1] = 83;  f.v[2] = 84;  	f.smGroup = 1;  f.flags = 3; smpSharedMesh->GetMesh().faces[144] = f;
	f.v[0] = 88;  f.v[1] = 82;  f.v[2] = 84;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[145] = f;
	f.v[0] = 86;  f.v[1] = 88;  f.v[2] = 84;  	f.smGroup = 1;  f.flags = 0; smpSharedMesh->GetMesh().faces[146] = f;
	f.v[0] = 86;  f.v[1] = 84;  f.v[2] = 85;  	f.smGroup = 1;  f.flags = 6; smpSharedMesh->GetMesh().faces[147] = f;
	f.v[0] = 75;  f.v[1] = 76;  f.v[2] = 84;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[148] = f;
	f.v[0] = 75;  f.v[1] = 84;  f.v[2] = 83;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[149] = f;
	f.v[0] = 83;  f.v[1] = 82;  f.v[2] = 74;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[150] = f;
	f.v[0] = 75;  f.v[1] = 83;  f.v[2] = 74;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[151] = f;
	f.v[0] = 77;  f.v[1] = 78;  f.v[2] = 86;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[152] = f;
	f.v[0] = 77;  f.v[1] = 86;  f.v[2] = 85;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[153] = f;
	f.v[0] = 85;  f.v[1] = 84;  f.v[2] = 76;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[154] = f;
	f.v[0] = 77;  f.v[1] = 85;  f.v[2] = 76;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[155] = f;
	f.v[0] = 79;  f.v[1] = 80;  f.v[2] = 88;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[156] = f;
	f.v[0] = 79;  f.v[1] = 88;  f.v[2] = 87;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[157] = f;
	f.v[0] = 87;  f.v[1] = 86;  f.v[2] = 78;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[158] = f;
	f.v[0] = 79;  f.v[1] = 87;  f.v[2] = 78;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[159] = f;
	f.v[0] = 81;  f.v[1] = 74;  f.v[2] = 82;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[160] = f;
	f.v[0] = 81;  f.v[1] = 82;  f.v[2] = 89;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[161] = f;
	f.v[0] = 89;  f.v[1] = 88;  f.v[2] = 80;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[162] = f;
	f.v[0] = 81;  f.v[1] = 89;  f.v[2] = 80;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[163] = f;
	f.v[0] = 108;  f.v[1] = 125;  f.v[2] = 107;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[164] = f;
	f.v[0] = 108;  f.v[1] = 107;  f.v[2] = 90;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[165] = f;
	f.v[0] = 90;  f.v[1] = 91;  f.v[2] = 109;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[166] = f;
	f.v[0] = 108;  f.v[1] = 90;  f.v[2] = 109;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[167] = f;
	f.v[0] = 92;  f.v[1] = 93;  f.v[2] = 111;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[168] = f;
	f.v[0] = 92;  f.v[1] = 111;  f.v[2] = 110;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[169] = f;
	f.v[0] = 110;  f.v[1] = 109;  f.v[2] = 91;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[170] = f;
	f.v[0] = 92;  f.v[1] = 110;  f.v[2] = 91;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[171] = f;
	f.v[0] = 94;  f.v[1] = 95;  f.v[2] = 113;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[172] = f;
	f.v[0] = 94;  f.v[1] = 113;  f.v[2] = 112;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[173] = f;
	f.v[0] = 112;  f.v[1] = 111;  f.v[2] = 93;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[174] = f;
	f.v[0] = 94;  f.v[1] = 112;  f.v[2] = 93;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[175] = f;
	f.v[0] = 96;  f.v[1] = 97;  f.v[2] = 115;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[176] = f;
	f.v[0] = 96;  f.v[1] = 115;  f.v[2] = 114;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[177] = f;
	f.v[0] = 114;  f.v[1] = 113;  f.v[2] = 95;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[178] = f;
	f.v[0] = 96;  f.v[1] = 114;  f.v[2] = 95;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[179] = f;
	f.v[0] = 98;  f.v[1] = 99;  f.v[2] = 117;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[180] = f;
	f.v[0] = 98;  f.v[1] = 117;  f.v[2] = 116;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[181] = f;
	f.v[0] = 116;  f.v[1] = 115;  f.v[2] = 97;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[182] = f;
	f.v[0] = 98;  f.v[1] = 116;  f.v[2] = 97;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[183] = f;
	f.v[0] = 100;  f.v[1] = 101;  f.v[2] = 119;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[184] = f;
	f.v[0] = 100;  f.v[1] = 119;  f.v[2] = 118;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[185] = f;
	f.v[0] = 118;  f.v[1] = 117;  f.v[2] = 99;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[186] = f;
	f.v[0] = 100;  f.v[1] = 118;  f.v[2] = 99;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[187] = f;
	f.v[0] = 102;  f.v[1] = 103;  f.v[2] = 121;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[188] = f;
	f.v[0] = 102;  f.v[1] = 121;  f.v[2] = 120;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[189] = f;
	f.v[0] = 120;  f.v[1] = 119;  f.v[2] = 101;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[190] = f;
	f.v[0] = 102;  f.v[1] = 120;  f.v[2] = 101;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[191] = f;
	f.v[0] = 104;  f.v[1] = 105;  f.v[2] = 123;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[192] = f;
	f.v[0] = 104;  f.v[1] = 123;  f.v[2] = 122;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[193] = f;
	f.v[0] = 122;  f.v[1] = 121;  f.v[2] = 103;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[194] = f;
	f.v[0] = 104;  f.v[1] = 122;  f.v[2] = 103;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[195] = f;
	f.v[0] = 106;  f.v[1] = 107;  f.v[2] = 125;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[196] = f;
	f.v[0] = 106;  f.v[1] = 125;  f.v[2] = 124;  	f.smGroup = 8;  f.flags = 131074; smpSharedMesh->GetMesh().faces[197] = f;
	f.v[0] = 124;  f.v[1] = 123;  f.v[2] = 105;  	f.smGroup = 8;  f.flags = 131075; smpSharedMesh->GetMesh().faces[198] = f;
	f.v[0] = 106;  f.v[1] = 124;  f.v[2] = 105;  	f.smGroup = 8;  f.flags = 131076; smpSharedMesh->GetMesh().faces[199] = f;
	f.v[0] = 110;  f.v[1] = 111;  f.v[2] = 129;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[200] = f;
	f.v[0] = 110;  f.v[1] = 129;  f.v[2] = 128;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[201] = f;
	f.v[0] = 128;  f.v[1] = 127;  f.v[2] = 109;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[202] = f;
	f.v[0] = 110;  f.v[1] = 128;  f.v[2] = 109;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[203] = f;
	f.v[0] = 112;  f.v[1] = 113;  f.v[2] = 131;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[204] = f;
	f.v[0] = 112;  f.v[1] = 131;  f.v[2] = 130;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[205] = f;
	f.v[0] = 130;  f.v[1] = 129;  f.v[2] = 111;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[206] = f;
	f.v[0] = 112;  f.v[1] = 130;  f.v[2] = 111;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[207] = f;
	f.v[0] = 114;  f.v[1] = 115;  f.v[2] = 133;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[208] = f;
	f.v[0] = 114;  f.v[1] = 133;  f.v[2] = 132;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[209] = f;
	f.v[0] = 132;  f.v[1] = 131;  f.v[2] = 113;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[210] = f;
	f.v[0] = 114;  f.v[1] = 132;  f.v[2] = 113;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[211] = f;
	f.v[0] = 116;  f.v[1] = 117;  f.v[2] = 135;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[212] = f;
	f.v[0] = 116;  f.v[1] = 135;  f.v[2] = 134;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[213] = f;
	f.v[0] = 134;  f.v[1] = 133;  f.v[2] = 115;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[214] = f;
	f.v[0] = 116;  f.v[1] = 134;  f.v[2] = 115;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[215] = f;
	f.v[0] = 118;  f.v[1] = 119;  f.v[2] = 137;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[216] = f;
	f.v[0] = 118;  f.v[1] = 137;  f.v[2] = 136;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[217] = f;
	f.v[0] = 136;  f.v[1] = 135;  f.v[2] = 117;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[218] = f;
	f.v[0] = 118;  f.v[1] = 136;  f.v[2] = 117;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[219] = f;
	f.v[0] = 120;  f.v[1] = 121;  f.v[2] = 139;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[220] = f;
	f.v[0] = 120;  f.v[1] = 139;  f.v[2] = 138;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[221] = f;
	f.v[0] = 138;  f.v[1] = 137;  f.v[2] = 119;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[222] = f;
	f.v[0] = 120;  f.v[1] = 138;  f.v[2] = 119;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[223] = f;
	f.v[0] = 122;  f.v[1] = 123;  f.v[2] = 141;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[224] = f;
	f.v[0] = 122;  f.v[1] = 141;  f.v[2] = 140;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[225] = f;
	f.v[0] = 140;  f.v[1] = 139;  f.v[2] = 121;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[226] = f;
	f.v[0] = 122;  f.v[1] = 140;  f.v[2] = 121;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[227] = f;
	f.v[0] = 124;  f.v[1] = 125;  f.v[2] = 143;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[228] = f;
	f.v[0] = 124;  f.v[1] = 143;  f.v[2] = 142;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[229] = f;
	f.v[0] = 142;  f.v[1] = 141;  f.v[2] = 123;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[230] = f;
	f.v[0] = 124;  f.v[1] = 142;  f.v[2] = 123;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[231] = f;
	f.v[0] = 108;  f.v[1] = 109;  f.v[2] = 127;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[232] = f;
	f.v[0] = 108;  f.v[1] = 127;  f.v[2] = 126;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[233] = f;
	f.v[0] = 126;  f.v[1] = 143;  f.v[2] = 125;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[234] = f;
	f.v[0] = 108;  f.v[1] = 126;  f.v[2] = 125;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[235] = f;
	f.v[0] = 128;  f.v[1] = 129;  f.v[2] = 147;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[236] = f;
	f.v[0] = 128;  f.v[1] = 147;  f.v[2] = 146;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[237] = f;
	f.v[0] = 146;  f.v[1] = 145;  f.v[2] = 127;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[238] = f;
	f.v[0] = 128;  f.v[1] = 146;  f.v[2] = 127;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[239] = f;
	f.v[0] = 130;  f.v[1] = 131;  f.v[2] = 149;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[240] = f;
	f.v[0] = 130;  f.v[1] = 149;  f.v[2] = 148;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[241] = f;
	f.v[0] = 148;  f.v[1] = 147;  f.v[2] = 129;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[242] = f;
	f.v[0] = 130;  f.v[1] = 148;  f.v[2] = 129;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[243] = f;
	f.v[0] = 132;  f.v[1] = 133;  f.v[2] = 151;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[244] = f;
	f.v[0] = 132;  f.v[1] = 151;  f.v[2] = 150;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[245] = f;
	f.v[0] = 150;  f.v[1] = 149;  f.v[2] = 131;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[246] = f;
	f.v[0] = 132;  f.v[1] = 150;  f.v[2] = 131;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[247] = f;
	f.v[0] = 134;  f.v[1] = 135;  f.v[2] = 153;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[248] = f;
	f.v[0] = 134;  f.v[1] = 153;  f.v[2] = 152;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[249] = f;
	f.v[0] = 152;  f.v[1] = 151;  f.v[2] = 133;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[250] = f;
	f.v[0] = 134;  f.v[1] = 152;  f.v[2] = 133;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[251] = f;
	f.v[0] = 136;  f.v[1] = 137;  f.v[2] = 155;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[252] = f;
	f.v[0] = 136;  f.v[1] = 155;  f.v[2] = 154;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[253] = f;
	f.v[0] = 154;  f.v[1] = 153;  f.v[2] = 135;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[254] = f;
	f.v[0] = 136;  f.v[1] = 154;  f.v[2] = 135;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[255] = f;
	f.v[0] = 138;  f.v[1] = 139;  f.v[2] = 157;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[256] = f;
	f.v[0] = 138;  f.v[1] = 157;  f.v[2] = 156;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[257] = f;
	f.v[0] = 156;  f.v[1] = 155;  f.v[2] = 137;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[258] = f;
	f.v[0] = 138;  f.v[1] = 156;  f.v[2] = 137;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[259] = f;
	f.v[0] = 140;  f.v[1] = 141;  f.v[2] = 159;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[260] = f;
	f.v[0] = 140;  f.v[1] = 159;  f.v[2] = 158;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[261] = f;
	f.v[0] = 158;  f.v[1] = 157;  f.v[2] = 139;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[262] = f;
	f.v[0] = 140;  f.v[1] = 158;  f.v[2] = 139;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[263] = f;
	f.v[0] = 142;  f.v[1] = 143;  f.v[2] = 161;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[264] = f;
	f.v[0] = 142;  f.v[1] = 161;  f.v[2] = 160;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[265] = f;
	f.v[0] = 160;  f.v[1] = 159;  f.v[2] = 141;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[266] = f;
	f.v[0] = 142;  f.v[1] = 160;  f.v[2] = 141;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[267] = f;
	f.v[0] = 126;  f.v[1] = 127;  f.v[2] = 145;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[268] = f;
	f.v[0] = 126;  f.v[1] = 145;  f.v[2] = 144;  	f.smGroup = 0;  f.flags = 2; smpSharedMesh->GetMesh().faces[269] = f;
	f.v[0] = 144;  f.v[1] = 161;  f.v[2] = 143;  	f.smGroup = 0;  f.flags = 3; smpSharedMesh->GetMesh().faces[270] = f;
	f.v[0] = 126;  f.v[1] = 144;  f.v[2] = 143;  	f.smGroup = 0;  f.flags = 4; smpSharedMesh->GetMesh().faces[271] = f;
	f.v[0] = 165;  f.v[1] = 163;  f.v[2] = 162;  	f.smGroup = 4;  f.flags = 65539; smpSharedMesh->GetMesh().faces[272] = f;
	f.v[0] = 162;  f.v[1] = 164;  f.v[2] = 165;  	f.smGroup = 4;  f.flags = 65539; smpSharedMesh->GetMesh().faces[273] = f;
	f.v[0] = 169;  f.v[1] = 168;  f.v[2] = 166;  	f.smGroup = 2;  f.flags = 3; smpSharedMesh->GetMesh().faces[274] = f;
	f.v[0] = 166;  f.v[1] = 167;  f.v[2] = 169;  	f.smGroup = 2;  f.flags = 3; smpSharedMesh->GetMesh().faces[275] = f;
	f.v[0] = 167;  f.v[1] = 166;  f.v[2] = 162;  	f.smGroup = 8;  f.flags = 262147; smpSharedMesh->GetMesh().faces[276] = f;
	f.v[0] = 162;  f.v[1] = 163;  f.v[2] = 167;  	f.smGroup = 8;  f.flags = 262147; smpSharedMesh->GetMesh().faces[277] = f;
	f.v[0] = 169;  f.v[1] = 167;  f.v[2] = 163;  	f.smGroup = 16;  f.flags = 196611; smpSharedMesh->GetMesh().faces[278] = f;
	f.v[0] = 163;  f.v[1] = 165;  f.v[2] = 169;  	f.smGroup = 16;  f.flags = 196611; smpSharedMesh->GetMesh().faces[279] = f;
	f.v[0] = 168;  f.v[1] = 169;  f.v[2] = 165;  	f.smGroup = 32;  f.flags = 327683; smpSharedMesh->GetMesh().faces[280] = f;
	f.v[0] = 165;  f.v[1] = 164;  f.v[2] = 168;  	f.smGroup = 32;  f.flags = 327683; smpSharedMesh->GetMesh().faces[281] = f;
	f.v[0] = 166;  f.v[1] = 168;  f.v[2] = 164;  	f.smGroup = 64;  f.flags = 131075; smpSharedMesh->GetMesh().faces[282] = f;
	f.v[0] = 164;  f.v[1] = 162;  f.v[2] = 166;  	f.smGroup = 64;  f.flags = 131075; smpSharedMesh->GetMesh().faces[283] = f;

	smpSharedMesh->GetMesh().buildNormals();
	smpSharedMesh->GetMesh().EnableEdgeList(1);
	meshBuilt = 1;
	}
...
{
	BOOL enabled;
	pblock->GetValue(PB_MP_EFF_REND_EFF_PER_PASS, 0, enabled);
	return enabled;
}
...
void SimpleCamera::GetDeformBBox(TimeValue t, Box3& box, Matrix3 *tm, BOOL useSel )
	{
	box = smpSharedMesh->GetMesh().getBoundingBox(tm);
	}
...
void SimpleCamera::GetLocalBoundBox(TimeValue t, INode* inode, ViewExp* vpt, Box3& box ){
	...
	box = smpSharedMesh->GetMesh().getBoundingBox();
#if 0
	if (!hasTarget) {
		if (coneState) {
			Point3 q[4];
	...
	if( rangeDisplay) {
		Point3 q[4];
		float rad = std::max(GetEnvRange(t, ENV_NEAR_RANGE), GetEnvRange(t, ENV_FAR_RANGE));
...
void SimpleCamera::GetWorldBoundBox(TimeValue t, INode* inode, ViewExp* vpt, Box3& box )
	...
	nv = smpSharedMesh->GetMesh().getNumVerts();
	box.Init();
	if(!(extDispFlags & EXT_DISP_ZOOM_EXT))
		for (i=0; i<nv; i++) 
			box += tm*smpSharedMesh->GetMesh().getVert(i);
	else
		box += tm.GetTrans();
...
//				SetWindowText(GetDlgItem(hSimpleCamParams,IDC_TARG_DISTANCE),buf);
			...
			if(!inode->IsFrozen() && !inode->Dependent())
			{
				...
				// use that color for the target line too
				Color color(inode->GetWireColor());
				if (color != Color(GetUIColor(COLOR_CAMERA_OBJ)))
...
int SimpleCamera::HitTest(TimeValue t, INode* inode, int type, int crossing, int flags, IPoint2 *p, ViewExp *vpt) {
	...
	gw->setTransform(m);
	gw->clearHitCode();
	res = smpSharedMesh->GetMesh().select( gw, gw->getMaterial(), &hitRegion, flags & HIT_ABORTONHIT ); 
	...
	MaxSDK::Graphics::IRenderItemContainer& targetRenderItemContainer)
{
	...
	MaxSDK::Graphics::Utilities::MeshEdgeRenderItemPtr pMeshItem = new CameraMeshItem(smpSharedMesh);
	if (pNode->Dependent())
	{
...
int SimpleCamera::Display(TimeValue t, INode* inode, ViewExp *vpt, int flags) {
	...
	if (!MaxSDK::Graphics::IsRetainedModeEnabled())
	{
		smpSharedMesh->GetMesh().render( gw, gw->getMaterial(), NULL, COMP_ALL);	
	}
...
RefResult SimpleCamera::NotifyRefChanged(const Interval& changeInt, RefTargetHandle hTarget, 
	...
	switch (message) {		
		...
		case REFMSG_GET_PARAM_NAME_LOCALIZED: {
			...
			{
				switch (gpn->index) {
					case PB_FOV:                      gpn->name = GetString(IDS_RB_FOV);                   break;
					case PB_TDIST:                    gpn->name = GetString(IDS_DB_TDIST);                 break;
					case PB_HITHER:                   gpn->name = GetString(IDS_RB_NEARPLANE);             break;
					case PB_YON:                      gpn->name = GetString(IDS_RB_FARPLANE);              break;
					case PB_NRANGE:                   gpn->name = GetString(IDS_DB_NRANGE);                break;
					case PB_FRANGE:                   gpn->name = GetString(IDS_DB_FRANGE);                break;
					case PB_FOV_TYPE:                 gpn->name = GetString(IDS_FOV_TYPE);                 break;
					case PB_MP_EFFECT_ENABLE:         gpn->name = GetString(IDS_MP_EFFECT_ENABLE);         break;
					case PB_MP_EFF_REND_EFF_PER_PASS: gpn->name = GetString(IDS_MP_EFF_REND_EFF_PER_PASS); break;
					}
				return REF_HALT;
			}
			return REF_STOP;
		...
		case REFMSG_GET_PARAM_NAME_NONLOCALIZED: {
			...
			{
				switch (gpn->index) {
					case PB_FOV:                      gpn->name = _T("FOV");                                break;
					case PB_TDIST:                    gpn->name = _T("Target Distance");                    break;
					case PB_HITHER:                   gpn->name = _T("Near Clip");                          break;
					case PB_YON:                      gpn->name = _T("Far Clip ");                          break;
					case PB_NRANGE:                   gpn->name = _T("Near Env Range");                     break;
					case PB_FRANGE:                   gpn->name = _T("Far Env Range");                      break;
					case PB_FOV_TYPE:                 gpn->name = _T("FOV Type");                           break;
					case PB_MP_EFFECT_ENABLE:         gpn->name = _T("MultiPass Effect Enabled");           break;
					case PB_MP_EFF_REND_EFF_PER_PASS: gpn->name = _T("MPEffect - Render Effects Per Pass"); break;
					}
				return REF_HALT;
			}
			return REF_STOP;
...
class LACamClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Target"); }
	SClass_ID		SuperClassID() { return CAMERA_CLASS_ID; }
...
class LACamCreationManager : public MouseCallBack, ReferenceMaker {
	private:
		...
		virtual void GetClassName(MSTR& s, bool localized) const override { s = _M("LACamCreationManager"); }
