...
void TargetObject::AddRenderitem(const MaxSDK::Graphics::UpdateDisplayContext& updateDisplayContext, 
...
unsigned long TargetObject::GetObjectDisplayRequirement() const
{
	return 1;
}

bool TargetObject::PrepareDisplay(const MaxSDK::Graphics::UpdateDisplayContext& displayContext)
{
	return true;
}

bool TargetObject::UpdatePerNodeItems(
...
RefResult TargetObject::NotifyRefChanged(const Interval& changeInt, RefTargetHandle hTarget, 
