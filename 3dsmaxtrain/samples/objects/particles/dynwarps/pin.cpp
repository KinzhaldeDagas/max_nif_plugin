...
class PinObject : public SimpleWSMObject {
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override {return localized ? GetString(IDS_AP_PIN) : _T("PinConstraint");}
...
{	public:
		...
		const TCHAR*	NonLocalizedClassName() { return _T("Pin"); }
...
{	public:				
		...
		// From Animatable
		void GetClassName(MSTR& s, bool localized) const override {s= localized ? GetString(IDS_AP_PINMOD) : _T("PinConstraintMod");}
		SClass_ID SuperClassID() {return WSM_CLASS_ID;}
		void DeleteThis() {delete this;}
		Class_ID ClassID() { return PINMOD_CLASS_ID;}
		RefTargetHandle Clone(RemapDir& remap);
		const TCHAR *GetObjectName(bool localized) const override {return localized ? GetString(IDS_AP_PINBINDING) : _T("PinConstraintBinding");}
...
{	public:
		...
		const TCHAR*	NonLocalizedClassName() { return _T("PinConstraintMod"); }
		SClass_ID		SuperClassID() {return WSM_CLASS_ID;}
		Class_ID		ClassID() {return PINMOD_CLASS_ID;}
...
TSTR PinObject::GetParameterName(int pbIndex, bool localized)
{	switch (pbIndex)
	{	case PB_ONTIME:	return localized ? GetString(IDS_AP_ONTIME)   : _T("On Time");
		...
		case PB_PINTYPE:	return localized ? GetString(IDS_AP_PINTYPE)  : _T("Constraint Type");
