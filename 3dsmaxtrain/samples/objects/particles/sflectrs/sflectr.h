...
extern void GetVFLst(Mesh* dmesh,MaxSDK::VertexNormal* vnorms,Point3* fnorms);
extern int RayIntersectP(Ray& ray, float& at, Point3& norm,Mesh *amesh,MaxSDK::VertexNormal* vnorms,Point3 *fnorms);
