...
class USpawnDeflObject : public SimpleWSMObject2 {
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override {return localized ? GetString(IDS_EP_USPAWNDEFLECTOR_OBJECT) : _T("UOmniFlect");}
...
class USpawnDeflClassDesc:public ClassDesc2 {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("UOmniFlect"); }
...
class USpawnDeflMod : public SimpleWSMMod {
	public:				
		...
		// From Animatable
		void GetClassName(MSTR& s, bool localized) const override {s= localized ? GetString(IDS_EP_USPAWNDEFLECTORMOD) : _T("UOmniFlectMod");}
		SClass_ID SuperClassID() {return WSM_CLASS_ID;}
		void DeleteThis() {delete this;}
		Class_ID ClassID() { return USPAWNDEFLMOD_CLASS_ID;}
		RefTargetHandle Clone(RemapDir& remap);
		const TCHAR *GetObjectName(bool localized) const override {return localized ? GetString(IDS_EP_USPAWNDEFLECTORBINDING) : _T("UOmniFlector Binding");}
...
class USpawnDeflModClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("UOmniFlectMod"); }
	SClass_ID		SuperClassID() {return WSM_CLASS_ID; }
	Class_ID		ClassID() {return USPAWNDEFLMOD_CLASS_ID;}
...
(	uspflectrobj_params, 
	...
	uspflectrobj_timeoff,	_T("timeOff"),		TYPE_TIMEVALUE,		P_ANIMATABLE + P_RESET_DEFAULT,		IDS_EP_TIMEOFF,
		...
		p_nonLocalizedName, _T("Time Off"),
		p_end,
	...
	uspflectrobj_affects,	_T("affects"),		TYPE_PCNT_FRAC,		P_ANIMATABLE + P_RESET_DEFAULT,		IDS_EP_AFFECTS,
		...
		p_nonLocalizedName, _T("Reflects"),
		p_end,
	...
	uspflectrobj_velocity,	_T("inheritVelocity"),	TYPE_FLOAT,	P_ANIMATABLE + P_RESET_DEFAULT,		IDS_EP_INHERIT,
		...
		p_nonLocalizedName, _T("Velocity Inheritance"),
		p_end,
	...
	uspflectrobj_decelvar,	_T("decelVar"),	TYPE_PCNT_FRAC,		P_ANIMATABLE + P_RESET_DEFAULT,		IDS_AP_DECELVAR,
		...
		p_nonLocalizedName, _T("Deceleration Variation"),
		p_end,
	...
	uspflectrobj_refraction,_T("refraction"),	TYPE_PCNT_FRAC,		P_ANIMATABLE + P_RESET_DEFAULT,		IDS_EP_REFRACTION,
		...
		p_nonLocalizedName, _T("Distortion"),
		p_end,
	...
	uspflectrobj_refractvar,_T("refractionVar"),TYPE_PCNT_FRAC,	P_ANIMATABLE + P_RESET_DEFAULT,		IDS_EP_REFRACTVAR,
		...
		p_nonLocalizedName, _T("Distortion Variation"),
		p_end,
	...
	uspflectrobj_diffusionvar,	_T("diffusionVar"),TYPE_PCNT_FRAC,	P_ANIMATABLE + P_RESET_DEFAULT,		IDS_EP_DIFFUSIONVAR,
		...
		p_nonLocalizedName, _T("Diffusion Variation"),
		p_end,
	...
	uspflectrobj_spawn,		_T("spawn"),		TYPE_PCNT_FRAC,		P_ANIMATABLE + P_RESET_DEFAULT,		IDS_AP_SPAWN,
		...
		p_nonLocalizedName, _T("Spawn Percentage"),
		p_end,
	...
	uspflectrobj_passvel,	_T("passVelocity"),TYPE_FLOAT,		P_ANIMATABLE + P_RESET_DEFAULT,		IDS_AP_PASSVEL,
		...
		p_nonLocalizedName, _T("Pass Velocity"),
		p_end,
	...
	uspflectrobj_passvelvar,_T("passVelocityVar"),	TYPE_PCNT_FRAC,		P_ANIMATABLE + P_RESET_DEFAULT,		IDS_AP_PASSVELVAR,
		...
		p_nonLocalizedName, _T("Pass Velocity Variation"),
		p_end,
...
class CreateUSpawnDeflObjectProc : public MouseCallBack,ReferenceMaker {
	private:
		...
		virtual void GetClassName(MSTR& s, bool localized) const override { s = _M("CreateUSpawnDeflObjectProc"); } // from Animatable
...
{ if ( UspObj ) 
	...
	UspObj->EndEditParams( (IObjParam*)createInterface, 
		...
		{	// RB 4-9-96: Normally the hold isn't holding when this 
			...
			theHold.Suspend(); 
			UspObj->DeleteAllRefsFromMe();
			UspObj->DeleteAllRefsToMe();
			UspObj->DeleteThis();
			UspObj = NULL;
			theHold.Resume();
		...
		case MOUSE_POINT:
			switch ( point ) {
				case 0:
					...
					// link it up
					INode *l_CloudNode = createInterface->CreateObjectNode( UspObj);
					attachedToNode = TRUE;
...
{
	TSTR name= TSTR(GetString(IDS_EP_ITEMSTR)) + (custnode ? custname : TSTR(GetString(IDS_EP_NONE))); 
...
INT_PTR USpawnDeflObjectDlgProc::DlgProc(
