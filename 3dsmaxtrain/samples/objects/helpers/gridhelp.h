...
private:
	...
	float GetGrid(TimeValue t, Interval& valid);
	float GetGrid(TimeValue t) { Interval valid(0, 0); return GetGrid(t, valid); }
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_DB_GRIDHELPER) : _T("GridHelper"); }
...
public:
	...
	const TCHAR* GetObjectName(bool localized) const override { return localized ? GetString(IDS_DB_GRID_OBJECT) : _T("Grid"); }
