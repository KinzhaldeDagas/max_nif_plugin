...
// exposetransform_info_blk version number. In Elwood and earlier, timeOffset was incorrectly
// scaled (Frames * TicksPerFrame * TicksPerFrame, rather than Frames * TicksPerFrame)
#define EXPOSETRANSFORM_INFO_BLK_VERSION 1
...
class ExposeTransform : public HelperObject,public TimeChangeCallback {
	public:
		...
		//custom edits
		static ICustEdit *localEulerXEdit;
		static ICustEdit *localEulerYEdit;
		static ICustEdit *localEulerZEdit;
		static ICustEdit *worldEulerXEdit;
		static ICustEdit *worldEulerYEdit;
		static ICustEdit *worldEulerZEdit;
		static ICustEdit *localPositionXEdit;
		static ICustEdit *localPositionYEdit;
		static ICustEdit *localPositionZEdit;
		static ICustEdit *worldPositionXEdit;
		static ICustEdit *worldPositionYEdit;
		static ICustEdit *worldPositionZEdit;
		static ICustEdit *boundingBoxWidthEdit;
		static ICustEdit *boundingBoxLengthEdit;
		static ICustEdit *boundingBoxHeightEdit;
		static ICustEdit *distanceEdit;
		static ICustEdit *angleEdit;

		//custom buttons
		static ICustButton *localEulerXButton;
		static ICustButton *localEulerYButton;
		static ICustButton *localEulerZButton;
		static ICustButton *worldEulerXButton;
		static ICustButton *worldEulerYButton;
		static ICustButton *worldEulerZButton;
		static ICustButton *localPositionXButton;
		static ICustButton *localPositionYButton;
		static ICustButton *localPositionZButton;
		static ICustButton *worldPositionXButton;
		static ICustButton *worldPositionYButton;
		static ICustButton *worldPositionZButton;
		static ICustButton *boundingBoxWidthButton;
		static ICustButton *boundingBoxLengthButton;
		static ICustButton *boundingBoxHeightButton;
		static ICustButton *distanceButton;
		static ICustButton *angleButton;
		...
		const TCHAR *GetObjectName(bool localized) const override {return localized ? GetString(IDS_EXPOSE_TRANSFORM_HELPER_NAME) : _T("ExposeTransformHelper");}
		...
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_CLASS_NAME) : _T("ExposeTm");}
		...
		{
			if (i == PBLOCK_EXPOSE)
				return localized ? GetString(IDS_EXPOSE_PARAMS) : _T("Expose");
			else if (i == PBLOCK_INFO)
				return localized ? GetString(IDS_INFO_PARAMS) : _T("Parameters");
			else if (i == PBLOCK_OUTPUT)
				return localized ? GetString(IDS_DISPLAY_EXPOSED) : _T("Display Exposed");
			else
				return localized ? GetString(IDS_DISPLAY_PARAMS) : _T("Display");
		}
...
private:
		...
		{	
			if(i==PBLOCK_EXPOSE)
				pblock_expose = (IParamBlock2*) rtarg; 
			else if (i==PBLOCK_INFO)
				pblock_info = (IParamBlock2*)rtarg;
			else if(i==PBLOCK_OUTPUT) 
				pblock_output = (IParamBlock2*) rtarg;
			else 
...
public:
		...
		INode *GetMyNode();
		void SetUpClipBoard(const TSTR &localName);
};
...
class ExposeTransformClassDesc : public ClassDesc2 {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("ExposeTm"); }
	SClass_ID		SuperClassID() { return HELPER_CLASS_ID; }
	Class_ID		ClassID() { return ExposeTransform_CLASS_ID; }
