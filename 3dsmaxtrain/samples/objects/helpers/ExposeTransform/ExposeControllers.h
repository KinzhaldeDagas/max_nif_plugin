...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_FLOATEXPOSECONTROL_CLASS_NAME) : _T("Expose Float Control");}
...
class FloatExposeControlClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Expose Float Control"); }
	SClass_ID		SuperClassID() { return CTRL_FLOAT_CLASS_ID; }
	Class_ID		ClassID() { return FloatExposeController_CLASS_ID; }
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_POINT3EXPOSECONTROL_CLASS_NAME) : _T("Expose Point3 Control");}
...
class Point3ExposeControlClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Expose Point3 Control"); }
	SClass_ID		SuperClassID() { return CTRL_POINT3_CLASS_ID; }
	Class_ID		ClassID() { return Point3ExposeController_CLASS_ID; }
	const TCHAR* 	Category() { return _T("");  }
	};
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_EULEREXPOSECONTROL_CLASS_NAME) : _T("Expose Euler Control");}
...
class EulerExposeControlClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Expose Euler Control"); }
	SClass_ID		SuperClassID() { return CTRL_ROTATION_CLASS_ID; }
	Class_ID		ClassID() { return EulerExposeController_CLASS_ID; }
	const TCHAR* 	Category() { return _T("");  }
	};
