...
public:
	...
	const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_RB_PRISM) : _T("Prism"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Prism"); }
...
static_assert(prism_params == PRISM_PARAMBLOCK_ID, "");
...
void FixSideLengths(IParamBlock2* pblock2, TimeValue t, ParamID side1, ParamID side2, ParamID side3, ParamID side_changing)
{
	...
	float a, b, c, ll, ul;
	pblock2->GetValue(side1, t, s1len);
	pblock2->GetValue(side2, t, s2len);
	pblock2->GetValue(side3, t, s3len);
...
static ParamBlockDesc2 prism_param_blk(prism_params, _T("PrismParameters"), 0, &PrismDesc, P_AUTO_CONSTRUCT + P_AUTO_UI, PBLOCK_REF_NO,
	...
	p_range, BMIN_LENGTH, BMAX_LENGTH,
	p_ui, TYPE_SPINNER, EDITTYPE_UNIVERSE, IDC_PR_SIDE1LEN, IDC_PR_SIDE1LENSPIN, SPIN_AUTOSCALE,
	p_nonLocalizedName, _T("Side 1 Length"),
	p_end,
	...
	p_range, BMIN_LENGTH, BMAX_LENGTH,
	p_ui, TYPE_SPINNER, EDITTYPE_UNIVERSE, IDC_PR_SIDE2LEN, IDC_PR_SIDE2LENSPIN, SPIN_AUTOSCALE,
	p_nonLocalizedName, _T("Side 2 Length"),
	p_end,
	...
	p_accessor, &prismSideLen_Accessor,
	p_ui, TYPE_SPINNER, EDITTYPE_UNIVERSE, IDC_PR_SIDE3LEN, IDC_PR_SIDE3LENSPIN, SPIN_AUTOSCALE,
	p_nonLocalizedName, _T("Side 3 Length"),
	p_end,
	...
	p_nonLocalizedName, _T("Side 1 Segments"),
	p_end,
	...
	p_nonLocalizedName, _T("Side 2 Segments"),
	p_end,
	...
	p_nonLocalizedName, _T("Side 3 Segments"),
	p_end,
...
{
	float side1;
	pblock2->GetValue(prism_side1, t, side1);
