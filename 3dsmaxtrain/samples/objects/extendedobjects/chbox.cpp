...
class ChBoxObject : public SimpleObject2, public RealWorldMapSizeInterface {
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_RB_CHNAME) : _T("ChamferBox"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("ChamferBox"); }
...
static_assert(chbox_params == CHBOX_PARAMBLOCK_ID, "");
