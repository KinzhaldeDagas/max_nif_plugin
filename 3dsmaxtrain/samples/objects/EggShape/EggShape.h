...
public:
	...
	virtual const TCHAR*	NonLocalizedClassName()				{ return _T("Egg"); }
...
class EggAccessor : public PBAccessor, public PBRescaleParamAccessor
{
public:
	EggAccessor() : PBAccessor(), PBRescaleParamAccessor() {}
	//void Get(PB2Value& v, ReferenceMaker* owner, ParamID id, int tabIndex, TimeValue t, Interval &valid);
	virtual void Set(PB2Value& v, ReferenceMaker* owner, ParamID id, int tabIndex, TimeValue t) override;	// Regular accessor method
	virtual void DeleteThis() override { delete this;}
	BaseInterface* GetInterface(Interface_ID id);	// Here to provide RescaleParams accessor (below) when necessary
	// Rescale accessor Set method...
	virtual void Set(PB2Value& v, float scaleFactor, ReferenceMaker* owner, ParamID id, int tabIndex, TimeValue t) override;
};
