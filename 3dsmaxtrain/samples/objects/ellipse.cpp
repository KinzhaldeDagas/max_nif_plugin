...
public:	
	...
	const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_TH_ELLIPSE) : _T("Ellipse"); }
	void InitNodeName(TSTR& s) { s = GetString(IDS_TH_ELLIPSE); }		
	Class_ID ClassID() { return Class_ID(ELLIPSE_CLASS_ID,0); }  
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_TH_ELLIPSE_CLASS) : _T("Ellipse"); }
...
public:
	...
	virtual const TCHAR*	NonLocalizedClassName() { return _T("Ellipse"); }
...
(
	...
	// The parameters specifications .... for each of the controls
	PB_LENGTH,	_T("length"),	TYPE_WORLD,	P_ANIMATABLE|P_RESET_DEFAULT,	IDS_RB_LENGTH,
		p_default, 			ELLISPE_LENGTH_DEFAULT, 
		p_ms_default,		25.f,
		p_range, 			MIN_LENGTH,	MAX_LENGTH, 
		p_ui, 				TYPE_SPINNER,	EDITTYPE_UNIVERSE,	IDC_LENGTHEDIT,	IDC_LENSPINNER,	SPIN_AUTOSCALE, 
		p_dim,				stdWorldDim,
		p_end,
	PB_WIDTH,	_T("width"),	TYPE_WORLD,	P_ANIMATABLE|P_RESET_DEFAULT,	IDS_RB_WIDTH,
		p_default, 			ELLISPE_WIDTH_DEFAULT, 
		p_ms_default,		35.f,
		p_range, 			MIN_WIDTH,	MAX_WIDTH, 
		p_ui, 				TYPE_SPINNER,	EDITTYPE_UNIVERSE,	IDC_WIDTHEDIT,	IDC_WIDTHSPINNER,	SPIN_AUTOSCALE, 
		p_dim,				stdWorldDim,
		p_end,
	PB_THICKNESS,	_T("ellipse_thickness"),	TYPE_WORLD,	P_ANIMATABLE|P_RESET_DEFAULT,	IDS_RB_THICKNESS,
		p_default, 			ELLISPE_THICKNESS_DEFAULT, 
	...
	PB_OUTLINE,	_T("ellipse_outline"), 	TYPE_BOOL,	P_ANIMATABLE|P_RESET_DEFAULT, 	IDS_RB_OUTLINE, 
		...
		p_ui, 				TYPE_SINGLECHECKBOX,		IDC_OUTLINE,
...
{
	theEllipseParamBlock.InvalidateUI(myParamBlock->LastNotifyParamID());
}
...
RefResult EllipseObject::NotifyRefChanged( const Interval& changeInt, RefTargetHandle hTarget, PartID& partID, RefMessage message, BOOL propagate) 
{
