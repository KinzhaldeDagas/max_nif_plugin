...
class TargetObject: public GeomObject{			   
	...
	public:
		...
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_DB_TARGET) : _T("Target"); }
		...
		void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_DB_TARGET_CLASS) : _T("Target"); }
