...
extern ClassDesc* GetRingDriverDesc();
extern ClassDesc* GetDrivenControlDesc();
...
extern void MakeMeshCapTexture(Mesh &mesh, const Matrix3 &itm, int fstart, int fend, BOOL usePhysUVs);
extern void MakeMeshCapTexture(Mesh &mesh, const Matrix3 &itm, BitArray& capFaces, BOOL usePhysUVs);
