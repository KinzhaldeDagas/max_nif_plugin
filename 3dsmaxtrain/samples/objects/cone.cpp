...
public:
	...
	const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_RB_CONE) : _T("Cone"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Cone"); }
...
static_assert(cone_params == CONE_PARAMBLOCK_ID, "");
...
static ParamBlockDesc2 cone_param_blk(cone_params, _T("ConeParameters"), 0, &coneDesc, P_AUTO_CONSTRUCT + P_AUTO_UI, PBLOCK_REF_NO,
	...
	cone_capsegs, _T("capsegs"), TYPE_INT, P_ANIMATABLE, IDS_RB_CAPSEGMENTS,
		...
		p_nonLocalizedName, _T("Cap Segments"),
		p_end,
...
BOOL ConeObject::OKtoDisplay(TimeValue t)
{
	...
	pblock2->GetValue(cone_radius1, t, radius1);
	pblock2->GetValue(cone_radius2, t, radius2);
