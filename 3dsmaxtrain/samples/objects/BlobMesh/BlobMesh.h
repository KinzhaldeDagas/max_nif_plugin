...
class BlobMesh : public SimpleObject2 , public IBlobMesh {
	friend class BlobMeshValidatorClass;
	friend class PickControlNode;
	friend class DumpHitDialog;
	public:
...
//		void RescaleWorldUnits(float f);
		...
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_CLASS_NAME) : _T("BlobMesh");}
...
class BlobMeshClassDesc:public ClassDesc2 {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("BlobMesh"); }
	SClass_ID		SuperClassID() { return GEOMOBJECT_CLASS_ID; }
	Class_ID		ClassID() { return BLOBMESH_CLASS_ID; }
