...
static ParamBlockDesc2 blobmesh_param_blk ( blobmesh_params, _T("params"),  0, &BlobMeshDesc, 
	...
	p_nonLocalizedName, _T("Viewport"),
	p_end,
	...
	p_nonLocalizedName, _T("Min Size"),
	p_end,
	...
	p_nonLocalizedName, _T("PF Event List"),
	p_end,
...
//From SimpleObject
const TCHAR* BlobMesh::GetObjectName(bool localized) const
{
	return localized ? GetString(IDS_CLASS_NAME_IMP) : _T("BlobMesh");
}
