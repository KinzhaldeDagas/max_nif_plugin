...
public:
	...
	//bitarray used to show the vertex visiblity state
	BitArray mVertVisible;
...
public:
	...
	//returns a bitarray that has the vertex visiblity state
	const BitArray& GetVertexVisibleData(int index);
