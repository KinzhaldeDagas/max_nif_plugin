...
TSTR PainterInterface::GetCfgFilename()
{
   TSTR filename(TheManager ? TheManager->GetDir(APP_PLUGCFG_DIR) : TSTR());
   ...
   filename.append(PAINTERINTERFACECONFIGNAME);
...
void PainterInterface::SaveWindowPos()
{
   ...
   str.printf_l(_T("%d"), GetCNumericLocale(), optionsWindowPos.rcNormalPosition.left);
   MaxSDK::Util::WritePrivateProfileString(WSDSECTION,WINDOWPOSX1,str,filename);
   str.printf_l(_T("%d"), GetCNumericLocale(), optionsWindowPos.rcNormalPosition.bottom);
   MaxSDK::Util::WritePrivateProfileString(WSDSECTION,WINDOWPOSY1,str,filename);
   str.printf_l(_T("%d"), GetCNumericLocale(), optionsWindowPos.rcNormalPosition.right);
   MaxSDK::Util::WritePrivateProfileString(WSDSECTION,WINDOWPOSX2,str,filename);
   str.printf_l(_T("%d"), GetCNumericLocale(), optionsWindowPos.rcNormalPosition.top);
...
void PainterInterface::LoadWindowPos()
{
   ...
   int full = 0;
   int res = MaxSDK::Util::GetPrivateProfileString(WSDSECTION,WINDOWPOSX1,  def,str,MAX_PATH,filename);
   if ((res) && (_tcscmp(str,def))) 
      {
      _stscanf_l(str,_T("%d"), GetCNumericLocale(), &optionsWindowPos.rcNormalPosition.left);
      full++;
      }
   res = MaxSDK::Util::GetPrivateProfileString(WSDSECTION,WINDOWPOSY1,  def,str,MAX_PATH,filename);
   if ((res) && (_tcscmp(str,def))) 
      {
	   _stscanf_l(str, _T("%d"), GetCNumericLocale(), &optionsWindowPos.rcNormalPosition.bottom);
      full++;
      }
   res = MaxSDK::Util::GetPrivateProfileString(WSDSECTION,WINDOWPOSX2,  def,str,MAX_PATH,filename);
   if ((res) && (_tcscmp(str,def))) 
      {  
	   _stscanf_l(str, _T("%d"), GetCNumericLocale(), &optionsWindowPos.rcNormalPosition.right);
      full++;
      }
   res = MaxSDK::Util::GetPrivateProfileString(WSDSECTION,WINDOWPOSY2,  def,str,MAX_PATH,filename);
   if ((res) && (_tcscmp(str,def))) 
      {
	   _stscanf_l(str, _T("%d"), GetCNumericLocale(), &optionsWindowPos.rcNormalPosition.top);
      full++;
      }
