...
class MSResourceMakerCallback : public ResourceMakerCallback, public ReferenceTarget
{
	...
	public:
		...
		virtual void GetClassName(MSTR& s, bool localized) const override { s = _M("MSResourceMakerCallback"); } // from Animatable
...
public:	
	ICurveCtl*	cctl;
	// Following provides proper lifetime control of the ICurveCtl instance. Don't want to create the SRM in
	// ctor since called from listener thread, not main thread.
	TypedSingleRefMaker<ICurveCtl> *cctlOwner; 
	HWND		hFrame;
