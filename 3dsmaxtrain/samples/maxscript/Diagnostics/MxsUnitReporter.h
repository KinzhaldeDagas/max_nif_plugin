...
public:
	...
	//! \param testing_for_equivalence - true if testing for equivalence of values, false if testing if values are not equal.
	//! \return - A nicely formatted string.
	static MSTR CreateMessage(const MCHAR* frame_name, const MCHAR* expected, const MCHAR* actual, const MCHAR* message, const MCHAR* fileName, unsigned int lineNumber, bool testing_for_equivalence);
