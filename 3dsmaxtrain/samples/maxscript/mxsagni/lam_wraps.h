...
def_struct_primitive_debug_ok	( isDebugBuild,			systemTools,	"isDebugBuild");
def_visible_primitive			( setFocus,				"setFocus");  
def_visible_primitive			( setForegroundWindow,	"setForegroundWindow");  
...
def_visible_primitive_debug_ok	( doesDirectoryExist,	"doesDirectoryExist");
...
def_visible_primitive_debug_ok	( getQtTextExtent,	"getQtTextExtent");


def_visible_primitive_debug_ok	( isValidNode,			"isValidNode");
def_visible_primitive_debug_ok	( isValidObj,			"isValidObj");
def_visible_primitive_debug_ok	( isValidValue,		"isValidValue");
...
def_visible_primitive_debug_ok	( getClassCounts,				"getClassCounts");
...
def_visible_primitive_debug_ok	( getImporterExporterExtensions,	"getImporterExporterExtensions");
...
def_visible_primitive_debug_ok	( getHandleByAnim,				"getHandleByAnim");
def_visible_primitive_debug_ok	( getAnimByHandle,				"getAnimByHandle");
def_visible_primitive_debug_ok	( getNumAnimatables,			"getNumAnimatables");
def_visible_primitive_debug_ok	( getNextAnimHandle,			"getNextAnimHandle");

def_visible_primitive_debug_ok	( getAnimPointer,				"getAnimPointer");
def_visible_primitive_debug_ok	( getAnimByPointer,				"getAnimByPointer");
...
def_struct_primitive			( getDecimalChars,			localeInfo, "getDecimalChars");

def_struct_primitive			( getLocale,				localeInfo, "getLocale");
def_struct_primitive			( setLocale,				localeInfo, "setLocale");
def_struct_primitive			( getCPlusPlusLocale,		localeInfo, "getCPlusPlusLocale");
def_struct_primitive			( setCPlusPlusLocale,		localeInfo, "setCPlusPlusLocale");

def_struct_primitive			( getPerThreadLocale,		localeInfo, "getPerThreadLocale");
def_struct_primitive			( setPerThreadLocale,		localeInfo, "setPerThreadLocale");
...
def_struct_primitive_debug_ok	( meshop_getFacesByMatId,			meshop, "getFacesByMatId");
def_struct_primitive_debug_ok	( meshop_getVertsByMatId,			meshop, "getVertsByMatId");
def_struct_primitive_debug_ok	( meshop_getAllFaces,				meshop, "getAllFaces");
def_struct_primitive_debug_ok	( meshop_getFaceMatId,				meshop, "getFaceMatId");
def_struct_primitive_debug_ok	( meshop_getFacesMatId,				meshop, "getFacesMatId");
def_struct_primitive			( meshop_setFaceMatId,				meshop, "setFaceMatId");
...
def_struct_primitive_debug_ok	( meshop_getVerts,					meshop, "getVerts");
...
def_struct_primitive_debug_ok	( meshop_getFace,					meshop, "getFace");
def_struct_primitive_debug_ok	( meshop_getFaces,					meshop, "getFaces");
...
def_struct_primitive_debug_ok	(meshop_getNumVelocity,				meshop, "getNumVelocity");
def_struct_primitive_debug_ok	(meshop_getVelocity,				meshop, "getVelocity");
...
def_struct_primitive_debug_ok(polyop_getVertsByMatId, polyop, "getVertsByMatId");
...
def_struct_primitive_debug_ok	( polyop_getEdgesVerts,				polyop,	"getEdgesVerts");
def_struct_primitive_debug_ok	( polyop_getEdgesFaces,				polyop,	"getEdgesFaces");
...
def_struct_primitive_debug_ok	( polyop_getFacesVerts,				polyop,	"getFacesVerts");
def_struct_primitive_debug_ok	( polyop_getFacesEdges,				polyop,	"getFacesEdges");
...
def_struct_primitive_debug_ok   ( polyop_getFacesByMatId,           polyop, "getFacesByMatId");
def_struct_primitive_debug_ok   ( polyop_getAllFaces,               polyop, "getAllFaces");
...
def_struct_primitive_debug_ok	( polyop_getVerts,					polyop, "getVerts");
...
def_struct_primitive_debug_ok	( polyop_getFacesMatID,				polyop, "getFacesMatID");
...
def_struct_primitive_debug_ok	( polyop_checkTriangulation,		polyop, "checkTriangulation");
...
def_struct_primitive_debug_ok	( logsys_logName,			logsystem,	"logName");
def_struct_primitive_debug_ok	( logsys_saveState,			logsystem,	"saveState");
def_struct_primitive_debug_ok	( logsys_loadState,			logsystem,	"loadState");

def_struct_primitive_debug_ok	( logsys_setLogLevel,		logsystem,	"setLogLevel");
def_struct_primitive_debug_ok	( logsys_getLogLevel,		logsystem,	"getLogLevel");
def_struct_primitive_debug_ok	( logsys_getLogName,		logsystem,	"getLogName");
...
def_visible_primitive_debug_ok	( isParticleSystem,											"isParticleSystem");
def_visible_primitive_debug_ok	( isWorldSpaceObject,										"isWorldSpaceObject");
...
def_visible_primitive_debug_ok	( timeGetTime, 						"timeGetTime");

def_visible_primitive_debug_ok	( isUsedInScene, 					"isUsedInScene");
def_visible_primitive_debug_ok	( isMtlUsedInSceneMtl, 				"isMtlUsedInSceneMtl");
def_visible_primitive_debug_ok	( UpdateSceneMaterialLib,			"UpdateSceneMaterialLib");

def_visible_primitive_debug_ok	( ValidateSingleRefMaker,			"ValidateSingleRefMaker");
def_visible_primitive_debug_ok	( ValidateReferenceMakerRefs,		"ValidateReferenceMakerRefs");
def_visible_primitive_debug_ok	( ValidateGetRenderMeshNeedDelArg,	"ValidateGetRenderMeshNeedDelArg");
def_visible_primitive_debug_ok	( get_maxclass, 					"getMAXClass");

def_visible_primitive_debug_ok	( ParamTypeToTypeName, 				"paramTypeToTypeName");
def_visible_primitive_debug_ok	( TypeNameToParamType, 				"typeNameToParamType");
