...
def_struct_primitive_debug_ok	( VP_GetViewNumEx,					viewport,		"NumViewEx");
def_struct_primitive			( VP_SetActiveViewportEx,			viewport,		"ActiveViewportEx");
def_struct_primitive_debug_ok	( VP_EnableSolidBackgroundColorMode,	viewport,	"EnableSolidBackgroundColorMode");
def_struct_primitive_debug_ok	( VP_IsSolidBackgroundColorMode,	viewport,		"IsSolidBackgroundColorMode"); 

// Elvic: Added these
def_struct_primitive_debug_ok	( VP_IsCanvasNavigationMode,		viewport,		"IsCanvasNavigationMode");
def_struct_primitive_debug_ok	( VP_SetCanvasNavigationMode,		viewport,		"SetCanvasNavigationMode");

def_struct_primitive_debug_ok	(VP_AppendTooltip,					viewport,		"AppendTooltip");

def_struct_primitive_debug_ok	( VP_GetHWnd,		viewport,		"getHWnd");

def_struct_primitive_debug_ok	( VP_SetInPresentationMode,		viewport,		"SetInPresentationMode");
def_struct_primitive_debug_ok	( VP_IsInPresentationMode,		viewport,		"IsInPresentationMode");

def_struct_primitive_debug_ok	( VP_getViewportFromScreenCoord,	viewport,	"getViewportFromScreenCoord");
