...
define_system_global (_T("preserveStackPosition"),  get_preserveStackPosition,  set_preserveStackPosition);
...
define_struct_global ( _T("EnableOptimizeDependentNotifications")	, _T("preferences"),	get_EnableOptimizeDependentNotifications, set_EnableOptimizeDependentNotifications);
define_struct_global ( _T("EnableTMCache")			, _T("preferences"),		get_EnableTMCache,	  set_EnableTMCache);
define_struct_global ( _T("ControllerIntervalOptimization"), _T("preferences"), get_ControllerIntervalOptimization, set_ControllerIntervalOptimization);
define_struct_global (_T("playPreviewWhenDone"),	 _T("preferences"),			get_playPreviewWhenDone, set_playPreviewWhenDone);


define_struct_global ( _T("InvalidateTMOpt")	, _T("preferences"),	get_InvalidateTMOpt, set_InvalidateTMOpt);

define_struct_global ( _T("autoKeyDefaultKeyOn")	,	_T("preferences"),		get_autoKeyDefaultKeyOn, set_autoKeyDefaultKeyOn);
define_struct_global ( _T("autoKeyDefaultKeyTime")	, _T("preferences"),		get_autoKeyDefaultKeyTime, set_autoKeyDefaultKeyTime);
...
// Log System
define_struct_global ( _T("quietMode"),				_T("logsystem"),			get_logsys_quiet_mode,		set_logsys_quiet_mode);
define_struct_global ( _T("longevity"),				_T("logsystem"),			get_logsys_longevity,		set_logsys_longevity);
define_struct_global ( _T("logDays"),				_T("logsystem"),			get_logsys_logDays,			set_logsys_logDays);
define_struct_global ( _T("logSize"),				_T("logsystem"),			get_logsys_logSize,			set_logsys_logSize);
define_struct_global ( _T("enabled"),				_T("logsystem"),			get_logsys_enabled_mode,	set_logsys_enabled_mode);
