...
def_visible_primitive_debug_ok  ( ConvertIntToDirID, 		"ConvertIntToDirID");
...
def_visible_primitive_debug_ok	( GetDriverController,		"GetDriverController");
...
def_visible_primitive_debug_ok	( IsNetworkRenderServer, 	"IsNetworkRenderServer");
...
def_visible_primitive_debug_ok	( getMAXFileFileProperties, 	"getMAXFileFileProperties");
def_visible_primitive			( clearMAXFilePersonalInfo, 	"clearMAXFilePersonalInfo");
