...
public:
	...
	virtual IMemStream* OpenFile( const TCHAR *fname, unsigned int favor_type = FAVOR_ACP, int code_page = CP_ACP ) = 0;
...
inline bool IsSpace(const MaxSDK::Util::Char& c) { return c.IsInCharacterSet(whitespace) != NULL; }
inline bool IsNewline(const MaxSDK::Util::Char& c) { return (c==_T('\n')||c==_T('\r')); }
