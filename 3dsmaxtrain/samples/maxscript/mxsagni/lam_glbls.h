...
define_struct_global (_T("posUnscaled"),	_T("mouse"),	getMouseMAXPosUnscaled,			NULL);
define_struct_global (_T("screenpos"),		_T("mouse"),	getMouseScreenPos,		NULL);
define_struct_global (_T("screenposUnscaled"),	_T("mouse"),	getMouseScreenPosUnscaled,		NULL);
...
define_struct_global (_T("nonrenderables"),	_T("hideByCategory"), getHideByCategory_nonrenderables, setHideByCategory_nonrenderables);
...
define_struct_global (_T("screenHitPointUnscaled"),		_T("snapMode"),	getScreenHitpointUnscaled,	setScreenHitpointUnscaled);
...
define_struct_global(_T("angle"),				_T("snapMode"), getSnapAngle,	setSnapAngle);
define_struct_global(_T("percent"),				_T("snapMode"), getSnapPercent,	setSnapPercent);
define_struct_global(_T("shapeAngleConstraintEnabled"),		_T("snapMode"), getSnapShapeAngleConstraintEnabled,	setSnapShapeAngleConstraintEnabled);
define_struct_global(_T("shapeAngleConstraintValue"),		_T("snapMode"), getSnapShapeAngleConstraintValue,	setSnapShapeAngleConstraintValue);

define_struct_global(_T("active"),				_T("snapMode"), getSnapAactive,		setSnapAactive);
define_struct_global(_T("type"),				_T("snapMode"), getSnapType,		setSnapType);

define_struct_global(_T("angleSnapActive"),		_T("snapMode"), getAngleSnapActive,		setAngleSnapActive);
define_struct_global(_T("percentSnapActive"),	_T("snapMode"), getPercentSnapActive,	setPercentSnapActive);
...
define_struct_global ( _T("sceneIODebugEnabled"), _T("systemTools"),		systemTools_GetSceneIODebugEnabled, systemTools_SetSceneIODebugEnabled);
