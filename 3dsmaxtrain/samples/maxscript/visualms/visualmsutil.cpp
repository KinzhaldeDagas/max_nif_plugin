...
const TCHAR* CVisualMSClassDesc::ClassName() 
{ 
	static TSTR className (MaxSDK::GetResourceStringAsMSTR(IDS_CLASS_NAME)); 
	return className; 
}

const TCHAR* CVisualMSClassDesc::NonLocalizedClassName()
{
	return _T("Visual MAXScript");
}

const TCHAR* CVisualMSClassDesc::Category() 
{ 
	static TSTR category (MaxSDK::GetResourceStringAsMSTR(IDS_CATEGORY)); 
	return category; 
}
