...
public:
	...
	IVisualMSForm* CreateFormFromFile(const TCHAR* fname);	// create form from a .vms file
...
void 
VisualMSForm::Open(IVisualMSCallback* cb, const TCHAR* source)	// open the form editor on the form
{
...
void 
VisualMSForm::InitForm(const TCHAR* formType, const TCHAR* formName, const TCHAR* caption)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
IVisualMSItem* 
VisualMSForm::AddItem(const TCHAR* itemType, const TCHAR* itemName, const TCHAR* text, int src_from, int src_to)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
IVisualMSItem* 
VisualMSForm::FindItem(const TCHAR* itemName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
IVisualMSItem* 
VisualMSForm::AddCode(const TCHAR* code, int src_from, int src_to)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
BOOL 
VisualMSForm::GenScript(TSTR& script, const TCHAR* indent)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
IVisualMSForm* 
VisualMSMgr::CreateFormFromFile(const TCHAR* fname)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
