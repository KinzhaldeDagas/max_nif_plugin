...
public:
	...
	CArray <CProperty, const CProperty&> m_properties;

	// Array of all event handlers in the object.
	CArray <CHandler, const CHandler&> m_handlers;
	...
	int FindProperty(const TCHAR* propName);
	int FindHandler(const TCHAR* eventName);
	...
	void SetPropery(const TCHAR* propName, float f);
	void SetPropery(const TCHAR* propName, int i);
	void SetPropery(const TCHAR* propName, bool i);
	void SetPropery(const TCHAR* propName, const TCHAR* s);
	void SetProperyLit(const TCHAR* propName, const TCHAR* s);
	void SetPropery(const TCHAR* propName, Point2 pt);
	void SetPropery(const TCHAR* propName, Tab<const TCHAR*>* sa);
	void SetPropery(const TCHAR* propName, Point3 pt);
	void GetShape(int& left, int& top, int& width, int& height);
	void SetShape(int left, int top, int width, int height);

	void SetHandler(const TCHAR* eventName, const TCHAR* source, int arg_start, int arg_end, int body_start, int body_end);
	void AddComment(const TCHAR* code, int src_from, int src_to);
