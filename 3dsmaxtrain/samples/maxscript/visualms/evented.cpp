...
BOOL CEventEd::OnInitDialog() 
{
	...
	DLGetTextExtent(dc, _T("01235678901234567890123456789012345678901234567890"), 4, &size); 
...
void CEventEd::OnClose() 
{
	...
	{
		int res = MaxSDK::MaxMessageBox(GetSafeHwnd(), MaxSDK::GetResourceStringAsMSTR(IDS_SAVE_CHANGES_TO_EVENT), NULL, MB_YESNOCANCEL | MB_ICONEXCLAMATION);
		switch(res)
		{
		case IDYES:
			OnOK();
