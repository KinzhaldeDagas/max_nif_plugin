...
#define frameWndAtomID _T("__FRAMEWND_ATOM_ID__")
...
public:
	...
	virtual void PressCtrlButton(UINT nID);
...
// ============================================================================
// CMainCAFrame - Main window frame class used for Custom Attributes.
// ----------------------------------------------------------------------------
class CMainCAFrame : public CMainFrame
{
protected:
	DECLARE_DYNCREATE(CMainCAFrame)

// Implementation
public:
	CMainCAFrame();
	virtual ~CMainCAFrame();
