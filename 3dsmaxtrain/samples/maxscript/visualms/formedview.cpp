...
// ============================================================================
IMPLEMENT_DYNCREATE(CFormEdCAView, CFormEdView)
BEGIN_MESSAGE_MAP(CFormEdCAView, CFormEdView)
	//{{AFX_MSG_MAP(CFormEdView)
	ON_WM_PAINT()
	ON_WM_LBUTTONDOWN()
	ON_WM_MOUSEMOVE()
...
// ============================================================================
CFormEdCAView::CFormEdCAView() {}
CFormEdCAView::~CFormEdCAView() {}

// ============================================================================
void CFormEdCAView::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp)
{
	CScrollView::OnNcCalcSize(bCalcValidRects, lpncsp);
}

// ============================================================================
void CFormEdCAView::OnNcPaint()
{
	CScrollView::OnNcPaint();
}

// ============================================================================
void CFormEdCAView::OnPaint()
{
	CPaintDC dc(this);
	CGuiObj *pObj = GetDocument()->GetObj(0);
	if(pObj)
