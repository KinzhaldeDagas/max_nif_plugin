   ...
   : CSingleDocTemplate(nIDResource, pDocClass, pFrameClass, pViewClass)
{
	...
	// tell CVisualMSDoc whether it is used for Custom Attributes
	m_pThread->m_pMainDoc->SetUseCA(useCA);
...
{
	MaxSDK::Util::UseLanguagePackLocale(nullptr);
...
// ============================================================================
IMPLEMENT_DYNCREATE(CVisualMSCAThread, CVisualMSThread)
	BEGIN_MESSAGE_MAP(CVisualMSCAThread, CVisualMSThread)
		//{{AFX_MSG_MAP(CVisualMSThread)
		//}}AFX_MSG_MAP
	END_MESSAGE_MAP()

// ============================================================================
CVisualMSCAThread* CVisualMSCAThread::Create(bool bVisible)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	CVisualMSCAThread *pThread = (CVisualMSCAThread*)AfxBeginThread(RUNTIME_CLASS(CVisualMSCAThread));
...
// ============================================================================
CVisualMSCAThread::CVisualMSCAThread()
{
}
...
// ============================================================================
BOOL CVisualMSCAThread::InitInstance()
{
	MaxSDK::Util::UseLanguagePackLocale(nullptr);
	m_pDocTemplate = new CVMSDocTemplate(
		IDR_CATOOLS,
		RUNTIME_CLASS(CVisualMSDoc),
		RUNTIME_CLASS(CMainCAFrame),
		RUNTIME_CLASS(CFormEdCAView),
		this,
		true);
...
// ============================================================================
int CVisualMSCAThread::ExitInstance()
{
	theDLL.RemoveThread(this);
	m_threadExit.SetEvent();
	delete m_pDocTemplate;
