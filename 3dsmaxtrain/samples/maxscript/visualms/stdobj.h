...
public:
	...
	virtual void Emit(CString &out);
	virtual int  OnPropChange(int idx);
	virtual void SetPropery(const TCHAR* propName, int i);
	virtual void SetShape(int left, int top, int width, int height);
	virtual void GetShape(int& left, int& top, int& width, int& height);
};
