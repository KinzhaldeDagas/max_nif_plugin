...
#include "GuiObj.h"
#include "FormEd.h"
#include "../../../samples/Include/IVisualMxsEditor.h"
...
public:
	...
	CFormObj* GetFormObj();
	int ItemIDFromName(const TCHAR* itemName);
	...
	// script generation
	bool GenScript(CString& script, const TCHAR* indent = NULL);
	bool CheckScriptLinkage();
	void GetDataForParamEditor(MaxSDK::Array<UIData4ParamEditor> &uiDatas, CString &addSource, const FPValue* fpv);
...
protected:
	...
	afx_msg void OnRenameCaptionSettings();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
