...
// chain_plane_angle_at shoulder is the angle made by the ee-axis and the upper_arm 
		...
		void GetClassName(MSTR& s) const override {s = GetString(IDS_CLASS_NAME);}
...
class IKLimbClassDesc : public ClassDesc2 {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("IKLimb"); }
	SClass_ID		SuperClassID() {return IK_SOLVER_CLASS_ID;}
	Class_ID		ClassID() {return IKLIMB_CLASS_ID;}
	const TCHAR* 	Category() {return _T(""); }
	const TCHAR*	InternalName() { return _T("IKLimb"); }// returns fixed parsable name (scripter-visible name)
