...
class StdMtl: public StdMat {
	...
	public:
		...
		BOOL KeyAtTimeByID(int id,TimeValue t) { return pblock->KeyFrameAtTime(id,t); }
		...
		int SubTexmapOn(int i) { return (i >= 0 && i < MAX_TEXTURE_CHANNELS) ? (*maps)[i].IsActive() : 0; }

		Class_ID ClassID();
		SClass_ID SuperClassID() { return MATERIAL_CLASS_ID; }
		void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_DS_STANDARD) : _T("R2.5 Standard"); }  
