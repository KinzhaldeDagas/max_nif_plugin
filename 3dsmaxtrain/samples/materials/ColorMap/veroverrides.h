...
#define MAXVER_INTERNALNAME "colormap\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "colormap.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Color Map texmap (plugin)\0"//should  be overidden on a per-dll level
