...
class PartAgeTex : public Texmap { 
	public:
		...
		void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_RB_PARTICLEAGE) : _T("Particle Age"); } // mjm - 2.3.99
...
class PartAgeTexClassDesc:public ClassDesc2 {
	...
	const TCHAR*	ClassName() { return GetString(IDS_RB_PARTICLEAGE_CDESC); }
	const TCHAR*	NonLocalizedClassName() { return _T("Particle Age"); }
	SClass_ID		SuperClassID() {return TEXMAP_CLASS_ID;}
	Class_ID 		ClassID() {return PARTAGE_CLASSID;}
...
static ParamBlockDesc2 page_param_blk ( page_params, _T("parameters"),  0, &partAgeCD, P_AUTO_CONSTRUCT + P_AUTO_UI, 0, 
	...
	page_map1_on,	_T("map1Enabled"), TYPE_BOOL,			0,				IDS_JW_MAP1ENABLE,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHECKBOX, IDC_PARTAGE_USEMAP1,
		p_end,
	page_map2_on,	_T("map2Enabled"), TYPE_BOOL,			0,				IDS_JW_MAP2ENABLE,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHECKBOX, IDC_PARTAGE_USEMAP2,
		p_end,
	page_map3_on,	_T("map3Enabled"), TYPE_BOOL,			0,				IDS_JW_MAP3ENABLE,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHECKBOX, IDC_PARTAGE_USEMAP3,
		p_end,
...
static ParamUIDesc descParam[] = {
	...
	// Use Map 1
	ParamUIDesc(PB_USEMAP1,TYPE_SINGLECHECKBOX,IDC_PARTAGE_USEMAP1),

	// Use Map 2
	ParamUIDesc(PB_USEMAP2,TYPE_SINGLECHECKBOX,IDC_PARTAGE_USEMAP2),

	// Use Map 3
	ParamUIDesc(PB_USEMAP3,TYPE_SINGLECHECKBOX,IDC_PARTAGE_USEMAP3),
...
ParamDlg* PartAgeTex::CreateParamDlg(HWND hwMtlEdit, IMtlParams *imp)
	{
	IAutoMParamDlg* dlg = partAgeCD.CreateParamDlgs(hwMtlEdit, imp, this);
...
TSTR PartAgeTex::GetSubTexmapSlotName(int i, bool localized)
{
	switch (i)
	{
...
TSTR PartAgeTex::SubAnimName(int i, bool localized)
{
	switch (i)
	{
	case 0: return localized ? GetString(IDS_DS_PARAMETERS) : _T("Parameters");
	case 1: return localized ? GetString(IDS_DS_OUTPUT) : _T("Output");
...
/*
		...
		case REFMSG_GET_PARAM_NAME_NONLOCALIZED: {
			GetParamName *gpn = (GetParamName*)partID;
			switch (gpn->index) {
				case PB_COL1: gpn->name = _T("Color 1");   break;
				case PB_COL2: gpn->name = _T("Color 2");   break;
				case PB_COL3: gpn->name = _T("Color 3");   break;
				case PB_AGE1: gpn->name = _T("Age 1");     break;
				case PB_AGE2: gpn->name = _T("Age 2");     break;
				case PB_AGE3: gpn->name = _T("Age 3");     break;
				default:      gpn->name = _T("Parameter"); break;
				}
			return REF_STOP;
			}
