...
//		int seed;
		...
		void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_DS_DENT) : _T("Dent"); }
...
class DentClassDesc:public ClassDesc2 
{
	...
	const TCHAR*	ClassName() { return GetString(IDS_DS_DENT_CDESC); }
	const TCHAR*	NonLocalizedClassName() { return _T("Dent"); }
	SClass_ID		SuperClassID() { return TEXMAP_CLASS_ID; }
	Class_ID 		ClassID();
