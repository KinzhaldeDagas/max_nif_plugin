...
static      Class_ID       dentClassID(DENT_CLASS_ID);
...
ParamDlg* Dent::CreateParamDlg(HWND hwMtlEdit, IMtlParams *imp) 
{
   ...
   IAutoMParamDlg* dlg = dentCD.CreateParamDlgs(hwMtlEdit, imp, this);
...
void Dent::ReadSXPData(const TCHAR *name, void *sxpdata) 
{
...
TSTR Dent::GetSubTexmapSlotName(int i, bool localized)
{
	switch (i)
	{
...
TSTR Dent::SubAnimName(int i, bool localized)
{
	switch (i)
	{
...
RefResult Dent::NotifyRefChanged(   const Interval& changeInt, RefTargetHandle hTarget, 
