...
#define MAXVER_INTERNALNAME "materialswitcher\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "materialswitcher.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Material Switcher (plugin)\0"//should  be overidden on a per-dll level
