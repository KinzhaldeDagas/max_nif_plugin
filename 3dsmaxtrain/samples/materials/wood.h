...
{ 
	...
	public:
		...
		void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_DS_WOOD) : _T("Wood"); }
...
class WoodClassDesc:public ClassDesc2 
{
	...
	const TCHAR*	ClassName() { return GetString(IDS_DS_WOOD_CDESC); }
	const TCHAR*	NonLocalizedClassName() { return _T("Wood"); }
	SClass_ID		SuperClassID() { return TEXMAP_CLASS_ID; }
	Class_ID 		ClassID();
