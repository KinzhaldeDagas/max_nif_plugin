...
class AVCClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Vertex Colors"); }
...
void ApplyVCMod::GetClassName(MSTR& s, bool localized) const
{
	s= localized ? GetString(IDS_AVCM_CNAME) : _T("Vertex Colors");
}
...
const TCHAR* ApplyVCMod::GetObjectName(bool localized) const
{
	return localized ? GetString(IDS_AVCM_ONAME) : _T("Vertex Colors");
}
...
TSTR ApplyVCMod::SubAnimName(int i, bool localized)
{
	return _T("");
}
