...
class TreeViewUtil : public UtilityObj {
	public:
		...
		void NameChannel(INode *node, int channelType, int channel, int subChannel, const TCHAR *name);
...
class MapChannelDelete : public Modifier {
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_MAPCHANNELDELETENAME) : _T("UVW Mapping Clear"); }
		...
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_MAPCHANNELDELETENAME) : _T("UVW Mapping Clear");}
...
class MapChannelPaste : public Modifier {
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_MAPCHANNELPASTENAME) : _T("UVW Mapping Paste"); }

		//From Modifier
		ChannelMask ChannelsUsed()  { return GEOM_CHANNEL|TOPO_CHANNEL|SELECT_CHANNEL|SUBSEL_TYPE_CHANNEL|VERTCOLOR_CHANNEL|TEXMAP_CHANNEL; }
		//TODO: Add the channels that the modifier actually modifies
		ChannelMask ChannelsChanged() { return GEOM_CHANNEL|TOPO_CHANNEL|TEXMAP_CHANNEL|VERTCOLOR_CHANNEL|SELECT_CHANNEL|SUBSEL_TYPE_CHANNEL; }
		//TODO: Return the ClassID of the object that the modifier can modify
		Class_ID InputType() {return defObjectClassID;}
		...
		SClass_ID SuperClassID() { return OSM_CLASS_ID; }
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_MAPCHANNELPASTENAME) : _T("UVW Mapping Paste");}
...
class MapChannelAdd : public Modifier {
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_MAPCHANNELADDNAME) : _T("UVW Mapping Add"); }
		...
		SClass_ID SuperClassID() { return OSM_CLASS_ID; }
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_MAPCHANNELADDNAME) : _T("UVW Mapping Add");}
...
class SelectByChannel : public Modifier {
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_SELECTBYCHANNELNAME) : _T("Select By Channel"); }

		//From Modifier
		ChannelMask ChannelsUsed()  { return GEOM_CHANNEL|TOPO_CHANNEL|SELECT_CHANNEL|SUBSEL_TYPE_CHANNEL; }
		//TODO: Add the channels that the modifier actually modifies
		ChannelMask ChannelsChanged() { return GEOM_CHANNEL|TOPO_CHANNEL|SELECT_CHANNEL|SUBSEL_TYPE_CHANNEL; }
		//TODO: Return the ClassID of the object that the modifier can modify
		Class_ID InputType() {return defObjectClassID;}
		...
		SClass_ID SuperClassID() { return OSM_CLASS_ID; }
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_SELECTBYCHANNELNAME) : _T("Select By Channel");}
