...
class SelectByChannelClassDesc:public ClassDesc2 {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Select By Channel"); }
...
INT_PTR SelectByChannelDlgProc::DlgProc(
...
void SelectByChannel::NotifyInputChanged(const Interval& changeInt, PartID partID, RefMessage message, ModContext *mc)
{
