...
#define MAXVER_INTERNALNAME "CustomFileStreamAPI\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CustomFileStreamAPI.dll\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "CustomFileStreamAPI dll\0"//should  be overidden on a per-dll level
