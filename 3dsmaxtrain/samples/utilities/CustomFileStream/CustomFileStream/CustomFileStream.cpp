...
static CustomFileStream sCustomSceneStream(CUSTOMFILESTREAM_INTERFACE, _T("CustomFileStream"), 0, NULL, FP_CORE,
	...
	CustomFileStream::kIsCustomFileStreamOperable, _T("isCustomFileStreamOperable"), 0, TYPE_bool, FP_NO_REDRAW, 2,
		_T("fileName"), 0, TYPE_FILENAME,
		_T("streamName"), 0, TYPE_STRING,
	CustomFileStream::kDeleteStream, _T("deleteStream"), 0, TYPE_bool, FP_NO_REDRAW | FP_EMBEDDEDSCRIPTSECURITYFEATURE, MaxSDK::ISceneScriptSecurityManager::ScriptingFeature::MAXScriptSystemCommands, 2,
		_T("fileName"), 0, TYPE_FILENAME,
		_T("streamName"), 0, TYPE_STRING,
	CustomFileStream::kReadStream, _T("readStream"), 0, TYPE_TSTR_BV, FP_NO_REDRAW, 2,
		_T("fileName"), 0, TYPE_FILENAME,
		_T("streamName"), 0, TYPE_STRING,
	CustomFileStream::kWriteStream, _T("writeStream"), 0, TYPE_bool, FP_NO_REDRAW | FP_EMBEDDEDSCRIPTSECURITYFEATURE, MaxSDK::ISceneScriptSecurityManager::ScriptingFeature::MAXScriptSystemCommands, 6,
		_T("fileName"), 0, TYPE_FILENAME,
		_T("streamName"), 0, TYPE_STRING,
	...
	CustomFileStream::kReadStreamArray, _T("readStreamArray"), 0, TYPE_TSTR_TAB_BV, FP_NO_REDRAW, 2,
		_T("fileName"), 0, TYPE_FILENAME,
		_T("streamName"), 0, TYPE_STRING,
	CustomFileStream::kWriteStreamArray, _T("writeStreamArray"), 0, TYPE_bool, FP_NO_REDRAW | FP_EMBEDDEDSCRIPTSECURITYFEATURE, MaxSDK::ISceneScriptSecurityManager::ScriptingFeature::MAXScriptSystemCommands, 6,
		_T("fileName"), 0, TYPE_FILENAME,
		_T("streamName"), 0, TYPE_STRING,
	...
	CustomFileStream::kSetStreamFlags, _T("setStreamFlags"), 0, TYPE_bool, FP_NO_REDRAW | FP_EMBEDDEDSCRIPTSECURITYFEATURE, MaxSDK::ISceneScriptSecurityManager::ScriptingFeature::MAXScriptSystemCommands, 4,
		_T("fileName"), 0, TYPE_FILENAME,
		_T("streamName"), 0, TYPE_STRING,
