...
#define MAXVER_INTERNALNAME "CustomFileStream\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CustomFileStream.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "CustomFileStream plugin\0"//should  be overidden on a per-dll level
