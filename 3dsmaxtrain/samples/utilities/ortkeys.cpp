...
class ORTKeysUtil : public TrackViewUtility {
   public:
      ...
      void     GetClassName(MSTR& s) const { s = ORT_KEYS_NAME; }
...
class ORTKeysClassDesc:public ClassDesc {
   ...
   const TCHAR*  NonLocalizedClassName() { return _T("Create Out of Range Keys"); }
...
static INT_PTR CALLBACK ORTKeysDlgProc(
   ...
   {
   ORTKeysUtil *util = DLGetWindowLongPtr<ORTKeysUtil*>(hWnd);
