...
class RandKeysUtil : public TrackViewUtility {
   public:
      ...
      void     GetClassName(MSTR& s) const { s = RAND_KEYS_NAME; }
...
class RandKeysClassDesc:public ClassDesc {
   ...
   const TCHAR*  NonLocalizedClassName() { return _T("Randomize Keys"); }
...
static INT_PTR CALLBACK RandKeysDlgProc(
   ...
   {
   RandKeysUtil *util = DLGetWindowLongPtr<RandKeysUtil*>(hWnd);
