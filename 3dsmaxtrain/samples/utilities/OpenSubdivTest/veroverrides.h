...
#define MAXVER_INTERNALNAME "OSDInterfaceTest\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "OSDInterfaceTest.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "OpenSubdiv Interface Test Sample\0"//should  be overidden on a per-dll level
