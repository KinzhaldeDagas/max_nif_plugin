...
#define APPDATA_TEST_CLASS_ID		Class_ID(0xf6277abd,0)
...
extern void AppDataTest_UpdateAppDataLoadProc(Animatable *anim, const Class_ID& cid, SClass_ID sid, ILoad* iload, Tab<DWORD> &subIDs);
