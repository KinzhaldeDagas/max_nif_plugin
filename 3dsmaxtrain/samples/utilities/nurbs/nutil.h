...
public:
	...
	BOOL mRelational;
	BOOL mAsCurve;
	MaxSDK::Util::TextFile::Writer *mFP;

	APITestUtil() { mRelational = TRUE; mAsCurve = FALSE; mToFile = FALSE; mFP = NULL; _stprintf(mFilename, _T("testdump.txt")); }
	...
	void DumpMatrix3(int indent, const Matrix3& mat);
