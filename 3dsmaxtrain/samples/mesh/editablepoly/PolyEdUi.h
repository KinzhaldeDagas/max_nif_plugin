...
template <class BasePolyMode, class SelectionProcessor, class ModBoxType>
class DoubleClickModeDecorator : public BasePolyMode
{
private:
...
template <class BasePolyMode, class SelectionProcessor>
class DoubleClickModeDecorator<BasePolyMode, SelectionProcessor, SelectModBox> : public BasePolyMode
{
private:
	SelectionProcessor selProc;
