...
#define CHAMFER_VERTICES_SEGMENTS_PNG    _T("Segments.png")
#define CHAMFER_VERTICES_DEPTH_PNG    _T("Tension.png")
#define CHAMFER_VERTICES_SMOOTH_PNG    _T("EdgeChamferSmooth.png")
#define CHAMFER_VERTICES_SMOOTH_THRESHOLD_PNG    _T("EdgeChamferSmoothThreshold.png")
#define CHAMFER_VERTICES_SMOOTH_ALL_PNG    _T("EdgeChamferSmoothAll.png")
#define CHAMFER_VERTICES_SMOOTH_CHAMFERS_PNG    _T("EdgeChamferSmoothChamfers.png")
...
#define CHAMFER_EDGE_MITERING_TRI_PNG   _T("ChamferTri.png")
#define CHAMFER_EDGE_MITERING_QUAD_PNG   _T("ChamferQuad.png")
#define CHAMFER_EDGE_MITERING_UNIFORM_PNG   _T("ChamferUniform.png")
#define CHAMFER_EDGE_MITERING_PATCH_PNG    _T("ChamferPatch.png")
#define CHAMFER_EDGE_MITERING_RADIAL_PNG    _T("ChamferRadial.png")
#define CHAMFER_EDGE_SEGMENT_PNG        _T("Segments.png")
#define CHAMFER_EDGE_TENSION_PNG        _T("Tension.png")
#define CHAMFER_EDGE_DEPTH_PNG        _T("Tension.png") // Change when available
#define CHAMFER_EDGE_END_BIAS_PNG        _T("Tension.png") // Change when available
#define CHAMFER_EDGE_RADIAL_BIAS_PNG        _T("Tension.png") // Change when available
...
#define EDGEDEPTH_PNG                       _T("EdgeDepth.png")
...
public:
	enum OurGrips{eFalloff = 0,  ePinch, eBubble, eSetFlow, eLoopShift,
					eRingShift, eEdgeCrease, eEdgeWeight, eEdgeDepth, eVertexCrease, eVertexWeight,
	...
	void SetUpVisibility(BOOL isVisible, int indexGrip);  //should be called after it's enabled we will reset everything
...
public:
    ...
    enum OurGrips
    {
        eChamferVerticesAmount = 0,
        eChamferVerticesSegments,
        eChamferVerticesDepth,
        eChamferVerticesOpen, 
        eChamferVerticesSmooth, 
        eChamferVerticesSmoothType, 
        eChamferVerticesSmoothThreshold
    };
...
public:
	...
	enum OurGrips{
		eChamferEdgeMiteringType = 0, 
		eChamferEdgeAmount, 
		eChamferEdgeSegments, 
		eChamferEdgeTension, 
		eChamferEdgeDepth, 
		eChamferEdgeEndBias,
		eChamferEdgeRadialBias,
		eChamferEdgeOpen, 
		eChamferEdgeInvert, 
		eChamferEdgeSmooth, 
		eChamferEdgeSmoothType, 
		eChamferEdgeSmoothThreshold
	};
...
public:
	...
	WeldVerticesGrip():mStrBefore(_T(" ")),mStrAfter(_T(" ")){}
...
public:
	...
	WeldEdgesGrip():mStrBefore(_T("     ")),mStrAfter(_T("     ")){}
