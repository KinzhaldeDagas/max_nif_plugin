...
class EditPolySubobjControlDlgProc : public ParamMap2UserDlgProc {
	EditPolyMod *mpMod;
	bool mUIValid;
	bool mSpinningWC;	// Adjusting weight or crease spinner indicator

public:
	EditPolySubobjControlDlgProc () : mpMod(NULL), mUIValid(false), mSpinningWC(false) { }
	void SetEPoly (EditPolyMod *e) { mpMod = e; }
