...
BOOL EditPolyActionCB::ExecuteAction (int id) {
	...
	case ID_EP_SEL_BYVERT:
		theHold.Begin ();
		mpMod->getParamBlock()->GetValue (epm_by_vertex, TimeValue(0), checkboxValue);
	...
	case ID_EP_PREVIEW_SEL:
		mpMod->getParamBlock()->GetValue(epm_select_mode,TimeValue(0),checkboxValue);
		theHold.Begin();
	...
	case ID_EP_SS_ON:
		theHold.Begin ();
		mpMod->getParamBlock()->GetValue (epm_ss_use, TimeValue(0), checkboxValue);
	...
	case ID_EP_SS_BACKFACE:
		theHold.Begin ();
		mpMod->getParamBlock()->GetValue (epm_ss_affect_back, TimeValue(0), checkboxValue);
	...
	case ID_EP_SS_LOCK:
		theHold.Begin ();
		mpMod->getParamBlock()->GetValue (epm_ss_lock, TimeValue(0), checkboxValue);
	...
	case ID_EP_NONE_CONSTRAINT:
		mpMod->getParamBlock()->GetValue (epm_constrain_type, TimeValue(0), constrainType);
