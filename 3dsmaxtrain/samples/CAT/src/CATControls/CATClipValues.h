...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_CATCLIPFLOAT) : _T("LayerFloat"); }
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_CATCLIPMATRIX3) : _T("LayerMatrix3"); }
	void DeleteThis() { delete this; }
