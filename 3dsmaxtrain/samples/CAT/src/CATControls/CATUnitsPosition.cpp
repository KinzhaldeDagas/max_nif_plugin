...
public:
	...
	const TCHAR*	ClassName() { return _T("CATUnitsPosition"); }
	const TCHAR*	NonLocalizedClassName() { return _T("CATUnitsPosition"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("CATUnitsScale"); }
...
public:
	...
	const TCHAR*	ClassName() { return _T("CATUnitsFloat"); }
	const TCHAR*	NonLocalizedClassName() { return _T("CATUnitsFloat"); }
