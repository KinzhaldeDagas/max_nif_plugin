...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_LIFTOFFSET) : _T("CATLiftOffset"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("CATLiftOffset"); }
