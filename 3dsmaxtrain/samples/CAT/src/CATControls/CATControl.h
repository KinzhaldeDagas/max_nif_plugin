...
private:
	// When > 0, evaluation is blocked.
	// KZ 06/2024: Refactored away from using a flag 'CNCFLAG_LOCK_STOP_EVALUATING' to a solution with a counter to support nesting.
	int mBlockEvaluation = 0;
public:
...
#pragma endregion
	...
	void IncrementBlockEvaluation();
	void DecrementBlockEvaluation();
	...
	BOOL IsEvaluationBlocked() const { return mBlockEvaluation > 0; }
...
private:
	...
	void BlockAllEvaluation(BOOL tf)
	{
		HoldSuspend hs;
		if (tf) {
