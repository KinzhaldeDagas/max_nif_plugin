...
public:
	...
	enum {
		PB_DIGITDATA, // Holder of the controller DigitData controller but is hidden. Access through PB_DIGITDATA_REFTARG.
		...
		PB_NODESEG,
		PB_BENDWEIGHT,
		PB_DIGITDATA_REFTARG // External access to the DigitData controller hold by PB_DIGITDATA.
	};
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const { s = _T("CATDigitSegTrans"); /*GetString(IDS_CL_DIGITSEGTRANS);*/ }
...
public:
	...
	void* GetInterface(ULONG id) {
		if (id == I_DRIVER) 	return (void *)GetDigit();
