...
extern TCHAR *GetUserSettingsPath(const TCHAR *filename = NULL);
...
BOOL DialogSaveRigPreset(HINSTANCE hInstance, HWND hWnd, TCHAR *fileBuf, int bufSize, const TCHAR *initialName = NULL);
