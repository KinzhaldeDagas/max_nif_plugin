...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_FOOTLIFT) : _T("CATFootLift"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("CATFootLift"); }
