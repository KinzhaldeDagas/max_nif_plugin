...
public:
	...
	int Proc(RemapDir& remap)
	{
		...
		// KZ 06/2024: That's because some paramblock entries are marked with P_NO_REF which means that CloneRef won't do anything.
		//	Looks like this PostPatchProc was added as a safety for all the mistakes in ::Clone implementations. We should work towards removing this.
...
{
	IParamBlock2* clonedpblock = (IParamBlock2*)remap.CloneRef(pblock);
