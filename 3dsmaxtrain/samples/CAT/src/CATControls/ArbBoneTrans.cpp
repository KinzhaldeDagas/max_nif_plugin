...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("ArbBone"); }
...
TSTR ArbBoneTrans::SubAnimName(int i, bool localized)
{
	switch (i)
	{
...
{
	// Do NOT return a driver control.  The problem with this is
	// that Max will automatically delete the driver and all siblings
