...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_LEGWEIGHT) : _T("CATLegWeight"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("CATLegWeight"); }
