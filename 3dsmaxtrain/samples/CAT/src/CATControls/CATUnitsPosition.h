...
public:
	...
	// here the 'Driver' controller can manage deleting/merging the whole character
	void* GetInterface(ULONG id) {
		//	if (id==I_DRIVER && REF_CTRL) 	return (void *)REF_CTRL->GetInterface(id);
		return Control::GetInterface(id);
	}
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = _T("CATUnitsPos"); } //GetString(IDS_CL_CATUNITSPOS);}

	TSTR SubAnimName(int i, bool localized) override { return _T("Position"); }
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = _T("CATUnitsScl"); } //GetString(IDS_CL_CATUNITSSCL);}

	TSTR SubAnimName(int i, bool localized) override { return _T("Scale"); }
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = _T("CATUnitsFloat"); } //GetString(IDS_CL_CATUNITSFLT);}

	TSTR SubAnimName(int i, bool localized) override { return _T("Float"); }
