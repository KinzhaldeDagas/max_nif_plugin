...
static_assert(sizeof(stepkey) == sizeof(int) + 3 * sizeof(float), "");
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = _T("Ease"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Ease"); }
