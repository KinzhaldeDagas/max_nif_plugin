...
private:
	...
	//////////////////////////////////////////////////////////////////////////
	// these flags are turned on and off while footprint positions get calculated
	BOOL calculating_footprints;
	bool mCalculateFootprints = true; // KZ 06/2024: Hack to block footprint calculations and fix crashes.
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_CATMOTIONPLATFORM) : _T("CATMotionPlatform"); }
...
public:
	...
	// KZ 06/2024: Hack to block footprint calculations and fix crashes.
	void DisableFootPrintsCalculation() { mCalculateFootprints = false; }
	void EnableFootPrintsCalculation() { mCalculateFootprints = true; }
