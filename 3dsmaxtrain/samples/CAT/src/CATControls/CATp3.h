...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_CATP3) : _T("CATPoint3"); }
	...
	TSTR SubAnimName(int i, bool localized) override; //  { return GetString(IDS_PARAMS); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("CATPoint3"); }
	SClass_ID		SuperClassID() { return CTRL_POINT3_CLASS_ID; }
	Class_ID		ClassID() { return CATP3_CLASS_ID; }
