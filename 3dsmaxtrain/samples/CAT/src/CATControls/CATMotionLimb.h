...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_CATMOTIONLIMB) : _T("CATMotionLimb"); }
	...
	{
		UNREFERENCED_PARAMETER(t); UNREFERENCED_PARAMETER(method);
		*((float*)val) = 0.0f;
	};
