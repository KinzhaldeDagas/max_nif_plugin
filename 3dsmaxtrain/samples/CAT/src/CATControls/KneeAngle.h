...
//		IParamBlock2	*pblock;	//ref 0
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_KNEEANGLE) : _T("CATKneeAngle"); }
...
public:
	...
	const TCHAR*	NonLocalizedClassName() { return _T("CATKneeAngle"); }
