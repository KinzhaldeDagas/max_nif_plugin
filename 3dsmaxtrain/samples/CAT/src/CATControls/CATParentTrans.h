...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_CATPARENTTRANS) : _T("CATParentTrans"); };
...
public:
	...
	virtual void	SetCATMode(CATMode mode, bool skipInvalidateUI = false) override;
