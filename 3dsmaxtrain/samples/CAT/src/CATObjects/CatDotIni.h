...
{
private:
	using PathMap = std::unordered_map<std::wstring, std::wstring>;

	static PathMap::key_type ToPathMapKey(const TCHAR *szGroup, const TCHAR *szKey);
	static void InitializePathMap();
	static bool InitializeUserSettingsPath();

private:
	static PathMap sPathMap;
