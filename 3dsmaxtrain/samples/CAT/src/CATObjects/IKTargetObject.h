...
public:
	...
	const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_CL_IKTARGET_OBJECT) : _T("IKTarget"); }
	...
	Object* ConvertToType(TimeValue, Class_ID obtype) 
	{ 
		// 'Any' type:
		if (obtype == anyObjectClassID)
			return this;
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_IKTARGET_OBJECT) : _T("IKTarget"); }
	int IsKeyable() { return 0; }
	int NumSubs() { return 1; }
	Animatable* SubAnim(int) { return pblock2; }
	TSTR SubAnimName(int i, bool localized) override { return TSTR(_T("Parameters")); }
