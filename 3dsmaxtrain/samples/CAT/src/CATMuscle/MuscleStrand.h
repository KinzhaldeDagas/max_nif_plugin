...
class MuscleStrand : public SimpleObject2, public IMuscleStrand, public ICATMuscleSystemDriver, IDataRestoreOwner<float>, IDataRestoreOwner<int>, IDataRestoreOwner<TabSphereParams> {
protected:
...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_MUSCLESTRAND) : _T("Muscle Strand"); }
