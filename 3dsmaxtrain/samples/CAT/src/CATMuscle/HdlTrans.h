...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_HDLTRANS) : _T("HdlTrans"); }
	void DeleteThis() { delete this; }
	int NumSubs() { return NUMREFS; }
	Animatable* SubAnim(int i) { return (i == PRSREF) ? mPRS : NULL; };
	TSTR SubAnimName(int i, bool localized) override { return (i == PRSREF) ? (localized ? GetString(IDS_TRANSFORM) : _T("Transform")) : _T(""); };
