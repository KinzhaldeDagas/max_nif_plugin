...
////////////////////////////////////////////////////////////////
//
#define CATMUSCLE_SYSTEMDRIVER_INTERFACE_ID Interface_ID(0x78054328, 0x507b443d)

class ICATMuscleSystemDriver : public BaseInterface {
public:
...
#define  GetCATMuscleSystemInterface(ref) ((ICATMuscleSystemDriver*)ref->GetInterface(CATMUSCLE_SYSTEMDRIVER_INTERFACE_ID))
 ...
 * IMuscle: Published functions for CATMuscles
 */
#define SPRINGDRIVER_INTERFACE_ID Interface_ID(0x19787c4e, 0x41bc4ad5)
#define GetSpringDriverInterface(cd) ((ISpringDriver*)cd->GetInterface(SPRINGDRIVER_INTERFACE_ID))

class ISpringDriver : public FPMixinInterface {
public:
	...
	FPInterfaceDesc* GetDesc() { return GetDescByID(SPRINGDRIVER_INTERFACE_ID); }
