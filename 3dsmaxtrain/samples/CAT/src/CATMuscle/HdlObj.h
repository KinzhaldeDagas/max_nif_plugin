...
public:
	...
	const MCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_CL_HDLOBJ) : _T("Muscle Handle"); }
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_CL_HDLOBJ) : _T("Muscle Handle"); }
