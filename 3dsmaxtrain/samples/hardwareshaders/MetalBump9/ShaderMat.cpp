...
bool ShaderMat::Evaluate(float Time, LPDIRECT3DDEVICE9 Device, RenderMesh *RMesh)
{
	...
	{
		D3DXVECTOR4 vec4_1(m_MixScale, m_MixScale, m_MixScale, m_MixScale);
		Device->SetPixelShaderConstantF(CP_MIX_AMT,(float*)&vec4_1, 1);
		D3DXVECTOR4 vec4_2(m_ReflectScale, m_ReflectScale, m_ReflectScale, m_ReflectScale);
		Device->SetPixelShaderConstantF(CP_REFLECT_AMT,(float*)&vec4_2, 1);
	}
