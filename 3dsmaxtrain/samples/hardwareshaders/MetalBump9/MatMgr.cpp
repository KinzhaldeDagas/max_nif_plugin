...
void MatMgr::LoadDefaults(LPDIRECT3DDEVICE9 Device, bool FromResource)
{
	...
	if(!m_Loaded)
	{
		...
		for(i=0; i < MAX_MATERIALS; i++)
		{
			...
			m_MatInfos[i].m_VertexFile			= _T("");		
			m_MatInfos[i].m_VertexHandle		= 0;		
			m_MatInfos[i].m_PixelFile			= _T("");	
			m_MatInfos[i].m_PixelHandle			= 0;
			m_MatInfos[i].m_AlphaPixelFile		= _T("");	
		...
		m_MatInfos[m_NumMat].m_VertexFile		= _T("D.nvo");		
		m_MatInfos[m_NumMat].m_VertexRes		= IDR_D_NVO;
		m_MatInfos[m_NumMat].m_AlphaPixelFile	= _T("DA.pso");		
		...
		m_MatInfos[m_NumMat].m_VertexFile		= _T("R.nvo");
		...
		m_MatInfos[m_NumMat].m_VertexFile		= _T("D.nvo");		
		m_MatInfos[m_NumMat].m_VertexRes		= IDR_D_NVO;
		m_MatInfos[m_NumMat].m_AlphaPixelFile	= _T("DMA.pso");		
		...
		m_MatInfos[m_NumMat].m_VertexFile		= _T("DR.nvo");		
		m_MatInfos[m_NumMat].m_VertexRes		= IDR_DR_NVO;		
		m_MatInfos[m_NumMat].m_PixelFile		= _T("DR.pso");		
		m_MatInfos[m_NumMat].m_PixelRes			= IDR_DR_PSO;		
		m_MatInfos[m_NumMat].m_AlphaPixelFile	= _T("DRA.pso");		
		...
		m_MatInfos[m_NumMat].m_VertexFile		= _T("DR.nvo");		
		m_MatInfos[m_NumMat].m_VertexRes		= IDR_DR_NVO;
		m_MatInfos[m_NumMat].m_PixelFile		= _T("DMR.pso");		
		m_MatInfos[m_NumMat].m_PixelRes			= IDR_DMR_PSO;		
		m_MatInfos[m_NumMat].m_AlphaPixelFile	= _T("DMRA.pso");		
		...
		m_MatInfos[m_NumMat].m_VertexFile		= _T("NR.nvo");
		m_MatInfos[m_NumMat].m_PixelFile		= _T("NR.pso");	
