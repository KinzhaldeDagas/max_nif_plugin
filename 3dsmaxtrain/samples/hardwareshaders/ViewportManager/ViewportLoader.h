...
public:
	...
	virtual const TCHAR* GetName(bool localized) override;
	void GetClassName(MSTR& s, bool localized) const override {s = _T("DirectX Manager");}
