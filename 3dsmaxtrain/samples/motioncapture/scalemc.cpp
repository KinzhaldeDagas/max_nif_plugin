...
class ScaleMC : public MCControl {
	public:
		...
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_RB_SCALEMC) : _T("Scale Motion Capture");}
...
class ScaleMCClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Scale Motion Capture"); }
	SClass_ID		SuperClassID() {return CTRL_SCALE_CLASS_ID;}
	Class_ID		ClassID() {return scalemcControlClassID;}
