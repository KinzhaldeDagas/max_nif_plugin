...
class PositionMC : public MCControl {
	public:
		...
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_RB_POSMC) : _T("Position Motion Capture");}
...
class PosMCClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Position Motion Capture"); }
	SClass_ID		SuperClassID() {return CTRL_POSITION_CLASS_ID;}
	Class_ID		ClassID() {return posmcControlClassID;}
