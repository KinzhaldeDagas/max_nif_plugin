...
class MCParamDlg : public IMCParamDlg {
	public:
		...
		void DoWindow(HWND hParent, const TCHAR *pname);

		Class_ID ClassID() {return Class_ID(MCPARAMDLG_CLASS_ID,0);}
		SClass_ID SuperClassID() {return REF_MAKER_CLASS_ID;}		
		virtual void GetClassName(MSTR& s, bool localized) const override { s = _M("MCParamDlg"); } // from Animatable
...
private:
		virtual void SetReference(int i, RefTargetHandle rtarg) {cont=(MCControl*)rtarg;}
public:
