...
class FloatMC : public MCControl {
	public:
		...
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_RB_FLOATMC) : _T("Float Motion Capture");}
...
class FloatMCClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Float Motion Capture"); }
	SClass_ID		SuperClassID() {return CTRL_FLOAT_CLASS_ID;}
	Class_ID		ClassID() {return floatmcControlClassID;}
