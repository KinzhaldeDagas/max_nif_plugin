...
class Point3MC : public MCControl {
	public:
		...
		void GetClassName(MSTR& s, bool localized) const override {s = localized ? GetString(IDS_RB_POINT3MC) : _T("Point3 Motion Capture");}
...
class Point3MCClassDesc:public ClassDesc {
	...
	const TCHAR*	NonLocalizedClassName() { return _T("Point3 Motion Capture"); }
	SClass_ID		SuperClassID() {return CTRL_POINT3_CLASS_ID;}
	Class_ID		ClassID() {return point3mcControlClassID;}
