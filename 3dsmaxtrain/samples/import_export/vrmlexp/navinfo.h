...
class NavInfoObject: public HelperObject {			   
  ...
  public:
    ...
    const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_NAV_INFO) : _T("NavInfo"); }
    ...
    Class_ID ClassID() { return Class_ID(NavInfo_CLASS_ID1,
                                         NavInfo_CLASS_ID2);}  
    void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_NAV_INFO_CLASS) : _T("NavInfo"); }
