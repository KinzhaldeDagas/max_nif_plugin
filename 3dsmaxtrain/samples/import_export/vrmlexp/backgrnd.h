...
class BackgroundObject: public HelperObject {			   
  ...
  public:
    ...
    const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_BACKGROUND) : _T("Background"); }


    // From Object
           ObjectState Eval(TimeValue time);
    void InitNodeName(TSTR& s) { s = GetString(IDS_BACKGROUND); }
    ...
    void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_BACKGROUND_CLASS) : _T("Background"); }
