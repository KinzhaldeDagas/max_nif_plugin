...
public:
	...
	void ResetStr(void) {
		...
		else listStr.printf(_T("%s   %g"), _T("NO_NAME"), dist);
	}
...
//	void Snap(TimeValue t, INode* inode, SnapInfo *snap, IPoint2 *p, ViewExp *vpt);
	...
	const TCHAR *GetObjectName(bool localized) const override { return localized ? GetString(IDS_LOD) : _T("LOD"); }
	...
	void InitNodeName(TSTR& s) { s = GetString(IDS_LOD); }
