...
#define BM_SIZE 32768
      ...
      int rc = MaxSDK::Util::GetPrivateProfileSection(BOOKMARK_SECTION, bm, BM_SIZE,
   ...
   HWND hlist = GetDlgItem(hDlg,IDC_URL_LIST);
    ...
    case WM_COMMAND:
      ...
      case IDC_IMPORT: {
         ...
         ofn.lpstrTitle = NULL; 
         ofn.Flags = OFN_FILEMUSTEXIST | OFN_LONGNAMES | OFN_PATHMUSTEXIST|OFN_EXPLORER | OFN_ENABLEHOOK | OFN_ENABLESIZING | OFN_HIDEREADONLY; 
