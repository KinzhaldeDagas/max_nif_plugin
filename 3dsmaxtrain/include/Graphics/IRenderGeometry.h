...
namespace MaxSDK { namespace Graphics {
	...
	*/
	...
	{
	public:
		/** This function might be called multiple times in a frame, such as when we use shadow maps. Inherited classes need to
		use in the pipeline context to render the geometry. It's recommend to prepare the geometry
		data in another function like the constructor, and only do rendering tasks in the Display() function.
		...
		/param lod current lod value from adaptive degradation system
		*/
