...
public:
	...
	GraphicsUtilityAPI long AddRef() override;
	GraphicsUtilityAPI long Release() override;
	GraphicsUtilityAPI long RefCount() override;
	GraphicsUtilityAPI IRefObject* QueryInterface(Interface_ID classID) override;
...
public:
	...
	static inline void RefCount(RefObjectType* pObject) { pObject->RefCount(); }
};
