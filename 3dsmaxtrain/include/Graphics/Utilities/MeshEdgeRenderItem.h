...
namespace MaxSDK{namespace Graphics{namespace Utilities	{
	...
	*/
	class MeshEdgeRenderItem : public MaxSDK::Graphics::ICustomRenderItem, public MaxSDK::Util::Noncopyable
	{
		...
		SharedMeshPtr	mpSharedMesh = nullptr;
		Edge* mpEdgeList;
		Color mColor;
	...
	public:
		/** Constructor
		\param pMesh mesh to display, we will do a local copy of this mesh
		\param fixedSize indicate whether this item's mesh has fixed size on the screen
		*/
		DefaultRenderItemAPI MeshEdgeRenderItem(Mesh& pMesh, bool fixedSize);///We do a copy of the mesh
		/** Constructor
		\param pSharedMeshPtr Shared mesh pointer of the mesh to display, this mesh will be shared
		\param fixedSize indicate whether this item's mesh has fixed size on the screen
		*/
		DefaultRenderItemAPI MeshEdgeRenderItem(SharedMeshPtr pSharedMeshPtr, bool fixedSize); 
		...
		*/
		DefaultRenderItemAPI void SetColor(const Color& color);
