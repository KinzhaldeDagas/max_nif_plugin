...
#define _MAXVER_TOSTRING_HELPER(x)  _MAXVER_TOSTRING(x)
...
#define MAXVER_FILEDESCRIPTION MAXVER_PRODUCTNAME " " _MAXVER_TOSTRING_HELPER(MAX_PRODUCT_YEAR_NUMBER) "\0"
#endif
...
#define MAXVER_COPYRIGHT		"© 2026 Autodesk, Inc. All rights reserved.\0"
#endif
