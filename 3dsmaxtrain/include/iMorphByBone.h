...
class IMorphByBone : public FPMixinInterface 
{
	public:
		...
		/// void fnSelectBone(INode *node,const MCHAR* morphName)
		...
		/// void	fnRemoveMorph(INode *node, const MCHAR *name)
		...
		/// void	fnResetOrientation(INode *node, const MCHAR *name)
		...
		/// void	fnReloadTarget(INode *node, const MCHAR *name)
		...
		/// void	fnEditFalloffGraph(INode *node, const MCHAR *name)
		...
		/// void	fnSetExternalNode(INode *node, const MCHAR *name,INode *exnode)
