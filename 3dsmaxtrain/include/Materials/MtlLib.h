...
class MtlList: public Tab<MtlHandle> {
	 public:
			...
			<b>MSTR\& name</b>\n\n
			The material to find. */
			CoreExport int FindMtlByName(const MSTR& name);
...
class MtlLib: public ReferenceTarget, public MtlList {
	 public:
			...
			CoreExport Class_ID ClassID() override;
		...
		public:
			CoreExport RefTargetHandle Clone(RemapDir& remap) override;
...
public:
	...
	CoreExport Class_ID ClassID() override;
	CoreExport void GetClassName(MSTR& s, bool localized = true) const override;
	CoreExport int NumSubs() override;
...
protected:
	/*! \remarks Destructor. All references are deleted. */
	CoreExport ~MtlBaseLib() override;
};
