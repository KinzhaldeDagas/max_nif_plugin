...
public:
	...
	explicit OperationDesc(const MSTR& commandName);
	...
	explicit OperationDesc(int commandResId, const MSTR& commandName, HINSTANCE moduleInst);
	...
	//!     way point.
	explicit OperationDesc(int commandResId, const MSTR& commandName, HINSTANCE moduleInst, ReferenceTarget* refTarget);
	...
	//!     invocation and from which the Class_ID and the SClass_ID will be extracted and used as such in the
	//!     way point.
	explicit OperationDesc(int commandResId, const MSTR& commandName, HINSTANCE moduleInst, ClassDesc* classDesc);
	...
	//!     Used as such in the way point.
	explicit OperationDesc(int commandResId, const MSTR& commandName, HINSTANCE moduleInst, const SClass_ID& scId, const Class_ID& cId);
	...
	explicit OperationDesc(int commandResId, const MSTR& commandName, HINSTANCE moduleInst, MSTR commandDetails);
