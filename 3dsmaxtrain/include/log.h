...
class LogSys : public MaxHeapOperators
{
	protected:
	 ...
	 public:
		...
		\endcode */
		virtual void LogEntry(DWORD type, BOOL dialogue, const MSTR& title, const MCHAR* format, ...) = 0;
		virtual void LogEntry(DWORD type, BOOL dialogue, const MSTR& title, MSTR format, ...) = 0; // Cannot use const& because of va_start
