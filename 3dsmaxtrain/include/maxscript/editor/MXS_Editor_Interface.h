...
struct EditFileResult
{
	...
	EditFileResult() : fileNotFound(false), fileAlreadyOpen(false), fileNewOpen(false), edit_hwnd(nullptr) {}
};
...
public:
	...
	virtual bool EditFile(const MCHAR* filename = nullptr, bool useOpenfilenameDialogIfFilenameNull = false, const MCHAR* initialPath = nullptr, 
...
public:
	...
	virtual MSTR GetLocalUserDataDirectory();
...
class MXSEditor_Interface3 : public MXSEditor_Interface2 {
public:
...
public:
	...
	MXS_Editor_Interface() : Editor_Interface_Instance(nullptr), MXSEditor_Interface_Instance(nullptr) {}
	...
	bool Editor_EditFile(const MCHAR* filename = nullptr, bool useOpenfilenameDialogIfFilenameNull = false, const MCHAR* initialPath = nullptr, 
						 int openToPos = -1, Editor_Interface::OpenFlags of = Editor_Interface::ofNone, bool unhide = true, 
						 bool setFocus = true) 
	...
	void MXS_DisplayHelp(const MCHAR* word)
		{ ((MXSEditor_Interface*)MXSEditor_Interface_Instance)->DisplayHelp(word); }
	void MXS_DisplayHelp(bool displayPythonHelp, const MCHAR* word)
		{ MXSEditor_Interface_Instance->DisplayHelp(displayPythonHelp, word); }
	...
	void EditorActivated(bool activatedState)
		{ MXSEditor_Interface_Instance->EditorActivated(activatedState); }
