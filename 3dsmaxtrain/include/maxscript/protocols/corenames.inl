...
// LAM: Added these 7/23/02
	...
	def_name ( colorSpace )
	def_name ( colorSpaceSource )
	def_name ( colorSpaceReq )
	def_name ( colorSpaceReqSource )
	def_name ( colorSpaceStatus )
	def_name ( colorSpaceRule )

	def_name ( outputColorConversion )
	def_name ( outputColorSpace )
	def_name ( outputDisplay )
	def_name ( outputViewTransform )

	// for Color Conversion types
	// def_name ( automatic )
	def_name ( noConversion )
	def_name ( colorSpaceConversion )
	def_name ( displayViewTransform )

	// for Color Space Source
	def_name ( inputRules )
	def_name ( notSet )
	def_name ( heuristics )

	// Color Space Status
	def_name ( forcedDefault )
	def_name ( invalid )
	...
	def_name ( ok )
	def_name ( question )
	def_name ( information )
	def_name ( critical )
	def_name ( dontShowAgain )
	def_name ( defaultButton )
	def_name ( helpID )
	def_name ( extraFlags )
	def_name ( showHoldButton )
	def_name ( autoSaveEnabled )
	def_name ( hold )
	def_name ( caseSensitiveSort )

	def_name ( multiLine )
	def_name ( propCaseSensitiveName )
	def_name ( nestedPropCaseSensitiveName )

	def_name ( nonLocalizedName )
	def_name ( which )

	def_name ( trackViewNodes )
	def_name ( customAttributes )

	def_name ( unknownSourceScript )
	def_name ( sceneEmbeddedScript )
	def_name ( nonSceneEmbeddedScript )
	def_name ( dynamicScript )
	def_name ( allowCancel )
	def_name ( stepName )
	def_name ( autobackupRequired )
	...
	def_name ( temporary )
	def_name ( sparseFile )
	def_name ( reparsePoint )
	def_name ( compressed )
	def_name ( offline )
	def_name ( notContentIndexed )
	def_name ( encrypted )
	def_name ( integrityStream )
	def_name ( virtual )
	def_name ( noScrubData )
	def_name ( recallOnOpen )
	def_name ( pinned )
	def_name ( unpinned )
	def_name ( recallOnDataAccess )
	def_name ( wireColor )
	def_name ( skipXRefs )
	def_name ( mergeByHandles )

	def_name ( anyObjectFilter )

	def_name ( populateDynamicMenu )
	def_name ( dynamicMenuItemSelected )

	def_name ( autoScale )
	def_name ( ignoreSSSEState )
	def_name ( dynamicAlwaysScript )

	def_name ( addFileToList )
	def_name ( strictCompare )

	def_name ( copyAllValuesAsUnique )
	def_name ( forever )
	def_name ( never )

	def_name ( maxclass )

	def_name ( doDisplayTransform )
	def_name ( doDisplayTransformBitmap )
	def_name ( colorContext )
	def_name ( sceneSurface )
	def_name ( sceneLight )
	def_name ( sRGB )
	def_name ( data )
