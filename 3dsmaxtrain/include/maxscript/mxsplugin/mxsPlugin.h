...
#define MPC_UNIQUE						(1<<20) //0x00100000  // Attribute is a unique copy of another attribute. Used when compiling unique attribute definition
...
#pragma pop_macro("new")
	...
	BaseInterface*	GetInterface(Interface_ID id) override { return TYPE::GetInterface(id); }
...
public:
	...
	BaseInterface*	GetInterface(Interface_ID id) override { return MS_SUPER::GetInterface(id); }
