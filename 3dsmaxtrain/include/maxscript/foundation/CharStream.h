...
//	 bool			mTrippedLineFeed;
 ...
 public:
	...
	virtual ~CharStream();
 			...
 			BOOL	_is_charstream() override { DbgAssert(!is_sourcepositionwrapper(this)); return 1; }
...
//	void			setTrippedLineFeed(bool val); // set whether passed a line feed
	...
	void puts(const MSTR& str) { puts(str.data()); }
	...
	#pragma warning(pop)
 	...
 	virtual Listener* get_listener() { return nullptr; }
 	virtual CharStream* get_log() { return nullptr; }
