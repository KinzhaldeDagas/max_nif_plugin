...
*/
//!@{
#define I_BIPDRIVER10	0x9170    //!< Biped interface identifier
#define GetBipDriver10Interface(anim) ((IBipDriver10*)(anim)->GetInterface(I_BIPDRIVER10))	//!< Gets the Biped interface
//!@}

//! \brief Interface into the biped driver controller for Max 10.
