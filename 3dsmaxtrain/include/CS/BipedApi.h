...
BIPExport IBipDriver* CreateNewBiped(float height, float angle, const Point3& wpos,
...
class MixerManager: public MaxHeapOperators {
	public:
		...
		BIPExport void   AddBipedToMixerDisplay(IBipDriver *mc);
		BIPExport void   RemoveBipedFromMixerDisplay(IBipDriver *mc);
