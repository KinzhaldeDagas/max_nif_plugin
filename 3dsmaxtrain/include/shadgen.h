...
#define MIN_SHADOW_MAP_SIZE 1	// Minimum allowed value for the shadow map size property
#define DEFAULT_SHADOW_MAP_SIZE 2048	// Default value for the shadow map size property
#define MAX_SHADOW_MAP_SIZE 10000	// Maximum allowed value for the shadow map size property

#define MIN_SHADOW_BIAS_VALUE 0.0f // Minimum allowed value for the shadow map bias property
#define DEFAULT_SHADOW_BIAS_VALUE 1.0f // Default value for the shadow map bias property
...
#define DEFAULT_SHADOW_SAMPLE_RANGE 4.0f // Default value for the shadow map sample range property
#define MAX_SHADOW_SAMPLE_RANGE 50.0f // Maximum allowed value for the shadow map sample range property

#define DEFAULT_SHADOW_ABSOLUTE_BIAS FALSE // Default value for the shadow map Absolute Map Bias property

#define TWO_SIDED_SHADOW_DEFAULT FALSE // Default value for the shadow map 2 Sided Shadows property
