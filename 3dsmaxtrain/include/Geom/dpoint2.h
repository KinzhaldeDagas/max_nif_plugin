...
GEOM_EXPORT int DoublePrecisionLineSegmentIntersection(const DPoint2& seg1Start, const DPoint2& seg1End,
...
*/
GEOM_EXPORT int DoublePrecisionLineIntersection(const DPoint2& line1PointA, const DPoint2& line1PointB,
