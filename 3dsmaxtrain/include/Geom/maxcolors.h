...
struct Color24
{
	...
	friend constexpr bool operator==(const Color24& lhs, const Color24& rhs)
	{
...
struct Color48
{
	...
	friend constexpr bool operator==(const Color48& lhs, const Color48& rhs)
	{
		return lhs.r == rhs.r && lhs.g == rhs.g && lhs.b == rhs.b;
	}
	friend constexpr bool operator!=(const Color48& lhs, const Color48& rhs)
...
struct Color64
{
	...
	friend constexpr bool operator==(const Color64& lhs, const Color64& rhs)
	{
...
struct BMM_Color_24
{
	...
	friend constexpr bool operator==(const BMM_Color_24& lhs, const BMM_Color_24& rhs)
	{
		return lhs.r == rhs.r && lhs.g == rhs.g && lhs.b == rhs.b;
	}
	friend constexpr bool operator!=(const BMM_Color_24& lhs, const BMM_Color_24& rhs)
...
struct BMM_Color_32
{
	...
	friend constexpr bool operator==(const BMM_Color_32& lhs, const BMM_Color_32& rhs)
	{
		return lhs.r == rhs.r && lhs.g == rhs.g && lhs.b == rhs.b && lhs.a == rhs.a;
	}
	friend constexpr bool operator!=(const BMM_Color_32& lhs, const BMM_Color_32& rhs)
...
struct BMM_Color_48
{
	...
	friend constexpr bool operator==(const BMM_Color_48& lhs, const BMM_Color_48& rhs)
	{
		return lhs.r == rhs.r && lhs.g == rhs.g && lhs.b == rhs.b;
	}
	friend constexpr bool operator!=(const BMM_Color_48& lhs, const BMM_Color_48& rhs)
...
struct BMM_Color_64
{
	...
	friend constexpr bool operator==(const BMM_Color_64& lhs, const BMM_Color_64& rhs)
	{
		return lhs.r == rhs.r && lhs.g == rhs.g && lhs.b == rhs.b && lhs.a == rhs.a;
	}
	friend constexpr bool operator!=(const BMM_Color_64& lhs, const BMM_Color_64& rhs)
...
struct BMM_Color_fl
{
	...
	friend constexpr bool operator==(const BMM_Color_fl& lhs, const BMM_Color_fl& rhs)
	{
		return lhs.r == rhs.r && lhs.g == rhs.g && lhs.b == rhs.b && lhs.a == rhs.a;
	}
	friend constexpr bool operator!=(const BMM_Color_fl& lhs, const BMM_Color_fl& rhs)
...
{
	constexpr BMM_Color_fl3(float vr = 0.0f, float vg = 0.0f, float vb = 0.0f)
			: r(vr)
			, g(vg)
			, b(vb)
	{
	...
	friend constexpr bool operator==(const BMM_Color_fl3& lhs, const BMM_Color_fl3& rhs)
	{
		return lhs.r == rhs.r && lhs.g == rhs.g && lhs.b == rhs.b;
	}
	friend constexpr bool operator!=(const BMM_Color_fl3& lhs, const BMM_Color_fl3& rhs)
