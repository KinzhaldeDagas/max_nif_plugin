 ...
 */
GEOM_EXPORT Point3 BaryCoords(Point3 p0, Point3 p1, Point3 p2, Point3 p);
 ...
 */
GEOM_EXPORT Point3 BaryCoords(Point2 p0, Point2 p1, Point2 p2, Point2 p);
 ...
 */
GEOM_EXPORT bool RayHitsBox(Ray& ray, Box3& b);
 ...
 */
GEOM_EXPORT float DistPtToLine(Point2* p0, Point2* p1, Point2* q);
 ...
 * \return The distance of the point from the line.
 */
GEOM_EXPORT float Dist3DPtToLine(Point3* p0, Point3* p1, Point3* q);
 ...
 */
GEOM_EXPORT bool ComputeIntersectionPoint(Point3& intersectionPoint, geo::span<const Point3> fixedCoeffs,
 ...
 */
GEOM_EXPORT void ComputeBumpVectors(const Point3 tv[3], const Point3 v[3], Point3 bvec[3]);
 ...
 */
GEOM_EXPORT void ComputeBumpVec2D(int axis, const Point3 tv[3], const Point3 v[3], Point3 bvec[2]);
 ...
 */
GEOM_EXPORT Point3 ComputeTangent(const Point3 tv[3], const Point3 v[3]);
 ...
 * \param[out] bvec The 2 normalized bump basis vectors corresponding to the specified axes.
 */
GEOM_EXPORT void ComputeTangentAndBinormal(const Point3 tv[3], const Point3 v[3], Point3 bvec[2]);
 ...
 */
GEOM_EXPORT void ComputeMikkTangents(ITangentsComputationCallback* tangentsComputationCallback);
 ...
 */
GEOM_EXPORT UVTangentVectors ComputeUVTangents(
 ...
 */
GEOM_EXPORT uint32_t CompressNormal(Point3 p);
 ...
 * \see CompressNormal()
 */
GEOM_EXPORT Point3 DeCompressNormal(uint32_t n);
 ...
 */
GEOM_EXPORT void ArbAxis(const Point3& zAxis, Matrix3& matrix);
