...
/*! \sa  Class Color, Structure BMM_Color_24, Structure BMM_Color_32, Structure BMM_Color_48, Structure BMM_Color_64,
Structure BMM_Color_fl, Structure RealPixel.\n\n
\par Description:
This class represents color as four floating point values: <b>r, g, b</b>, and an alpha channel <b>a</b>.
...
public:
	...
	optionally specifying an alpha value. */
	GEOM_EXPORT explicit AColor(uint32_t rgb, float alph = 1.0f); // from Windows RGB value
...
b=2, a=3. */
GEOM_EXPORT int MaxComponent(const AColor&); // the component with the maximum abs value
...
b=2, a=3. */
GEOM_EXPORT int MinComponent(const AColor&); // the component with the minimum abs value
