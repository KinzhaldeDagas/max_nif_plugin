...
public:
   ...
   \return true if the absolute difference between point components
...
GEOM_EXPORT Point4 CrossProd(const Point4& a, const Point4& b, const Point4& c); // CROSS PRODUCT
