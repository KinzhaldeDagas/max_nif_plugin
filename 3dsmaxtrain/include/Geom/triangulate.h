...
GEOM_EXPORT void SortPolygonDiagonals(geo::span<int> diag);
GEOM_EXPORT void SortPolygonDiagonals(geo::span<uint64_t> diag);
...
GEOM_EXPORT void BestConvexDiagonals(
...
/** This method finds diagonals for this sequence of vertices, creating a
	...
	\param[in] meshVertices The array of vertices.\n\n
	\param[out] diag A pointer to an array of size (deg-3)*2 where the diagonals can be put. */
GEOM_EXPORT void FindDiagonals(
		const BufferProxy<const int>& faceVertexIndices, const BufferProxy<const Point3>& meshVertices, int* diag);
...
GEOM_EXPORT bool BuildDiagonals(geo::span<int>& diagonals, const geo::span<const Point3>& xVertices,
							   bool doComputeIfPlanarConvex = true, TriangulationVersionType version = TRIANGULATION_VER_2024);
GEOM_EXPORT bool BuildDiagonals(geo::span<uint16_t>& diagonals, const geo::span<const Point3>& xVertices,
							   bool doComputeIfPlanarConvex = true, TriangulationVersionType version = TRIANGULATION_VER_2024);

// Single-threaded overloads.
GEOM_EXPORT bool BuildDiagonalsST(geo::span<int>& diagonals, const geo::span<const Point3>& xVertices,
							   bool doComputeIfPlanarConvex = true, TriangulationVersionType version = TRIANGULATION_VER_2024);
GEOM_EXPORT bool BuildDiagonalsST(geo::span<uint16_t>& diagonals, const geo::span<const Point3>& xVertices,
							   bool doComputeIfPlanarConvex = true, TriangulationVersionType version = TRIANGULATION_VER_2024);
...
/** Computes a set of diagonals for the polygon defined by the specified
	...
	\return Flag indicating whether diagonals were computed. If false, the
			diagonals array will be unaltered. Note that if N <= 3, we will
			return false reflexively. */
GEOM_EXPORT bool BuildDiagonals(geo::span<int>& diagonals, const geo::span<const int>& vertexIndices,
...
GEOM_EXPORT bool BuildDiagonals(geo::span<uint16_t>& diagonals, const geo::span<const uint64_t>& vertexIndices,
							   const BufferProxy<const Point3>& xVertices, bool doComputeIfPlanarConvex = true,
							   TriangulationVersionType version = TRIANGULATION_VER_2024);

// Single-threaded overloads.
GEOM_EXPORT bool BuildDiagonalsST(geo::span<int>& diagonals, const geo::span<const int>& vertexIndices,
							   const BufferProxy<const Point3>& xVertices, bool doComputeIfPlanarConvex = true,
							   TriangulationVersionType version = TRIANGULATION_VER_2024);
GEOM_EXPORT bool BuildDiagonalsST(geo::span<uint16_t>& diagonals, const geo::span<const uint64_t>& vertexIndices,
							   const BufferProxy<const Point3>& xVertices, bool doComputeIfPlanarConvex = true,
							   TriangulationVersionType version = TRIANGULATION_VER_2024);
...
GEOM_EXPORT void GetTriangles(int deg, geo::span<int> diag, geo::span<int> out_tri);
GEOM_EXPORT void GetTriangles(uint16_t deg, geo::span<uint16_t> diag, geo::span<uint16_t> out_tri);
GEOM_EXPORT void GetTriangles(uint64_t deg, geo::span<uint64_t> diag, geo::span<uint64_t> out_tri);
...
/** This method fills in the buffer with the full triangulation for the face,
	...
	\param[out] out_tri The output triangle indices, 3 indices per triangle.
 */
GEOM_EXPORT void GetTriangles(int deg, geo::span<const int> diag, geo::span<int> out_tri);
GEOM_EXPORT void GetTriangles(uint16_t deg, geo::span<const uint16_t> diag, geo::span<uint16_t> out_tri);
GEOM_EXPORT void GetTriangles(uint64_t deg, geo::span<const uint64_t> diag, geo::span<uint64_t> out_tri);
} // namespace MaxSDK
