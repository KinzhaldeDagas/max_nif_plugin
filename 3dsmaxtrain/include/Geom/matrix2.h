...
public:
	...
	GEOM_EXPORT Matrix2() = default;

	GEOM_EXPORT Matrix2(const Matrix2&) = default;
	GEOM_EXPORT Matrix2(Matrix2&&) = default;
	GEOM_EXPORT Matrix2& operator=(const Matrix2&) = default;
	GEOM_EXPORT Matrix2& operator=(Matrix2&&) = default;

	GEOM_EXPORT Matrix2(bool)
	{
		IdentityMatrix();
	} // An option to initialize

	/*! \remarks Constructor. The matrix is initialized using <b>fp</b>. */
	GEOM_EXPORT Matrix2(float (*fp)[2]);

	// Data member
	GEOM_EXPORT static const Matrix2 Identity;

	
	/*! \remarks Compares the elements of this matrix and the one specified element by
	element for exact equality.
	\param  M     The matrix to compare against. */
	GEOM_EXPORT bool operator==(const Matrix2& M) const;

	/*! \remarks Compares the elements of this matrix and the one specified element by
		element for inequality.
	\param  M     The matrix to compare against. */
	GEOM_EXPORT bool operator!=(const Matrix2& M) const;

	/*! \remarks Subtracts a Matrix2 from this Matrix2. */
	GEOM_EXPORT Matrix2& operator-=(const Matrix2& M);
	/*! \remarks Adds a Matrix2 to this Matrix2. */
	GEOM_EXPORT Matrix2& operator+=(const Matrix2& M);
	/*! \remarks Matrix multiplication between this Matrix2 and <b>M</b>. */
	GEOM_EXPORT Matrix2& operator*=(const Matrix2& M); // Matrix multiplication
	...
	GEOM_EXPORT void IdentityMatrix(); // Set to the Identity Matrix
	/*! \remarks Set all elements of this Matrix2 to 0.0f */
	GEOM_EXPORT void Zero(); // Set all elements to 0
	...
	<b>Point2 p</b>\n\n
	The values to set. */
	GEOM_EXPORT void SetRow(int i, Point2 p)
	{
		(*this)[i] = p;
	}
	...
	GEOM_EXPORT Point3 GetColumn(int i);
	...
	GEOM_EXPORT void Translate(const Point2& p);
	/*! \remarks Apply an incremental rotation to this matrix using the
	specified angle.
	\par Parameters:
	<b>float angle</b>\n\n
	Specifies the angle of rotation. */
	GEOM_EXPORT void Rotate(float angle);
	...
	the old way. */
	GEOM_EXPORT void Scale(const Point2& s, bool trans = false);

	// Apply Incremental transformations to this matrix
	// Equivalent to multiplying on the LEFT by transform
	GEOM_EXPORT void PreTranslate(const Point2& p);
	GEOM_EXPORT void PreRotate(float angle);
	GEOM_EXPORT void PreScale(const Point2& s);
	...
	<b>const Point2\& s</b>\n\n
	The values to store. */
	GEOM_EXPORT void SetTranslate(const Point2& s); // makes translation matrix
	/*! \remarks Initializes the matrix to the identity then sets the rotation to the
	specified value.
	\par Parameters:
	<b>float angle</b>\n\n
	The rotation angle in radians. */
	GEOM_EXPORT void SetRotate(float angle); // makes rotation matrix
	...
	GEOM_EXPORT Matrix2 operator*(const Matrix2& B) const;
...
GEOM_EXPORT Matrix2 RotateMatrix(float angle);
...
GEOM_EXPORT Matrix2 TransMatrix(const Point2& p);
...
GEOM_EXPORT Matrix2 ScaleMatrix(const Point2& s);
...
GEOM_EXPORT Matrix2 Inverse(const Matrix2& M);
...
GEOM_EXPORT Point2 operator*(const Matrix2& A, const Point2& V);
/*! \remarks Transforms the specified Point2 with the specified Matrix2.
\par Parameters:
<b>const Point2\& V</b>\n\n
The point to transform.
...
The matrix to transform the point with.\n\n
\return  The transformed Point2. */
GEOM_EXPORT Point2 operator*(const Point2& V, const Matrix2& A);
...
The point to transform.
\return  The transformed Point2. */
GEOM_EXPORT Point2 VectorTransform(const Matrix2& M, const Point2& V);
