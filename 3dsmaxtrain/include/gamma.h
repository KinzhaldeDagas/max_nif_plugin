...
/** \deprecated This class has been deprecated in 3ds Max 2024: Please use \ref MaxSDK::ColorManagement::IColorPipelineMgr which
...
\par Description:
Deprecated gamma manager class: Please use \ref MaxSDK::ColorManagement::IColorPipelineMgr which
provides better color management functionality.
...
class GammaMgr: public MaxHeapOperators 
{
	public:
		...
		/*! \remarks Deprecated! Sets the gamma correction enabled setting. Note
		that this function can only be used to switch between unmanaged and
		gamma color management modes (See
		MaxSDK::ColorManagement::ColorPipelineMode). If the current mode is an
		OCIO based mode, this function will not do anything.   
		\par Parameters: <b>BOOL onOff</b>\n\n TRUE to enable; FALSE to disable.
		*/
		MAX_DEPRECATED // Use MaxSDK::ColorManagement::IColorPipelineMgr to change color management modes.
