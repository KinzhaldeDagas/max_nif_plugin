...
class ClassEntry : public MaxHeapOperators
{
	public:
		...
		CoreExport static int __cdecl CompareClassEntry(const void* elem1, const void* elem2)
		{
			ClassEntry* ce1 = *((ClassEntry**)elem1);
			ClassEntry* ce2 = *((ClassEntry**)elem2);

			if (ce1->ClassName() < ce2->ClassName()) return -1;
			if (ce1->ClassName() > ce2->ClassName()) return 1;
			return 0;
		}
...
/*! \brief This class allows developers to provide some additional information on a superclass.
	...
	\sa  Class SubClassList, <a href="https://msdn.microsoft.com/en-us/library/dd183449(v=vs.85).aspx">COLORREF</a>.
*/
...
/** This class represents the directory of all plug-in classes known to the system.
	...
	See \ref SuperClassIDs "Super Class IDs"
	for a list of these super class ids.
	All methods of this class are implemented by the system. 
	Clients can retrieve the sole instance of ClassDirectory via DllDir::ClassDir() or
