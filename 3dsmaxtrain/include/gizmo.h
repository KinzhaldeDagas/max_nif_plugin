...
class GizmoObject : public HelperObject {
	public:
		...
		*/
		...
		MSTR SubAnimName(int i, bool localized = true) override {return _M("Parameters");}
...
public:
		...
		*/
		...
		virtual Point3 WireColor() { return GetUIColor(COLOR_ATMOS_APPARATUS); }
		...
		void SphereGizmoObject::GetBoundBox(Matrix3 &mat, TimeValue t, Box3 &box) {
			float radius;
			int hemi;
			pblock->GetValue(PB_GIZMO_RADIUS,t,radius);
			pblock->GetValue(PB_GIZMO_HEMI,t,hemi);
