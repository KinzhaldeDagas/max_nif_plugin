...
public:
	...
	/*! \brief Write a formatted string using current locale.
	 * Writes the format string, filled in by the optional arguments.
	 * See the ISO C++ documentation for more information on printf and format strings.
	 * \param format The format specification.
	 * \param ... optional arguments to format.
	 * \pre format is not null.
	 * \pre There are the correct number of optional arguments to fill the format string.
	...
	/*! \brief Write a formatted string using current locale.
	 * Writes the format string, filled in by the optional arguments.
	 * See the ISO C++ documentation for more information on vprintf and format strings.
	 * \param format The format specification.
	 * \param argList va_list to format.
	 * \pre format is not null.
	 * \pre There are the correct number of optional arguments to fill the format string.
	 * \return The number of characters written.
	 */
	...
	/*! \brief Write a formatted string using a specified locale.
	 * Writes the format string, filled in by the optional arguments.
	 * See the ISO C++ documentation for more information on printf and format strings.
	 * \param format The format specification.
...
private:
	 ...
	 * \return The number of characters written.
	 */
	size_t VprintfA(const char* format,    va_list argList);
	 ...
	 * \return The number of characters written.
	 */
	size_t VprintfW(const wchar_t* format, va_list argList);
	 ...
	 * \return The number of characters written.
	 */
	size_t VprintfA_l(const char* format,    const _locale_t theLocale, va_list argList);
	 ...
	 * \return The number of characters written.
	 */
	size_t VprintfW_l(const wchar_t* format, const _locale_t theLocale, va_list argList);
	 ...
	 * \return The number of characters written.
	 */
	size_t PrintfA(const char* format,    ...);
	 ...
	 * \return The number of characters written.
	 */
	size_t PrintfW (const wchar_t* format, ...);
	 ...
	 * \return The number of characters written.
	 */
	size_t PrintfA_l(const char* format, const _locale_t theLocale, ...);
	 ...
	 * \return The number of characters written.
	 */
	size_t PrintfW_l(const wchar_t* format, const _locale_t theLocale, ...);
};
