...
class EaseCurveList : public ReferenceTarget {
   ...
   public:
	  ...
	  */
	  ...
	  the list.
	  \param t - The base time which is eased by the curves.
	  ...
	  // Animatable
	  void GetClassName(MSTR& s, bool localized = true) const override { UNUSED_PARAM(localized); s = MSTR(_M("EaseCurve")); }
...
class MultCurveList : public ReferenceTarget {
   ...
   public:
	  ...
	  resulting value.
	  \param t - The time at which to get the multiplier values.\n\n
	  \param valid - The interval into which the validity of the evaluated parameters is intersected. */
	  ...
	  // Animatable
	  void GetClassName(MSTR& s, bool localized = true) const override { UNUSED_PARAM(localized); s = MSTR(_M("MultCurve")); }
...
//! @{
	  ...
	  NOTE: After this call, the controller and its subcontrollers may
	  contain cached "instant" validity intervals of [t,t], and if immediately
	  evaluated at time t they will reflect this interval, perhaps incorrectly.
	  In order to avoid this problem, it is suggested that immediately after
	  calling ChangeParents, you call GetValue on the controller with a time
	  other than t to force a recompute of these cached validity intervals.
...
//! @{
      ...
      */
	  ...
	  void GetValue(TimeValue t1, void* val1, GetSetMethod method1 = CTRL_ABSOLUTE) { Interval i = FOREVER; GetValue(t1, val1, i, method1); }
	  ...
	  void GetValue(TimeValue t1, void* val1, Interval&&, GetSetMethod method1 = CTRL_ABSOLUTE) { GetValue(t1, val1, method1); }
...
//! @}
	  ...
	  // Driven TM controllers can implement this to prevent plug-ins
	  // deleting their node via the DeleteNode API.
	  /*! \remarks	  This method is called on TM controllers so that system driven controllers
	  ...
	  so driver controllers can easily delete driven nodes if they want to.
	  ...
	  controller. The interval into which the validity of the evaluated parameters is intersected.
...
class StdControl : public Control {
   public:     
	  ...
	  void GetValueLocalTime(TimeValue t, void* val, GetSetMethod method = CTRL_ABSOLUTE)
	  {
		...
		GetValueLocalTime(t, val, interval, method);
	  }
...
class SetXFormPacket: public MaxHeapOperators {
   public:
	  ...
	  <b>const Matrix3\& par=Matrix3{}</b>\n\n
	  The <b>tmParent</b> value. */
	  SetXFormPacket(const Matrix3& mat, const Matrix3& par = Matrix3{})
	  ...
	  <b>const Matrix3\& par=Matrix3{}</b>\n\n
	  The <b>tmParent</b> value.\n\n
	  <b>const Matrix3\& a=Matrix3{}</b>\n\n
	  The <b>tmAxis</b> value. */
	  SetXFormPacket(Point3 pt, const Matrix3& par = Matrix3{},
			const Matrix3& a = Matrix3{})
	  ...
	  <b>const Matrix3\& a=Matrix3{}</b>\n\n
	  The <b>tmAxis</b> value. */
	  SetXFormPacket(Quat qt, BOOL l, const Matrix3& par = Matrix3{},
			const Matrix3& a = Matrix3{})
	  ...
	  <b>const Matrix3\& a=Matrix3{}</b>\n\n
	  The <b>tmAxis</b> value. */
	  SetXFormPacket(AngAxis aA, BOOL l, const Matrix3& par = Matrix3{},
			const Matrix3& a = Matrix3{})
	  ...
	  <b>const Matrix3\& a=Matrix3{}</b>\n\n
	  The <b>tmAxis</b> value. */
	  SetXFormPacket(Point3 pt, BOOL l, const Matrix3& par = Matrix3{},
			const Matrix3& a = Matrix3{})
...
class SetMorphTargetPacket: public MaxHeapOperators {
   public:
	  ...
	  SetMorphTargetPacket(Object *o, MSTR n, BOOL fc = FALSE) { obj = o; name = n; tm = Matrix3{}; forceCreate = fc; }
   };
...
class MorphControl : public Control {
   public:
	  ...
	  \par Default Implementation:
	  <b>{return Matrix3{};}</b> */
	  virtual Matrix3 GetMorphTargTM(int i) { return Matrix3{}; }
...
//-------------------------------------------------------------
// Control base class for Driver Controllers
//

/*! \sa  Class Control.\n\n
\par Description:
This is the base class for Controller Containers. Methods are available to get and
set the sub-controllers, get/set the number of sub-controllers, and add
sub-controllers.  */
class PointControllerContainer : public Control {
   public:
...
For each key of data stored, you can only store 1 chunk of memory of different sizes.
For example, 1 x 4 byte element, 1 x 8 byte element, etc.
\n\n
...
public:
	...
	/*! \remarks TempStore should only be accessed as a singleton. */
	...
	*/
	...
	The stored bytes will be copied into data.
	\par Parameters:
	<b>size_t num_bytes</b>\n\n
	...
	*/
	...
	CoreExport void Clear(const void* key); // Remove single entry
	...
	/*! \remarks Puts an <b>int</b> value in the storage.
	\par Parameters:
	<b>int f</b>\n\n
	The value to store.\n\n
	<b>const void *key</b>\n\n
	...
	/*! \remarks Puts a <b>Point4</b> value to the storage.
	\par Parameters:
	<b>Point4 f</b>\n\n
	The value to store.\n\n
	<b>const void *key</b>\n\n
	...
	/*! \remarks Retrieves a Point4 value from the storage.
	\par Parameters:
	<b>Point4 *f</b>\n\n
	The value to retrieve is stored here.\n\n
	<b>const void *key</b>\n\n
...
private:
	const std::unique_ptr<TempStoreImpl> mImpl;
};
...
/*! \remarks From a super class id determine which default control to use.
 * Use the other GetDefaultController when a ParamType is available. */
CoreExport ClassDesc *GetDefaultController(SClass_ID sid);

/*! \remarks From a super class id and ParamType, determine which default control to use.
 * Ex: A boolean parameter will have a ParamType2 of TYPE_BOOL with a super class CTRL_FLOAT_CLASS_ID.
 * In this case we would expect the default boolean control over the default float control.*/
CoreExport ClassDesc* GetDefaultController(SClass_ID sid, ParamType2 paramType);
