...
public:
	 ...
	 *  \param  [in] stepSrc Source pixel stepping (in pixels). Use 1 to
	 *	        process every pixel.  
	 *  \param  [in] iLinePaddingBytesSrc Source buffer line padding in bytes.
	 *	        Use 0 if the buffer is contiguous.  
	 *  \param  [out] pDst Destination pixel array.  
	 *  \param  [in] stepDst Destination pixel stepping (in pixels). Use 1 to
	 *	        write pixels in order.  
	 *  \param  [in] iLinePaddingBytesDst destination buffer line padding in
