...
template <>
constexpr int ImageLayoutInfo::NumChan<Point3>()
{
	return 3;
}
template <>
constexpr ImageLayoutInfo::ChannelType ImageLayoutInfo::ChanType<Point3>()
{
	return ChannelType::type_float;
}
template <>
constexpr ImageLayoutInfo::ChannelOrder ImageLayoutInfo::ChanOrder<Point3>()
{
	return ChannelOrder::order_rgb;
}
...
template <>
constexpr int ImageLayoutInfo::NumChan<Point4>()
{
	return 4;
}
template <>
constexpr ImageLayoutInfo::ChannelType ImageLayoutInfo::ChanType<Point4>()
{
	return ChannelType::type_float;
}
template <>
constexpr ImageLayoutInfo::ChannelOrder ImageLayoutInfo::ChanOrder<Point4>()
{
	return ChannelOrder::order_rgba;
}
