...
public:
	...
	{
		FLAG_NONE	= 0,
		FLAG_OPTIMIZATION_NONE		= 1ul << 0,	//!< Turn color conversion optimizations off (useful for debugging)
		FLAG_OPTIMIZATION_LOSSLESS	= 1ul << 1,	//!< Perform only lossless optimizations for color conversions (higher quality but slower)
	};
