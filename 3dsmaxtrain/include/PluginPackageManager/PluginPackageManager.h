...
namespace MaxSDK
{
	...
	public:
		...
		enum class Components {
			...
			Hotkeys,
            /// Menus defines the paths to the plugin's menu files. This can be either one or multiple files,
			/// which will be loaded by the UI customization mechanism.
			Menus,
            /// QuadMenus defines the paths to the plugin's quad menu files. This can be either one or multiple files,
			/// which will be loaded by the UI customization mechanism.
			QuadMenus,
