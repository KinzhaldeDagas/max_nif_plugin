...
public:
	...
	<b>bool registerForDuplicateNameCheck</b>\n\n
...
public:
	...
	*/
	...
	/*! \remarks Get import drag & drop import information.
	\par Parameters:
	<b>POINT& screenLocationOut</b>\n\n
	If the import was initiated by a drag & drop operation, the coordinates in the viewport
	window where the drop occurred.\n\n
	\return TRUE if the import is a drag & drop operation; FALSE otherwise.*/
	virtual BOOL			IsDragAndDropImport(POINT& screenLocationOut) = 0;
	/*! \remarks Control use of	interactive placement after import.
	\par Parameters:
	<b>BOOL wantPlacementMode</b>\n\n
	Tells 3ds Max whether the importer wants to use the default placement mode,
	which is entered to finalize the import. Supplying TRUE will cause 3ds Max to
	enter the interactive placement mode after successful import to place the imported
	object(s) into the scene (the default behavior). Supplying FALSE lets the import
	plug-in control the imported object(s) location on a drag & drop.*/
