...
public:
	...
	//! \param[in] iSelIndex Zero-based index into number of geometry selections.
	//! \param[in] fProportion The proportion adjustment.
	...
	//! \brief Get list of material IDs by Object Index.
	//! \param[in] pNode - INode* that contains the projection modifier.
	//! \param[in] iSelIndex - Zero-based index into number of objects.
	//! \param[out] mtlIDs - Tab< int> array of material IDs.
	//! \return int number of material IDs
...
public:
	...
	//! \param[in] pPMod - IProjectionMod Pointer to projection modifier.
	...
	virtual void NotifyInputChanged(const Interval& changeInt, PartID partID, RefMessage message, ModContext *mc, IProjectionModData *pPModData) {}
...
class IProjectionIntersector: public MaxHeapOperators {
	public:
		...
		/*! \param root - The root is normally the object on which the projection modifier is applied.
			...
			\param objectToWorldTM - The object to world transform matrix.*/
		...
		/*! \return true if initialized, false when freed */
