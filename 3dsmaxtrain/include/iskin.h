...
public:
	...
	/*! \remarks Sets the DQ blend weight of an individual vert, this is the amount that the DQ solver will contribute to the deformation
	\par Parameters:
	<b>int index is the index of the vertex you want to set the weight to</b>\n\n
	<b>int v is the weight that DQ will use for this vertex should between 0-1</b>\n\n
	*/
	virtual void SetDQBlendWeight(int index, float v) = 0;
	/*! \remarks Gets the DQ blend weight of an individual vert, this is the amount that the DQ solver will contribute to the deformation
	\par Parameters:
	<b>int index is the index of the vertex you want to get the weight to</b>\n\n
	*/
...
//new stuff
	...
	virtual const MCHAR *GetBoneName(int index) = 0;
	...
	/*! \remarks Returns whether the skin modifier is in DQ blending mode */
	virtual BOOL GetDQBlending() = 0;
	/*! \remarks Sets whether the skin modifier is in DQ blending mode */
...
public:
	...
	MSTR SubAnimName(int i, bool localized = true) override { return _M(""); }
...
// this called in the bonesdef display code to show the gizmo
	...
	\par Default Implementation:
	<b>{ return FALSE; }</b> */
	virtual BOOL IsVolumeBased() const {return FALSE;}
	...
	\par Default Implementation:
	<b>{ return FALSE; }</b> */
	virtual BOOL IsInVolume(Point3 p, Matrix3 tm) const { return FALSE;}
...
// this is passed in from the Map call in bones def
	...
	\par Default Implementation:
	<b>{ return p; }</b> */
	virtual Point3 DeformPoint(TimeValue t, int index, Point3 initialP, Point3 p, Matrix3 tm) const
	{
		return p;
	}
...
// From BaseObject
    ...
    virtual void GetSubObjectCenters(SubObjAxisCallback *cb,TimeValue t,INode *node, Matrix3 tm) {}
	 ...
	 ~{ Sub-Object Coordinate Systems }~. This method differs from its BaseObject version in that
