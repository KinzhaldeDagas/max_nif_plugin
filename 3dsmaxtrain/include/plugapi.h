...
#include "tab.h"
#include "strbasic.h"
#include <Geom/box2.h> // for Rect. Cannot forward declare this.
...
//! 3ds Max R25 (2023) Preview release id
#define MAX_RELEASE_R25_PREVIEW                     24900
//! 3ds Max R25 (2023) release id
#define MAX_RELEASE_R25                                 25000
//! 3ds Max R26 (2024) Preview release id
#define MAX_RELEASE_R26_PREVIEW                     25900
//! 3ds Max R26 (2024) release id
#define MAX_RELEASE_R26                                 26000
//! 3ds Max R27 (2025) Preview release id
#define MAX_RELEASE_R27_PREVIEW                     26900
//! 3ds Max R27 (2025) release id
#define MAX_RELEASE_R27                                 27000
//! 3ds Max R28 (2026) Preview release id
#define MAX_RELEASE_R28_PREVIEW                     27900
//! 3ds Max R28 (2026) release id
#define MAX_RELEASE_R28                                 28000

//! Identifier of the current 3ds Max release
#define MAX_RELEASE MAX_RELEASE_R28
...
- 3ds Max R23 is binary compatible with 3ds Max R22
- 3ds Max R24 is not binary compatible with previous releases
- 3ds Max R25 is not binary compatible with previous releases
- 3ds Max R26 is not binary compatible with previous releases
- 3ds Max R27 is not binary compatible with previous releases
...
//! 3ds Max R23 (2021) Preview SDK; compatible with 3ds Max R22 (2020).
#define MAX_API_NUM_R230_PREVIEW            56
//! 3ds Max R23 (2021) Final SDK; compatible with 3ds Max R22 (2020).
#define MAX_API_NUM_R230                    57
//! 3ds Max R24 (2022) Preview SDK; incompatible with 3ds Max R23 (2021).
#define MAX_API_NUM_R240_PREVIEW            58
//! 3ds Max R24 (2022) Preview 2 SDK; incompatible with 3ds Max R23 (2021).
#define MAX_API_NUM_R240_PREVIEW2       59
//! 3ds Max R24 (2022) Final SDK; incompatible with 3ds Max R23 (2021).
#define MAX_API_NUM_R240                    60
//! 3ds Max R25 (2023) Preview SDK; incompatible with 3ds Max R24 (2022).
#define MAX_API_NUM_R250_PREVIEW            61
//! 3ds Max R25 (2023) Final SDK; incompatible with 3ds Max R24 (2022).
#define MAX_API_NUM_R250                    62
//! 3ds Max R26 (2024) Preview SDK; incompatible with 3ds Max R25 (2023).
#define MAX_API_NUM_R260_PREVIEW            63
//! 3ds Max R26 (2024) Final SDK; incompatible with 3ds Max R25 (2023).
#define MAX_API_NUM_R260                    64
//! 3ds Max R27 (2025) Preview SDK; incompatible with 3ds Max R26 (2024).
#define MAX_API_NUM_R270_PREVIEW            65
//! 3ds Max R27 (2025) Final SDK; incompatible with 3ds Max R26 (2024).
#define MAX_API_NUM_R270                    66
//! 3ds Max R28 (2026) Preview SDK; incompatible with 3ds Max R27 (2025).
#define MAX_API_NUM_R280_PREVIEW            67
//! 3ds Max R28 (2026) Final SDK; incompatible with 3ds Max R27 (2025).
#define MAX_API_NUM_R280                    68
...
#define MAX_API_NUM MAX_API_NUM_R280
...
/** Denotes the revision of the SDK for a given API. This is incremented.
    ...
    not been changed.*/
/** While in beta, increment Rev for beta build.
    */
...
/*! Texture map container super-class ID. This is used by the Standard Material to contain its Texmaps.
    The track view filter code has been modified, so now it looks for this class and will filter it out when maps are being filtered out,
    instead of having special purpose code for the Standard Material.
    This allows plug-in developers to put their Texmaps in a sub-directory like the Standard Material does.
 */
...
#define COMMON_BAKE_MAP_CLASS_ID                0x001152    //!< Bake To Texture - Common Bake Map super-class ID.
#define COMMON_BAKE_MAP_OPERATOR_CLASS_ID   0x001153    //!< Bake To Texture - Common Bake Map Operator super-class ID.
...
#define ANY_OBJECT_CLASS_ID     0x0000ac //!< 'any' pseudo super-class ID - Applicable to Modifier InputType, says any object allowed as input.
//!@}
...
#define POINT2_XREFCTRL_CLASS_ID    Class_ID(0x414be32f, 0x482b21af) //!< point2 type XRef control class ID
...
#define PHYSICALMATERIAL_CLASS_ID       Class_ID(0x3d6b1cec, 0xdeadc001) //!< Physical Material Class ID
#define OPENPBR_CLASS_ID                Class_ID(0xf1551e33, 0x37fb1337) //!< OpenPBR Material Class ID
//!@}
...
#define MULTIOUTPUTTOMTL_CLASS_ID           Class_ID(0x31054882, 0x19bc6d6d) //!< MultiOutputToMtl material
#define COMPOUND_MAP_CLASS_ID               Class_ID(0x516f39d9, 0x232d7929) //!< CompoundMap
...
class ClassDesc: public MaxHeapOperators {
    ...
    public:
        ...
        This method was added in 3ds Max 2022 to provide more consistent scripting behavior in localized versions of 3ds Max.
        In versions of 3ds Max prior to 2022, MAXScript used the name returned from ClassName() (unless
        UseOnlyInternalNameForMAXScriptExposure() returns true) as (one of) the global variable name(s) holding the MAXClass
        value which exposes this class.
        In 3ds Max 2022 and later, MAXScript uses the name returned from NonLocalizedClassName() (unless
        UseOnlyInternalNameForMAXScriptExposure() returns true) as (one of) the global variable name(s) holding the MAXClass
        value which exposes this class.
        To maintain scripting compatibility with older versions of 3ds Max, the name returned should be the ClassName returned
        for locale en-US in versions of 3ds Max prior to 2022.
        \return  The non-localized name of the class. */
        virtual const MCHAR*    NonLocalizedClassName() = 0;

        /** Returns a string which provides a fixed, machine parsable internal name for the plug-in. This name is used by
        Scripting Engines. MAXScript uses this name (if not null) as (one of) the global variable name(s) holding the MAXClass
        value which exposes this class.*/
