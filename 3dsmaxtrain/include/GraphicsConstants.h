...
//!@{
//! \deprecated Deprecated as of 3ds Max 2022 Heidi is not a supported graphics driver.
#pragma deprecated("GW_HEIDI")

#define GW_OPENGL			1
#define GW_DIRECT3D			2
//! \deprecated Deprecated as of 3ds Max 2022 Heidi is not a supported graphics driver.
#pragma deprecated("GW_HEIDI3D")//! \deprecated Deprecated as of 3ds Max 2022 Heidi is not a supported graphics driver.

#define GW_NULL				4
//! \deprecated Deprecated as of 3ds Max 2022 Customized drivers are not a supported graphics driver.
#pragma deprecated("GW_CUSTOM")
...
#define GW_GAMMA_CORRECT		0x4000000 //!< Enable gamma correct. Only used for post scene callbacks
//!@}
...
#define GW_FRONT_PLANE		0x1000 //Please note that, for historical reasons, this plane is the plane behind the camera, despite of its name.
#define GW_BACK_PLANE		0x2000 //Please note that, for historical reasons, this plane is the plane in front of the camera, despite of its name.
...
/// \defgroup Dual_Plane_Buffer_Types Dual Plane Buffer Types
//!@{
