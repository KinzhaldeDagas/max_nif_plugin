...
public:
	...
	// from Animatable
	SClass_ID SuperClassID() override { return kLayerSuperClassID; }
	...
	/*! \remarks Sets the wire frame color.
		\param newcol - See <a href="https://msdn.microsoft.com/en-us/library/dd183449(v=vs.85).aspx">COLORREF</a>.
	...
	/*! \remarks Returns true if hidden; false if not hidden. 
		\param includeParent - Use true to get "by layer" hidden state; false for the object permanent hidden state.
	A child layer is considered hidden by layer when his parent is hidden (by layer or permanently),
	regardless of its permanent state, which is preserved when hiding through a parent layer. */
	...
	/*! \remarks Returns true if frozen; false if not frozen. 
		\param includeParent - Use true to get "by layer" frozen state; false for the object permanent frozen state.
	A child layer is considered frozen by layer when his parent is frozen (by layer or permanently),
	regardless of its permanent state, which is preserved when freezing through a parent layer. */
