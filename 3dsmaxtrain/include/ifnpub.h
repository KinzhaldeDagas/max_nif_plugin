...
\ref fpStatusValues, ~{ %Function Publishing }~.\n\n
\par Description:
...
public:
	...
	CoreExport virtual FunctionID	FindFn(const MCHAR* name);
...
/*! \sa  Class FPInterface,  Class ClassDesc,  Class Interface_ID, Class FPEnum, Class FPFunctionDef, Class FPPropDef, Class ActionTable, Template Class Tab, ~{ %Function Publishing }~.\n\n
\par Description:
...
public:
	...
	CoreExport virtual const MCHAR* GetRsrcString(StringResID id);
...
#define FP_CORE				0x0004	// if ClassDesc* is not specified, marks this as a MAX Core Interface, available through GetCOREInterface(Interface_ID) 
									// if ClassDesc* is specified, marks this as a Static interface available through the ClassDesc 
...
#define	FP_TEMPORARY		0x2000	// temporary descriptor built during scene load to support schema migration
...
// mixin interface
/*! \sa  Class FPInterface, Class FPInterfaceDesc, ~{ %Function Publishing }~.\n\n
\par Description:
...
/*! \sa  Class FPInterface, Class FPInterfaceDesc, Class FPActionDef, Class FPParamDef, Template Class Tab, ~{ %Function Publishing }~, 
::ParamType, 
::ParamType2.\n\n
\par Description:
...
public:
	...
	int				scriptSecurityFeature; // the MaxSDK::ISceneScriptSecurityManager::ScriptingFeature, if specified, for the function. The 'flags' member will have its FP_EMBEDDEDSCRIPTSECURITYFEATURE bit set.

	/*! \remarks Constructor.  The data members are initialized as
	follows:\n\n
	<b>flags = 0; description = 0; action_def = NULL; enumID = FP_NO_ENUM;</b>
	*/
	FPFunctionDef() : result_type(TYPE_ANGLE), ID(0) { cbStruct = sizeof(FPFunctionDef); flags = 0; description = 0; action_def = NULL; enumID = FP_NO_ENUM; keyparam_count = 0; scriptSecurityFeature = 0;  }
	CoreExport ~FPFunctionDef();
};

/*! \sa  Class FPParamOptions, ::ParamType, ::ParamType2\n\n
\par Description:
...
public:
	...
	FPPropDef() : prop_type(TYPE_ANGLE) { cbStruct = sizeof(FPPropDef); flags = 0; description = 0; getter_ID = setter_ID = FPS_NO_SUCH_FUNCTION; enumID = FP_NO_ENUM; setter_param = NULL; }
...
#define FP_EMBEDDEDSCRIPTSECURITYFEATURE 0x0008 // invoking action is subject to ISceneScriptSecurityManager settings. When this is specified, next value
		   // is a MaxSDK::ISceneScriptSecurityManager::ScriptingFeature value

// internal function bits
#define FP_ACTION			  0x0100	// indicates an action function
#define FP_HAS_UI			  0x0200	// action has UI specified
#define FP_ICONRES			  0x0400	// icon via res ID
#define FP_ICONFILE			  0x0800	// icon via bmp file + index
#define FP_HAS_SHORTCUT		  0x1000	// has default KB shortcut
...
/*! \sa  Class FPInterface, Class FPInterfaceDesc, Class FPActionDef, Class FPParamDef, Template Class Tab, Class MaxIcon, ~{ %Function Publishing }~, 
\ref ControlTypeList, 
...
enum {
	...
	f_embeddedScriptSecurityFeature, // invoking action is subject to ISceneScriptSecurityManager settings. When this
									 // is specified, next value is a
									 // MaxSDK::ISceneScriptSecurityManager::ScriptingFeature value

	// param and property options
	...
	f_keyArgDefault,				// marks this as an optional keyArg param and gives default value which must be of type to match param type, If the param type is a _BR type, the default value must be specified as a pointer to the default value.
	f_embeddedScriptSecurityFeature_r, // invoking getter function is subject to ISceneScriptSecurityManager settings.
									   // Note that this option should only be used in the 'properties' section of the descriptor.
									   // When this option is specified, the next value is a
									   // MaxSDK::ISceneScriptSecurityManager::ScriptingFeature value

	f_embeddedScriptSecurityFeature_w, // invoking setter function is subject to ISceneScriptSecurityManager settings.
									   // Note that this option should only be used in the 'properties' section of the descriptor.
									   // When this option is specified, the next value is a
									   // MaxSDK::ISceneScriptSecurityManager::ScriptingFeature value

	f_embeddedScriptSecurityFeature_rw, // invoking getter and setter functions are subject to ISceneScriptSecurityManager settings.
									   // Note that this option should only be used in the 'properties' section of the descriptor.
										// When this option is specified, the next value is a
										// MaxSDK::ISceneScriptSecurityManager::ScriptingFeature value
...
#define FPP_HAS_EMBEDDEDSCRIPTSECURITYFEATURE_R 0x0040 // getter function is subject to ISceneScriptSecurityManager settings
#define FPP_HAS_EMBEDDEDSCRIPTSECURITYFEATURE_W 0x0080 // setter function is subject to ISceneScriptSecurityManager settings
#define FPP_HAS_EMBEDDEDSCRIPTSECURITYFEATURE_RW 0x00C0 // getter and setter functions are subject to ISceneScriptSecurityManager settings

/*! \sa  ::ParamType, ::ParamType2, 
...
this param.  If the parameter type is a _BR type, the default value must 
be specified as a pointer to the default value.\n\n
<b>FPParamOptions* options;</b>\n\n
...
/*! This parameters class contains a MaxSDK::Array FPValue's. FPValue is the
	actual parameter for an FP Function call. */
...
public:
	...
	/*!	Constructor using variable args.
		...
		\param count - The number of parameter values to add. */
...
public:
	...
	*/
	...
	/*! \param [in] paramType - The ParamType2 type to set the FPValue to.
	...
	*/
	inline    void Load(int paramType, ...) { va_list ap; va_start(ap, paramType); ap = Loadva(paramType, ap); va_end(ap); }
	/*! \remarks This method will load the FPValue class with the provided
	data.
	\par Parameters:
	<b>int paramType</b>\n\n
	...
	This method takes a variable number of arguments.
	*/
	inline    void LoadPtr(int paramType, ...) { va_list ap; va_start(ap, paramType); ap = Loadva(paramType, ap, true); va_end(ap); }
...
/*! \sa  Class FPValue, ::ParamType, ::ParamType2,
Template Class Tab.\n\n
\par Description:
...
public:
	...
	int scriptSecurityFeature_r; // the MaxSDK::ISceneScriptSecurityManager::ScriptingFeature, if specified, for the
								 // getter function, The 'flags' member of owning FPParamDef will have its
								 // FPP_HAS_EMBEDDEDSCRIPTSECURITYFEATURE_R bit set
	int scriptSecurityFeature_w; // the MaxSDK::ISceneScriptSecurityManager::ScriptingFeature, if specified, for the
								 // setter function, The 'flags' member of owning FPParamDef will have its
								 // FPP_HAS_EMBEDDEDSCRIPTSECURITYFEATURE_W bit set

	/*! \remarks Constructor. */
	FPParamOptions() : cbStruct(sizeof(FPParamOptions)), validator(NULL), scriptSecurityFeature_r(0), scriptSecurityFeature_w(0) { }
};

// virtual base class for parameter validation objects
/*! \sa  Class InterfaceServer, Class FPInterfaceDesc, Class FPValue, Class Interface_ID, ~{ %Function Publishing }~.\n\n
\par Description:
...
/*! \sa  Class BaseInterfaceServer,  Class FPInterface,  Class FPInterfaceDesc, ~{ %Function Publishing }~, Class InterfaceServer,\n\n
\par Description:
...
\par Example
\snippet maxsdk/howto/functionpublishing/simplefp/IObjectDemo.cpp
*/
...
public:
	...
	\par Default Implementation:
	<b>{ return _M(""); }</b> */
	virtual const MCHAR* GetIObjectName() { return _M(""); }
...
// base exception class for function published exceptions.  Function published functions 
//  can throw instances of this class or subclasses to signal error conditions.
/*! \sa  Class FPInterfaceDesc, ~{ %Function Publishing }~.\n\n
\par Description:
...
public:
	...
	\par Default Implementation:
	<b>{}</b> */
	MAXException(const MSTR& msg, int code=0) : message(msg), error_code(code) { }

	/*! \remarks Destructor.*/
	virtual ~MAXException() {}
};

/*!  3ds Max security exception class for function published exceptions.  Function published functions can throw 
  instances of this class or subclasses to signal error conditions related to software security.
  For example, the 3ds Max Python Host FPS interface throws an instance of this class
  when attempting to evaluate a python string or file, and evaluation of python string or file
  from MAXScript is disabled by ISceneScriptSecurityManager.
  A MAXSecurityException exception caught by MAXScript is rethrown as a SecurityException, and its 
  message is always displayed in Listener and logged to the 3ds Max log file.
*/
class MAXSecurityException : public MAXException
{
public:
	/*! \remarks Constructor. The data members are initialized to the values
	passed.
	...
	\par Default Implementation:
	<b>{}</b> */
	MAXSecurityException(const MSTR& msg, int code = 0)
		: MAXException(msg, code)
	{
	}
};
...
#define TYPE_MAXGUID_FIELD(_v)				(*((_v).maxGuid))
...
#define TYPE_MAXGUID_TAB_FIELD(_v)			(((_v).maxGuid_tab))
...
#define TYPE_MAXGUID_BR_FIELD(_v)				(*((_v).maxGuid))
...
#define TYPE_MAXGUID_TAB_BR_FIELD(_v)			(*((_v).maxGuid_tab))
...
#define TYPE_MAXGUID_BV_FIELD(_v)			(*((_v).maxGuid))
...
#define TYPE_MAXGUID_TAB_BV_FIELD(_v)			(*((_v).maxGuid_tab))
