...
const ColorId kToolTipBackground = 9; //!< \deprecated As of 3ds Max 2019, use kToolTipViewportBackground instead.
const ColorId kToolTipViewportBackground = 9; //!< Tooltip background color for the Viewport
const ColorId kToolTipText   = 10; //!< \deprecated As of 3ds Max 2019, use kToolTipViewportBackground instead.
const ColorId kToolTipViewportText = 10; //!< Tooltip text color for the Viewport
...
const ColorId kToolTipUiBackground = 127; //!< Tooltip background color for the common Max UI
const ColorId kToolTipUiText = 128; //!< Tooltip text color for the common Max UI

const ColorId kItemViewBackground = 129; //!< Background color for ItemView component
const ColorId kItemViewAlternateBackground = 130; //!< Alternate background color for ItemView component
