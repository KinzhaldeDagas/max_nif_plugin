...
/** Enumeration indexing axes of Cartesian coordinate system, in either
    possible sense, consistent with return value for UVWMapper::MainAxis
    function. */
enum CartesianAxisType
{
    ...
    NEGATIVE_Y             = 4,
    NEGATIVE_Z             = 5,
    N_CARTESIAN_AXIS_TYPES = 6
};

/** Enumeration indexing axes of Cylindrical coordinate system, including
    both possible senses of the cylindrical axial direction. */
