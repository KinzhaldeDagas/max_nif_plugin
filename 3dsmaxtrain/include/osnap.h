...
public:
	...
	*/
	...
	fails to override this method, the snap will be added to the "standard" page
	of the UI.
	\par Default Implementation:
	<b>{return NULL;}</b> */
	DllExport virtual const MCHAR *Category();//JH 01/04/98 {return NULL;}
	...
	Developers wishing to use callbacks should override this method to return
	...
	*os) {</b>\n\n
	...
	snap. Typically, some part of the objects geometry is illuminated. In some
	...
	will be highlighted. The description of this geometry is recorded in the
	...
	/*! \remarks Developers may override this method to do additional hit testing on each
	...
	/*! \remarks Returns the reference to the snap's icon name 
	\par Parameters:
	<b>int index</b>\n\n
...
/*!	\sa Class Osnap
	\par Description:
	This class extends/decorates class Osnap with a few useful methods. 
...
class OSnapDecorator : public Osnap
{
	public:
		...
		DllExport virtual const MCHAR *Category();
		...
		DllExport virtual MSTR iconName(int index) const;
