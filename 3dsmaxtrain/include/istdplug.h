...
*/
//!@{
/*! \anchor paramBlock_param_IDs_arc 
\name Arc Parameter Block param IDs
*/
//!@{
#define ARC_RADIUS		0
#define ARC_FROM		1
...
/*! \anchor paramBlock2_IDs_boxObject
\name Box Object Parameter Block2 IDs */
//!@{
#define BOXOBJ_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_boxObject
\name Box Object Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_geosphere
\name Geosphere Parameter Block2 IDs */
//!@{
#define GEOSPHERE_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_geosphere
\name Geosphere Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_circle
\name Circle Parameter Block param IDs */
//!@{
#define CIRCLE_RADIUS		0
//!@}

/*! \anchor paramBlock2_IDs_cone
\name Cone Parameter Block2 IDs */
//!@{
#define CONE_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_cone
\name Cone Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_cylinder
\name Cylinder Parameter Block2 IDs */
//!@{
#define CYLINDER_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_cylinder
\name Cylinder Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_donut 
\name Donut Parameter Block param IDs */
//!@{
#define DONUT_RADIUS1		0
#define DONUT_RADIUS2		1
//!@}

/*! \anchor paramBlock_param_IDs_ellipse 
\name Ellipse Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_hedra 
\name Hedra Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_helix 
\name Helix  Parameter Block param IDs*/
//!@{
...
/*! \anchor paramBlock_param_IDs_ngon
\name NGon Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_patchGrid
\name PatchGrid Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_rainSnow
\name Rain/Snow Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_rectangle
\name Rectangle Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_sphere
\name Sphere Parameter Block2 IDs */
//!@{
#define SPHERE_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock_param_IDs_sphere
\name Sphere Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_torus
\name Torus Parameter Block2 IDs */
//!@{
#define TORUS_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_torus
\name Torus Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_capsule
\name Capsule Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_star
\name Star Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_teapot
\name Teapot Parameter Block2 IDs */
//!@{
#define TEAPOT_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_teaPot
\name Tea Pot Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_text
\name Text Parameter Block param IDs */
//!@{
#define TEXT_SIZE 0
...
/*! \anchor paramBlock2_IDs_tube
\name Tube Parameter Block2 IDs */
//!@{
#define TUBE_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_tube
\name Tube Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_grid
\name Grid Parameter Block2 IDs */
//!@{
#define GRIDHELP_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_grid
\name Grid Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_prism
\name Prism Parameter Block2 IDs */
//!@{
#define PRISM_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_prism
\name Prism Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_pyramid
\name Pyramid Parameter Block2 IDs */
//!@{
#define PYR_PARAMBLOCK_ID		2
//!@}


/*! \anchor paramBlock2_param_IDs_pyramid
\name Pyrmaid Parameter Block2 param IDs */
//!@{
#define PYR_WIDTH	0
#define PYR_DEPTH	1
#define PYR_HEIGHT	2
...
/*! \anchor paramBlock2_IDs_chbox
\name Chamfer Box Parameter Block2 IDs */
//!@{
#define CHBOX_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_chbox
\name Chamfer Box Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_chcyl
\name Chamfer Cylinder Parameter Block2 IDs */
//!@{
#define CHCYL_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_chcyl
\name Chamfer Cylinder Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_lext
\name L-Ext Parameter Block2 IDs */
//!@{
#define LEXT_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_lext
\name L-Ext Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock2_IDs_cext
\name C-Ext Parameter Block2 IDs */
//!@{
#define CEXT_PARAMBLOCK_ID		2
//!@}

/*! \anchor paramBlock2_param_IDs_cext
\name C-Ext Parameter Block2 param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_bend 
\name Bend Parameter Block param IDs*/
//!@{
#define BEND_ANGLE		0
#define BEND_DIR		1
#define BEND_AXIS		2
...
/*! \anchor paramBlock_param_IDs_bomb
\name Bomb Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_deflector
\name Deflector Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_displace Displace
\name  Parameter Block param IDs
...
/*! \anchor paramBlock_param_IDs_extrude 
\name Extrude Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_gravity
\name Gravity Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_wind
\name Wind Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_uvwMap
\name UVW Map Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_noiseMod 
\name Noise Mod Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_optimize
\name Optimize Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_volumeSelectionModifier
\name Volume Selection Modifier Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_rippleWaveModifier
\name Ripple/Wave Modifier Parameter Block param IDs
...
/*! \anchor paramBlock_param_IDs_rippleWaveBinding 
\name Ripple/Wave Binding (modifier) Parameter Block param IDs */
//!@{
#define RWAVE_FLEX			0
//!@}

/*! \anchor paramBlock_param_IDs_skew 
\name Skew Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_materialModifier
\name Material Modifier Parameter Block param IDs */
//!@{
#define MATMOD_MATID 0
//!@}

/*! \anchor paramBlock_param_IDs_smoothingGroupModifier 
\name Smoothing Group Modifier Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_normalModifier
\name Normal Modifier Parameter Block param IDs */
//!@{
#define NORMMOD_UNIFY	0
#define NORMMOD_FLIP 	1
//!@}

/*! \anchor paramBlock_param_IDs_surfRevModifier
\name SurfRev (Lathe) Modifier Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_taper
\name Taper Parameter Block param IDs */
//!@{
#define TAPER_AMT			0
#define TAPER_CRV			1
#define TAPER_AXIS			2
...
/*! \anchor paramBlock_param_IDs_twist
\name Twist Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_materialMod
\name Material Mod Parameter Block param IDs */
//!@{
#define MATMOD_MATID	0
//!@}

/*! \anchor paramBlock_param_IDs_smoothMod
\name Smooth Mod Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_normalMod
...
/*! \anchor paramBlock_param_IDs_tessellationMod
\name Tessellation Mod Parameter Block param IDs */
//!@{
...
/*! \anchor paramBlock_param_IDs_uvmXform
\name UVW Xform Parameter Block param IDs */
//!@{
...
/*! \anchor keyFlagBits_generalFlags 
\name General Key Flags
*/
//!@{
...
/*! \anchor keyFlagBits_tcbSpecific
\name TCB-specific Key Flags */
//!@{
#define TCBKEY_QUATVALID	(1<<4) //!< Angle/axis is derived from the quat instead of vice/versa
//!@}

/*! \anchor keyFlagBits_bezierSpecific
\name Bezier-specific Key Flags */
//!@{
...
/*! \anchor keyFlagBits_inOutTypes
\name In and Out types
Stored in bits 7-13 */
//!@{
...
/*! \anchor keyFlagBits_bezierTangentTypes
\name Bezier Tangeant Types */
//!@{
...
/*! \anchor keyFlagBits_macros
\name Key Flagbit Macros */
//!@{
...
/*! \anchor keyFlagBits_hybridTangeantAccessMacros
\name Macros to Access Hybrid Tangent Types */
//!@{
...
// Key/HitTrackRecord flags
// KEY_XSEL, KEY_YSEL, KEY_ZSEL, and KEY_WSEL are also used to identify the component
#define HITKEY_INTAN	(1<<22) // User has selected the "in tangent" handle of a key
#define HITKEY_OUTTAN	(1<<23) // User has selected the "out tangent" handle of a key
#define HITKEY_TIME		(1<<24) // User has selected the time (frame number text) of a key
#define HITKEY_KEY		(1<<25) // User has selected the key position itself
#define HITKEY_ANY		(HITKEY_INTAN|HITKEY_OUTTAN|HITKEY_TIME|HITKEY_KEY)
static_assert((HITKEY_ANY&IKEY_ALLSEL) == 0,
			  "HITKEY_* flags in conflict with IKEY_ALLSEL");
static_assert((HITKEY_ANY&(IKEY_VALX_LOCK|IKEY_VALY_LOCK|IKEY_VALZ_LOCK|IKEY_VALA_LOCK)) == 0,
			  "HITKEY_* flags in conflict with IKEY_VAL*_LOCK");
static_assert((HITKEY_ANY&TCBKEY_QUATVALID) == 0,
			  "HITKEY_* flags in conflict with TCBKEY_QUATVALID");
static_assert((HITKEY_ANY&(BEZKEY_XBROKEN|BEZKEY_YBROKEN|BEZKEY_ZBROKEN|BEZKEY_WBROKEN)) == 0,
			  "HITKEY_* flags in conflict with BEZKEY_*BROKEN");
static_assert((HITKEY_ANY&(BEZKEY_TYPEMASK<<BEZKEY_INTYPESHIFT)) == 0,
			  "HITKEY_* flags in conflict with BEZKEY_INTYPE flags");
static_assert((HITKEY_ANY&(BEZKEY_TYPEMASK<<BEZKEY_OUTTYPESHIFT)) == 0,
			  "HITKEY_* flags in conflict with BEZKEY_OUTTYPE flags");
static_assert((HITKEY_ANY&BEZKEY_CONSTVELOCITY) == 0,
			  "HITKEY_* flags in conflict with BEZKEY_CONSTVELOCITY");
static_assert((HITKEY_ANY&BEZKEY_UNCONSTRAINHANDLE) == 0,
			  "HITKEY_* flags in conflict with BEZKEY_UNCONSTRAINHANDLE");
...
/*! \sa  Class Animatable, Class IKey,  Class Control,  \ref SuperClassIDs "Super Class IDs",
...
// An interface for supporting tangent adjustment at a given time (as opposed to by selection)
// Retrievable via GetTangentInterface(anim)
class IAdjustTangents: public MaxHeapOperators {
	public:
	/*! Retrieves the value of the tangent at the nearest key to the given time, based on the given hitFlags. */
	virtual bool GetTangents(TimeValue t, int element, DWORD hitFlags, ParamDimensionBase *dim, float *angle, float *length, DWORD *flags, DWORD *kflags)=0;
	/*! Sets the value of the tangent at the nearest key to the given time, based on the given hitFlags. */
	virtual bool AdjustTangents(TimeValue t, int element, DWORD hitFlags, ParamDimensionBase *dim, float angle, float length, DWORD flags, DWORD kflags)=0;
	/*! Retrieves the flags of the key at the given time, or -1 if no such key exists */
	virtual DWORD GetKeyFlags(TimeValue t)=0;
	};
...
CoreExport void *GetAppDataChunk(void *appd, DWORD len, const char *idstring);
...
// an object whose class ID is NEWBOOL_CLASS_ID, 
// you can cast that pointer to the following
// class.  Note there is no Optimize parameter in the new Boolean.
//
...
to an object whose ClassID is NEWBOOL_CLASS_ID, you can cast that
pointer to this class and use the methods to access the parameters.
...
class ILookAtConstRotation : public Control , public FPMixinInterface {
	public:
		...
		enum {	get_num_targets, get_node, get_target_weight,
				set_target_weight, append_target, delete_target,
				get_vector_line_length, set_vector_line_length,
		};
		...
		FN_2(append_target,			TYPE_BOOL, AppendTarget, TYPE_INODE, TYPE_FLOAT);
		FN_1(delete_target,			TYPE_BOOL, DeleteTarget, TYPE_INDEX);
		PROP_FNS(get_vector_line_length, GetVectorLineLength, set_vector_line_length, SetVectorLineLength, TYPE_FLOAT);
		END_FUNCTION_MAP
		...
		*/
		...
		/*! \remarks Sets the vector line length of one of the Look-At nodes that the Look-At
		constraint controller follows.
		\param len The vector line length to set. */
		virtual void SetVectorLineLength(float len) = 0;

		/*! \remarks Gets the vector line length of one of the Look-At nodes that the Look-At
		constraint controller follows.\n\n */
		virtual float GetVectorLineLength() const = 0;
	};
...
pointer to the link controller interface by calling GetInterface(Interface_ID id) on the
controller instance, as in this example:
\code
Control* control; // the controller whose link controller interface we want to access
ILinkCtrl* linkCtrl = (ILinkCtrl*)(control->GetInterface(LINK_CONSTRAINT_INTERFACE));
\endcode
\par
Developers may use the following values to access the references of the Link
controller:
 - LINKCTRL_CONTROL_REF -The TM controller
 - LINKCTRL_FIRSTPARENT_REF - The index of the first parent node. 
 - LINKCTRL_PBLOCK_REF - The parameter block.
...
//		BOOL AddWorld(int frameNo)=0;
		...
		/*!
		This method returns the parent transformation matrix containing the combined link TM for a given time
		\par Parameters:
		<b>TimeValue t</b>\n\n
		The time at which to get the TM.
		<b>Interval *valid</b>\n\n
		The interval to get the TM.
		*/
		virtual Matrix3 GetParentTM(TimeValue t, Interval *valid=NULL) = 0;
...
#define TMLIST_CONTROL_CLASS_ID			0x4b4b1006
...
DRIVERBLOCKLIST_CONTROL_CLASS_ID, TMLIST_CONTROL_CLASS_ID.</b>\n\n
All methods of this class are Implemented by the System.  */
class IListControl : public Control, public FPMixinInterface {
	public:
		...
		BEGIN_FUNCTION_MAP
			...
			FN_1		(list_setIndexByName,	TYPE_BOOL,	SetIndexByName, TYPE_STRING);
		END_FUNCTION_MAP
		#pragma warning(pop)
		...
		//Get set list controller tags
		virtual MSTR GetTag() const = 0;
		virtual void SetTag(const MSTR& tag) = 0; 
		/*! \remarks This method returns the number of items that appear in
		the List controllers list box. */
		virtual int	 GetListCount() const =0;
		/*! \remarks Set the actice control in the list. The active controller in
		the list displays its parameter rollouts appear in the motion panel
		Any manipulation of the list controller is passed into this active control.
		 When in Weight mode, this method sets teh weight mode active control.
		 When in Index mode, this sets the index property value.
		\par Parameters:
		<b>int index</b>\n\n
		The index of the item to set as the active item. */
		virtual void SetActive(int index)=0;
		/*! \remarks When in weight mode, this method returns the index of the currently active
		item. When in index mode, this returns the current active index.*/
		virtual int	 GetActive() const =0;
		//! \remarks Set the Index mode index property using the list entry name that is the best match
		// with the entryNameMatch argument. Can still set the index when not in index mode.
		//! \return - True if a match was found and the index was set.
		//! \param[in] entryNameMatch - The case insensitive search string. Best match closest to beginning of the name is chosen.
		// Ex: "pos" will match "somePos" over "anotherpos".
		virtual bool SetIndexByName(MSTR entryNameMatch) =0;
		...
		//! Getter for wether or not the list controller is in weight mode or index mode. Default is false, weight mode.
		// Weight mode uses the table of weights to blend the controllers in the list together.
		// Index mode acts as a switcher and only the controllers value at that index is expressed.
		//! \return - True if the list control is in index mode. 
		virtual bool IsIndexMode() const = 0;
};
...
public:
	...
	virtual void SetVertSel(const BitArray &set, IMeshSelect *imod, TimeValue t)=0;
	...
	This parameter is available in release 3.0 and later only.\n\n
	The current time at which the call is made. */
	virtual void SetFaceSel(const BitArray &set, IMeshSelect *imod, TimeValue t)=0;
	...
	This parameter is available in release 3.0 and later only.\n\n
	The current time at which the call is made. */
	virtual void SetEdgeSel(const BitArray &set, IMeshSelect *imod, TimeValue t)=0;
...
/*! \sa  Class Animatable, ~{ Shapes and Splines }~.\n\n
\par Description:
...
/*! \sa  Class ISplineSelect, Class Animatable, Class BitArray, ~{ Shapes and Splines }~, Class GenericNamedSelSetList.\n\n
\par Description:
When a developer gets the <b>LocalModData</b> from the <b>ModContext</b> of the
...
/*! \sa  Class ISplineSelect, Class Animatable, ~{ Shapes and Splines }~.\n\n
\par Description:
...
/*! \sa  Class Animatable, ~{ Patches and Faces }~.\n\n
\par Description:
...
/*! \sa  Class IPatchSelect, Class Animatable, Class BitArray, ~{ Patches and Faces }~, Class GenericNamedSelSetList.\n\n
\par Description:
When a developer gets the <b>LocalModData</b> from the <b>ModContext</b> of the
...
/*! \par Description:
	...
	in one way wires where this controller is the driver. In addition when the controller is replaced and collapsed the
...
//! \brief An Animatable interface for controllers that can be buffered
/*! Controllers that support this interface can take a copy of themselves in a buffer and restore it.
The interface ID is I_BUFFERABLE defined in AnimatableInterfaceIDs.h.
*/
class IBufferable: public MaxHeapOperators {
public:
	/*! \brief Interchange the controller and its buffer. 
	\return true if the swap was made successfully
	*/
	virtual bool SwapWithBuffer() = 0;		// 
	/*! \brief Make the buffer equal to this controller. 
	//! \param [in] createOnly - if true, only take a snapshot if no buffer currently exists 
	\return true if the Snapshot was made successfully
	*/
	virtual bool Snapshot(bool createOnly = false) = 0;
	/*! \brief Make this controller equal to its buffer. 
	\return true if the Revert was made successfully
	*/
	virtual bool RevertToBuffer() = 0; 
