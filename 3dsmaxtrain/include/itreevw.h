...
public:
	...
	virtual MaxSDK::MaxGuid GetMenuBarGuid() const = 0;
	virtual void SetMenuBarGuid(const MaxSDK::MaxGuid& id) = 0;

	virtual MaxSDK::MaxGuid GetControllerQuadMenuGuid() const = 0;
	virtual void SetControllerQuadMenuGuid(const MaxSDK::MaxGuid& quadId) = 0;
	virtual MaxSDK::MaxGuid GetKeyQuadMenuGuid() const = 0;
	virtual void SetKeyQuadMenuGuid(const MaxSDK::MaxGuid& quadId) = 0;
	...
	BEGIN_FUNCTION_MAP
		...
		PROP_FNS(tv_getMenuBar, GetMenuBarGuid, tv_setMenuBar, SetMenuBarGuid, TYPE_MAXGUID_BV);
		PROP_FNS(tv_getControllerQuadMenu, GetControllerQuadMenuGuid, tv_setControllerQuadMenu, SetControllerQuadMenuGuid, TYPE_MAXGUID_BV);
		PROP_FNS(tv_getKeyQuadMenu, GetKeyQuadMenuGuid, tv_setKeyQuadMenu, SetKeyQuadMenuGuid, TYPE_MAXGUID_BV);
...
#define ID_TV_DELETE_CUSTOM_ATTRIBUTES	2430
