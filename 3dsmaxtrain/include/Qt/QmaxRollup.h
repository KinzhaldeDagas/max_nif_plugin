...
namespace MaxSDK
{
	 ...
	 * inadvertently changing values of controls. Wheel events are filtered for children that inherit
	 * from QAbstractSpinBox, QLineEdit, QAbstractSlider, QComboBox, and QCalendarView.
	 */
