...
namespace QtHelpers
{
	...
	* of the icon.
	* \param[in] iconName - The name of the icon to load.
	* \param[out] numIcons - the number of elements in the returned array.
	* \return An array of HIcon containing the HIcons of the loaded icons. Must be destroyed 
	*                  by the caller function.
	* \note The returned HICON array must be destroyed by the user. Also, the user has to call DestroyIcon
