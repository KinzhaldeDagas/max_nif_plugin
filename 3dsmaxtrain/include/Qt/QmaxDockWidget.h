...
public:
	...
	explicit QmaxDockWidget( const QString& objectName, const QString& title, QWidget* parent = nullptr, Qt::WindowFlags flags = {} );
	explicit QmaxDockWidget( QmaxMainWindow::QmaxDockType dockType, const QString& objectName, const QString& title, QWidget* parent = nullptr, Qt::WindowFlags flags = {} );
	explicit QmaxDockWidget( QWidget* parent = nullptr, Qt::WindowFlags flags = {} );
