...
class CoreExport QMaxColorSwatch: public QWidget
{
	...
	/** \brief Color context for this swatch. Color contexts determine
	 * how the colors will be managed, transformed and displayed. 
	* \see colorContext(), setColorContext(), enum class ColorContext */
	Q_PROPERTY( ColorContext colorContext READ colorContext WRITE setColorContext  );
...
public:
	...
	* on the Ok button to close the dialog.
	...
	/** \brief Retrieves the color context for this swatch. Color contexts
	 * determine how the colors will be managed, transformed and displayed.
	 * \see colorContext(), setColorContext(), enum class ColorContext */
	ColorContext colorContext() const; 
...
public Q_SLOTS:
	...
	/** \brief sets the color context for this swatch. Color contexts determine
	 * how the colors will be managed, transformed and displayed. 
	 * \see colorContext(), setColorContext(), enum class ColorContext */
...
Q_DECLARE_METATYPE( ColorContext );
