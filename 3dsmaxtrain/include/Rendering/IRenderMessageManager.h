...
public: 
	...
	//! via UI operation, API call, and MAXScript. 
	...
	//! \remarks Note that if Max is running in quiet mode, the message window will never show up. 
	...
	//! \remarks Note that if Max is running in quiet mode or is doing network rendering, 
	...
	//! \brief Get the "Open Message Window on Warning" option.  
	//! \return True if the window will be opened whenever there's a warning
	//! message sent in, false otherwise.  
	//! \remarks Note that if Max is running in quiet mode, the message window
	//! will never show up.
	virtual bool GetOpenMessageWindowOnWarning() const = 0;

	//! \brief Set the "Open Message Window on Warning" option.  
	//! \param flag Set true if client wants the manager to open the window
	//! whenever there's a warning message sent in, false otherwise.  
	//! \remarks Note that if Max is running in quiet mode or is doing network
	//! rendering, the message window will never show up.
	virtual void SetOpenMessageWindowOnWarning(bool flag) = 0;

	//! \brief Get the "Auto Scroll" option.
	//! \return True if the message window is set to automatically scroll to the
	//! latest message, false otherwise.
	virtual bool GetMessageWindowAutoScroll() const = 0;

	//! \brief Sets the "Auto Scroll" option.
	//! \param flag Set true, if the message window should automatically scroll
	//! to the latest message, false otherwise.
