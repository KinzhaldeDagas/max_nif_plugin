...
<b>GetIInteractiveRender()</b> method on the renderer. The renderer returns a pointer to a class
...
interactive rendering is not supported.\n\n
...
public:
	...
	virtual MSTR GetIRenderTitle() const = 0;
};
