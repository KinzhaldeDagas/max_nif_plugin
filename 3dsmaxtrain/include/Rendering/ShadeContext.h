...
public:
	...
	*/
	...
	/*! \remarks Returns the transformation matrix to transform from 
	internal camera space to the specified space.
	\par Parameters:
	<b>RefFrame ito</b>\n\n
	The space to transform to. One of the following values:\n\n
	<b>REF_CAMERA</b>\n\n
	<b>REF_WORLD</b>\n\n
	<b>REF_OBJECT</b>
	\return  The transformation matrix to transform to the specified space. */
	virtual Matrix3 MatrixTo(RefFrame ito) = 0;
	/*! \remarks Returns the transformation matrix to transform from the
	specified coordinate system to internal camera space.
	\par Parameters:
	<b>RefFrame ifrom</b>\n\n
	The space to transform from. One of the following values:\n\n
	<b>REF_CAMERA</b>\n\n
	<b>REF_WORLD</b>\n\n
	<b>REF_OBJECT</b>
	\return  The transformation matrix to transform to internal camera space. */
	virtual Matrix3 MatrixFrom(RefFrame ifrom) = 0;
