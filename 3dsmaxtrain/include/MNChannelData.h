...
public:
	...
	*/
	...
	bool use2012WeldMathFlag; //!< Owns this flag \ref MN_MESH_USE_MAX2012_WELD_MATH. This indicates that welding should add the 3 xyz components in the old order.
};
