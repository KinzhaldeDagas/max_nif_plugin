...
#define MAXCOM_FILE_NEW_FROM_TEMPLATE  217
#define MAXCOM_FILE_EXPORT_GAMEEXPORTER	218
...
//defined in release 2015 and later only
#define MAXCOM_HIDE_BONEOBJECT_TOGGLE		262
#define MAXCOM_PLACE						263
#define MAXCOM_PLACE_CYCLE					264

//defined in release 2016 and later only
#define MAXCOM_GROUP_OPEN_RECURSIVELY       265

#define MAXCOM_HIDE_NONRENDERABLE_TOGGLE	266

//==============================================================================
//
// IMPORTANT NOTE:
//		Any ID defined in this file should have its counterpart in the
//		maxsdk\include\maxscript\protocols\max_commands.inl file, in order for the corresponding
