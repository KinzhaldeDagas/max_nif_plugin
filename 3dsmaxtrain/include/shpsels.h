...
class ShapeVSel: public MaxHeapOperators {
	...
	CoreExport ShapeVSel(const ShapeVSel& from);
	CoreExport ~ShapeVSel();
	/*! \remarks Assignment operator. */
	CoreExport ShapeVSel& operator=(const ShapeVSel& from);
	CoreExport BOOL operator==(const ShapeVSel& s) const;
	...
	CoreExport BOOL IsCompatible(const ShapeVSel& selset) const;
	CoreExport BOOL IsCompatible(const BezierShape& shape) const;
	CoreExport BOOL IsCompatible(const PolyShape& shape) const;
...
class ShapeSSel: public MaxHeapOperators {
	...
	CoreExport ShapeSSel(const ShapeSSel& from);
	/*! \remarks Destructor. Any BitArrays are freed. */
	CoreExport ~ShapeSSel();
	/*! \remarks Assignment operator. */
	CoreExport ShapeSSel& operator=(const ShapeSSel& from);
	CoreExport BOOL operator==(const ShapeSSel& s) const;
	/*! \remarks Creates and inserts a new BitArray into <b>sel</b>.
	\par Parameters:
	<b>int where</b>\n\n
	The index into <b>sel</b> indicating where to insert the new BitArray.\n\n
	...
	/*! \remarks Sets the size of every poly BitArray to 0. */
	CoreExport void Empty();
	CoreExport BOOL IsCompatible(const ShapeSSel& selset) const;
	CoreExport BOOL IsCompatible(const BezierShape& shape) const;
	CoreExport BOOL IsCompatible(const PolyShape& shape) const;
...
class ShapePSel: public MaxHeapOperators {
	...
	CoreExport ShapePSel(const ShapePSel& from);
	/*! \remarks Destructor. */
	CoreExport ~ShapePSel();
	/*! \remarks Assignment operator. */
	CoreExport ShapePSel& operator=(const ShapePSel& from);
	CoreExport BOOL operator==(const ShapePSel& s) const;
	...
	CoreExport void Empty();
	CoreExport BOOL IsCompatible(const ShapePSel& selset) const;
	CoreExport BOOL IsCompatible(const BezierShape& shape) const;
	CoreExport BOOL IsCompatible(const PolyShape& shape) const;
