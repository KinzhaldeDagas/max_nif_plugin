...
//***********************************
	...
	*  \brief Each particle is given a unique ID (consecutive) upon its birth. The method 
	...
	\param i: index of the particle in the range of [0, NumParticles-1]
	*/
	...
	*  \brief Defines age of the specified particle. Particle is specified by either its
	...
	\param index: particle index in the particle group
	*/	
	...
	*  \brief See GetParticleAgeByIndex().
	\param index: particle index in the particle group
	\param age: new age value to set for a particle
	*/
	...
	*  \brief See GetParticleLifespanByIndex().
	\param index: particle index in the particle group
	\param lifespan: new lifespan value to set for a particle
	*/
	...
	*  \brief See GetParticleEventTimeByIndex().
	\param index: particle index in the particle container
	\param time: how long particle was staying in the current action list (event)
	*/
	...
	*  \brief See GetParticleSpeedByIndex().
	\param index: particle index in the particle group
	\param speed: speed of the particle in units per frame
	*/
	...
	*  \brief See GetParticleAccelerationByIndex().
	\param index: particle index in the particle group
	\param accel: acceleration of the particle in units per frame squared
	*/
	...
	*  \brief See GetParticleAccelerationByIndex().
	\param speed: acceleration of the particle in units per frame squared
	*/
	...
	*  \brief See GetParticleOrientationByIndex().
	\param index: particle index in the particle group
	\param orient: orientation of the particle. The orientation is defined by incremental rotations by world axes X, Y and Z. The rotation values are in degrees.
	*/
	...
	*  \brief See GetParticleSpinByIndex().
	\param index: particle index in the particle group
	\param spin: angular speed of the particle in rotation per frame, axis defines rotation axis, angle defines rotation amount per frame
	*/
	...
	*  \brief See GetParticleScaleByIndex().
	\param index: particle index in the particle group
	\param scale: scale factor for each local axis of the particle
	*/
	...
	*  \brief See GetParticleTMByIndex().
	\param index: particle index in the particle group
	\param tm: transformation matrix of the particle
	*/
	...
	*  \brief See GetParticleSelectedByIndex().
	\param index: particle index in the particle group
	\param selected: selection status of the particle
	*/
	...
	*  \brief Defines material index of the specified particle in the current state.
	...
	If no index is specified then the "current" index is used.
	\param index: particle index in the particle group
	\param mtlIndex: material index of the particle
	*/
	...
	*  \brief Defines mapping of the specified particle in the current state.
	...
	If no index is specified then the "current" index is used.
	\param index: particle index in the particle group
	\param mapChannel: mapping channel; range from 0 to MAX_MESHMAPS-1
	\param mapValue: mapping value of the particle
	*/
	...
	*  \brief See GetParticleIntByIndex().
	\param index: particle index in the particle group
	\param value: integer value of the particle
	*/
	...
	*  \brief See GetParticleFloatByIndex().
	\param index: particle index in the particle group
	\param value: float value of the particle
	*/
	...
	*  \brief See GetParticleVectorByIndex().
	\param index: int, particle index in the particle group
	\param value: vector value of the particle
	*/
	...
	*  \brief See GetParticleMatrixByIndex().
	\param index: particle index in the particle group
	\param value: matrix value of the particle
	*/
	...
	*/
	...
	/*! \fn virtual TimeValue GetParticleTestTime() = 0;
	*  \brief See SetParticleTestTimeByIndex().
	*/
	virtual TimeValue GetParticleTestTime() = 0;

	/*! \fn virtual void SetParticleTestTime(TimeValue testTime) = 0;
	*  \brief See SetParticleTestTimeByIndex().
	\param testTime: TimeValue; time when a particle satisfies the test
	*/
