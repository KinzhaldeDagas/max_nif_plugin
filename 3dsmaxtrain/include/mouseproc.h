...
private:
    ...
    int            mCursor;
    // The instance of the dll using the mouse proc for cursor for mCursor
    HINSTANCE      mInstance;
	// The Enum of the cursor to use
	UI::MouseCursors::ECursors mCursorEnum;

	//Cursors are either mCursorEnum for a cursor defined by 3ds Max or mCursor and mInstance for a cursor defined within a dll
