...
public:
	...
	*/
	...
	from memory. Note that opening a main file containing disabled xref records results 
	...
	*/
	...
	The child xref records saved with the intermediate main files must be update first, 
