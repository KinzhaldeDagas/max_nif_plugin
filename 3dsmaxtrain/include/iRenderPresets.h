...
/*! \sa Class Renderer, the <a href="group__render_preset_cat_def.html">Render Preset Category Defines</a>
\par Description:
...
public:
	...
	virtual const MCHAR *  MapIndexToCategory( const MCHAR * fileName, int catIndex  ) = 0;
	...
	\return the name of the specified render preset */
	virtual const MCHAR *  MapIndexToCategory( RendererSpecifier rendSpecifier, int catIndex  ) = 0;
	...
	\param category The name of the category to retrieve the ID of
