...
#include <set>
#include <vector>
#include <MeshValidator/MeshValidatorExport.h>
...
namespace MaxSDK
{
    ...
    public:
        ...
        MV_EXPORT RemediateNonManifoldGeometry(geo::span<const int> faceVertices, geo::span<const int> beginFaceVertices, int nVertices,
        ...
        // Destructor.
        MV_EXPORT ~RemediateNonManifoldGeometry() = default;
        ...
        MV_EXPORT void SetPhysicalSpaceFaces(geo::span<const int> physicalFaceVertices, int nPhysicalVertices);
        ...
        MV_EXPORT void FindNonManifoldEdgesAndVertices(size_t& nNonManifoldVertices, size_t& nNonManifoldEdges);
        ...
        MV_EXPORT void RemediateNonManifoldEdgesAndVertices(size_t& nNonManifoldVertices, size_t& nNonManifoldEdges);
        ...
        MV_EXPORT geo::span<const int> GetDetectedNonManifoldVertexIndices() const;
        ...
        MV_EXPORT int GetSourceVertex(size_t indexVertex) const;
        ...
        MV_EXPORT size_t GetNumberOfManifoldVerticesForFace(size_t indexFace) const;
        ...
        //
        // indexFace: index in mesh of face of interest; input
        MV_EXPORT const int* GetManifoldVerticesForFace(size_t indexFace) const;
        ...
        //
        // indexFace: index in mesh of face of interest; input
        MV_EXPORT const int* GetManifoldEdgesForFace(int indexFace) const;
        ...
        MV_EXPORT size_t GetNumberOfManifoldEdges() const;
